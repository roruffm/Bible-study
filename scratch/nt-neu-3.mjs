/* Neue NT-Artikel: 2. Thessalonicher lückenlos */
...
export const ARTICLES = [
  {
    ...
    from: 1,
    to: 4,
    title: '„wir rühmen uns euer unter den Gemeinden“',
    dating: {
    ...
    sources: [
      'Inschriften mit dem Titel Politarch, IG X 2,1',
      'Tertullian, Apologeticum 50',
      'Johann Ernst Christian Schmidt, Vermuthungen über die beyden Briefe an die Thessalonicher, 1801',
    ],
  },
  {
    book: '2thess',
    ...
    sources: [
      'Augustinus, Vom Gottesstaat 21,23',
      'Gregor von Nyssa, Über die Seele und die Auferstehung',
      'Viertes Esrabuch 7 (jüdische Gerichtserwartung derselben Zeit)',
    ],
  },
  {
    book: '2thess',
    ...
    sources: [
      'Konzil von Trient, Dekret über die Annahme der heiligen Bücher, 1546',
      'Zweites Vatikanisches Konzil, Dei verbum 9',
      'Mischna, Traktat Avot 1,1 (die Kette der Überlieferung)',
    ],
  },
  {
    book: '2thess',
    ...
    sources: [
      'Gallio-Inschrift aus Delphi (SIG 801d)',
      'Chrysostomos, Homilien zum zweiten Thessalonicherbrief 4',
      'Dordrechter Lehrregeln 1619, 3./4. Lehrstück',
    ],
  },
  {
    book: '2thess',
    ...
    sources: [
      'Schleitheimer Übereinkunft 1527, Artikel 2',
      'Cicero, Briefe an Atticus 13,25 (Diktat und eigene Hand)',
      'Sammlung der pseudoplatonischen Briefe (antike Fälschungspraxis)',
    ],
  },
];
