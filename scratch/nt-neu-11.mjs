/* Neue NT-Artikel: 1. Timotheus lückenlos */
...
export const ARTICLES = [
  {
    ...
    sources: [
      'Septuaginta, 3. Mose 18,22 und 20,13',
      'Josephus, Vita 1 (Abstammung aus öffentlichen Registern)',
      'John Wesley, Gedanken über die Sklaverei, 1774',
    ],
  },
  {
    book: '1tim',
    ...
    world: [
      ...
      {
        aspect: 'recht',
        text: 'Das Gesetz unterscheidet zwischen Sünde aus Versehen, für die geopfert werden kann, und dem Sündigen mit erhobener Hand. Der Hinweis auf die Unwissenheit ordnet die eigene Vergangenheit der ersten Gruppe zu.',
      },
      {
        aspect: 'gesellschaft',
    ...
    sources: [
      'John Newton, Grabinschrift in Olney',
      'Chrysostomos, Homilien zum ersten Timotheusbrief 3',
      'Mittelalterliche Bannformulare (Pontificale Romanum)',
    ],
  },
  {
    book: '1tim',
    ...
    world: [
      {
        aspect: 'macht',
        text: 'Im Jerusalemer Tempel wurde täglich ein Opfer für den Kaiser dargebracht, das Rom bezahlte. Seine Einstellung im Jahr 66 galt als Kriegserklärung. Fürbitte für den Herrscher war eine anerkannte Form politischer Loyalität.',
      },
      {
        aspect: 'glaube',
        text: 'Der Unterschied zwischen dem Gebet für den Kaiser und dem Gebet zu ihm war die Grenze, an der die Loyalität endete. Tertullian und Origenes betonen ihn ausdrücklich; an dieser Frage entschieden sich Prozesse.',
      },
      {
        aspect: 'recht',
      ...
      {
        aspect: 'gesellschaft',
        text: 'Ein ruhiges Leben war für eine Gruppe ohne Rechtsstatus die Bedingung des Überlebens. Aufmerksamkeit brachte Anzeigen, Anzeigen brachten Verfahren. Die genannten Wörter stammen aus der politischen Sprache und meinen die Ruhe eines Gemeinwesens.',
      },
    ],
    terms: [
      {
    ...
    sources: [
      'Josephus, Jüdischer Krieg 2,409 (Einstellung des Kaiseropfers)',
      'Tertullian, Apologeticum 30',
      'Konkordienformel 1577, Artikel 11',
    ],
  },
  {
    book: '1tim',
    ...
    world: [
      ...
      {
        aspect: 'arbeit',
        text: 'Das Wort für Versorgen der Gemeinde ist dasselbe, das im Gleichnis vom barmherzigen Samariter für die Pflege des Verletzten steht. Es meint praktische Fürsorge, nicht Leitung im Sinn von Befehlsgewalt.',
      },
      {
        aspect: 'glaube',
    ...
    sources: [
      'Plinius der Jüngere, Briefe 10,96 (ministrae und Gesang)',
      'Apostolische Konstitutionen 8,19–20 (Weihegebet für Diakoninnen)',
  ...
  },
  {
    ...
    world: [
      ...
      {
        aspect: 'macht',
        text: 'Alter entschied über Gehör. Ämter in Städten und Vereinen waren an Lebensjahre gebunden, und das griechische Wort für Jugend konnte bis zum vierzigsten Lebensjahr reichen. Ein junger Leiter musste sich behaupten.',
      },
      {
        aspect: 'glaube',
        text: 'Mehrere Richtungen des zweiten Jahrhunderts lehnten die Ehe ab, weil Fortpflanzung die Seele weiter in die Materie binde. Die Enkratiten machten den Verzicht zur Bedingung der Taufe; die apokryphen Paulusakten bewegen sich in dieser Richtung.',
      },
    ],
    terms: [
      {
    ...
    sources: [
      ...
      'Irenäus, Gegen die Häresien 1,28 (über die Enkratiten)',
      'Konzil von Trient, Sitzung 24, Kanon 10',
    ],
  },
  {
    book: '1tim',
    ...
    world: [
      {
        aspect: 'recht',
        text: 'Eine Frau erbte in der Regel nicht, sondern erhielt ihre Mitgift zurück, falls sie noch vorhanden war. Die Versorgung lag bei den Söhnen oder der Herkunftsfamilie. Wer beides nicht hatte, war auf Almosen angewiesen.',
      },
      {
        aspect: 'gesellschaft',
    ...
    sources: [
      'Syrische Didaskalie 14–15 (Ordnung des Witwenstands)',
      'Eusebius, Kirchengeschichte 6,43 (Versorgte der römischen Gemeinde)',
      'Theodor Fliedner, Gründungsschriften der Diakonissenanstalt Kaiserswerth, 1836',
    ],
  },
  {
    book: '1tim',
    ...
    world: [
      ...
      {
        aspect: 'alltag',
        text: 'Wasser war in vielen Städten verunreinigt; man mischte Wein hinein, um es genießbar zu machen. Die antike Heilkunde empfahl Wein bei Magenbeschwerden. Der Rat ist medizinisch, nicht gesellig gemeint.',
      },
      {
        aspect: 'gesellschaft',
    ...
    sources: [
      'Hippokratisches Corpus, Über die Diät bei akuten Krankheiten',
      'Luther, An die Ratsherren aller Städte deutschen Landes, 1524',
      'Kirchliche Stellungnahmen zur Aufarbeitung sexualisierter Gewalt seit 2010',
    ],
  },
  {
    book: '1tim',
    ...
    historicalLong:
      'Der Abschnitt beginnt mit einer Anweisung an Sklaven und behandelt einen Sonderfall: gläubige Herren. Die Sorge ist, dass die Bruderschaft im Glauben die Rangordnung im Haus außer Kraft setzt und die Sklaven ihre Herren geringachten. Das lässt sich lesen als Beleg dafür, dass genau das geschah – eine Anweisung ergeht gegen etwas, das vorkommt. Der Philemonbrief zeigt dieselbe Spannung von der anderen Seite.\n\nDer Vorwurf, jemand halte die Frömmigkeit für ein Gewerbe, trifft eine bekannte Erscheinung. Wanderredner und Religionsanbieter lebten von ihren Auftritten; Lukian von Samosata schildert einen Betrüger, der ein Orakel erfindet und damit reich wird. Der vorige Abschnitt hatte gerade die Bezahlung von Ältesten geregelt – der Brief unterscheidet also zwischen Unterhalt für Arbeit und Gewinnabsicht.\n\nDie Bemerkung, man habe nichts in die Welt gebracht und werde nichts hinausbringen, ist ein Gemeinplatz der Weisheitsliteratur. Sie steht fast wörtlich im Buch Hiob und im Prediger; auch griechische und lateinische Autoren formulieren so. Der Brief zieht daraus keine Verachtung des Besitzes, sondern eine Genügsamkeitsregel: Nahrung und Kleidung genügen. Das Wort für Kleidung meint wörtlich Bedeckung und schließt das Dach über dem Kopf ein.\n\nDer bekannteste Satz des Abschnitts wird fast immer falsch wiedergegeben. Es heißt nicht, Geld sei die Wurzel allen Übels, sondern die Geldliebe. Das griechische Wort ist eine Zusammensetzung aus „lieben“ und „Silber“ und bezeichnet eine Haltung, nicht eine Sache. Zudem fehlt im Griechischen der bestimmte Artikel – der Satz sagt eher, sie sei eine Wurzel aller Arten von Übel. Beide Genauigkeiten sind in der Wirkungsgeschichte verlorengegangen.\n\nDer Schluss wechselt in Bilder aus Wettkampf und Militärdienst: den guten Kampf kämpfen, das ewige Leben ergreifen, das gute Bekenntnis ablegen vor vielen Zeugen. Das Bekenntnis vor Zeugen ist wahrscheinlich die Taufe – die frühen Kirchenordnungen kennen ein Bekenntnis, das der Täufling vor der Gemeinde spricht. Damit wird eine vergangene Handlung als Verpflichtung in Erinnerung gerufen.',
    reception:
      'Der Satz über die Geldliebe gehört zu den bekanntesten der Bibel und ist zugleich einer der am häufigsten verkürzt zitierten. In der Fassung „Geld ist die Wurzel allen Übels“ ist er sprichwörtlich geworden, in mehreren Sprachen und weit über den kirchlichen Bereich hinaus. Die Auslegung hat seit der Alten Kirche auf die Genauigkeit hingewiesen; Chrysostomos betonte, das Geld sei ein Werkzeug, die Gier eine Haltung.\n\nDie Genügsamkeitsregel – Nahrung und Bedeckung genügen – ist in die Ordensregeln eingegangen und in die Armutsbewegungen des Mittelalters. Franz von Assisi berief sich darauf; die Bettelorden machten sie zur Lebensform. In der Neuzeit ist sie in der Kritik am Konsum wieder aufgegriffen worden.\n\nDie Anweisung an die Sklaven hat, wie die Haustafeln, in den Sklavereidebatten beiden Seiten gedient. Bemerkenswert ist, dass hier ausdrücklich der Fall gläubiger Herren behandelt wird: Die Gleichheit im Glauben und die Ungleichheit im Recht stehen unaufgelöst nebeneinander. Abolitionisten führten an, dass ein Verhältnis, das nur mit solcher Mühe zu halten ist, im Kern nicht haltbar sei.',
    world: [
      {
        aspect: 'gesellschaft',
      ...
      {
        aspect: 'arbeit',
        text: 'Wanderredner und Religionsanbieter lebten von ihren Auftritten. Lukian schildert einen, der ein Orakel erfindet und reich wird. Der Vorwurf, Frömmigkeit als Gewerbe zu betreiben, traf eine bekannte Erscheinung.',
      },
      {
        aspect: 'alltag',
        text: 'Das Wort für Kleidung meint wörtlich Bedeckung und schließt das Dach über dem Kopf ein. Nahrung und Obdach – das war das Maß, mit dem die Mehrheit der Bevölkerung rechnete, wenn es gut lief.',
      },
      {
        aspect: 'glaube',
    ...
    terms: [
      {
        ...
        rendered: 'Geiz',
        note: 'Wörtlich: Silberliebe. Eine Haltung, keine Sache. Der Satz sagt nicht, Geld sei die Wurzel allen Übels, sondern die Geldliebe – und im Griechischen fehlt zudem der bestimmte Artikel: eine Wurzel aller Arten von Übel.',
      },
      {
      ...
      {
        word: 'griech. skepasmata',
        rendered: 'Kleidung',
        note: 'Wörtlich: Bedeckungen. Das Wort schließt das Dach über dem Kopf ein und ist damit weiter als Kleidung. Nahrung und Obdach sind das genannte Maß.',
      },
    ],
    interpretations: [
      {
      ...
      {
        tradition: 'Kirchenväter',
        text: 'Chrysostomos betonte die Genauigkeit des Satzes: Nicht das Geld, die Gier ist die Wurzel. Das Geld sei ein Werkzeug, das gebraucht oder missbraucht werden könne. Basilius zog aus der Genügsamkeitsregel die Folgerung, dass alles darüber hinaus anderen gehöre.',
      },
      {
        tradition: 'Monastische und Armutstradition',
        text: 'Die Regel, Nahrung und Bedeckung genügten, ist in die Ordensregeln eingegangen. Franz von Assisi berief sich darauf, und die Bettelorden machten sie zur Lebensform. In der Neuzeit ist sie in der Konsumkritik wieder aufgegriffen worden.',
      },
      {
        tradition: 'Reformatorische Auslegung',
        text: 'Betont wird, dass der Text den Besitz nicht verurteilt, sondern die Bindung an ihn. Luther verband den Abschnitt mit dem ersten Gebot: Woran das Herz hängt, das ist der Gott. Diese Auslegung steht im Großen Katechismus.',
      },
      {
        tradition: 'Sprachkritische Anmerkung',
        text: 'Die sprichwörtliche Fassung „Geld ist die Wurzel allen Übels“ verkürzt den Satz in zwei Richtungen: Sie macht aus einer Haltung eine Sache und aus einer Wurzel die Wurzel. Beides ist in der Wirkungsgeschichte folgenreich gewesen, weil es Besitz an sich verdächtig macht.',
      },
    ],
    crossRefs: [
      { book: 'hi', chapter: 1, verse: 21, note: 'Nackt bin ich gekommen' },
      { book: 'phlm', chapter: 1, verse: 16, note: 'Der Sklave als Bruder' },
      { book: 'mt', chapter: 6, verse: 24, note: 'Ihr könnt nicht Gott dienen und dem Mammon' },
      { book: '1tim', chapter: 5, verse: 17, note: 'Die geregelte Bezahlung der Ältesten' },
    ],
    sources: [
      'Lukian, Alexandros oder der Lügenprophet',
      'Chrysostomos, Homilien zum ersten Timotheusbrief 17',
      'Luther, Großer Katechismus, Erstes Gebot',
    ],
  },
  {
    book: '1tim',
    ...
    world: [
      {
        aspect: 'macht',
        text: 'Pilatus war von 26 bis 36 Statthalter von Judäa. Eine 1961 in Cäsarea gefundene Inschrift nennt ihn mit dem Amtstitel Präfekt – die einzige zeitgenössische Erwähnung seines Namens außerhalb der Literatur.',
      },
      {
        aspect: 'gesellschaft',
        text: 'König der Könige und Herr der Herren waren Titel des persischen Großkönigs und später der Partherherrscher. Sie auf Gott anzuwenden, war eine Aussage über Rangordnungen, die jeder Leser einordnen konnte.',
      },
      {
        aspect: 'arbeit',
      ...
      {
        aspect: 'glaube',
        text: 'Das Wort Gnosis bedeutete einfach Erkenntnis und war ein Allerweltsbegriff. Erst im zweiten Jahrhundert wurde es zur Selbstbezeichnung bestimmter Richtungen – und über diesen Vers zur Fremdbezeichnung durch ihre Gegner.',
      },
    ],
    terms: [
      {
    ...
    sources: [
      'Pilatus-Inschrift aus Cäsarea Maritima, gefunden 1961',
      'Irenäus, Entlarvung und Widerlegung der fälschlich so genannten Erkenntnis, um 180',
