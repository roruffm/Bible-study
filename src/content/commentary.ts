...
/**
 * Die Seite der Welt, von der eine Beobachtung handelt.
 *
 * Die Einteilung ist grob und soll es bleiben: Sie ordnet die Notizen für das
 * Auge, sie klassifiziert nicht die Antike. Wo sich etwas nicht zuordnen lässt,
 * ist meist `gesellschaft` gemeint.
 */
...
export const WORLD_ASPECT_LABEL: Record<WorldAspect, string> = {
  alltag: 'Alltag und Haus',
  arbeit: 'Arbeit und Wirtschaft',
  recht: 'Recht und Ordnung',
  macht: 'Herrschaft und Politik',
  gesellschaft: 'Was als selbstverständlich galt',
  glaube: 'Religiöse Umwelt',
  raum: 'Land, Wege, Klima',
};

/**
 * Ein Zug der Welt, in der der Abschnitt spielt oder entstanden ist.
 *
 * Nicht zu verwechseln mit dem Lexikon: Das erklärt Wörter, die im Vers
 * vorkommen – was eine Elle ist, was ein Groschen wert war. Hier steht, was
 * die ersten Hörer nicht erklärt bekamen, weil es für sie selbstverständlich
 * war: wer über sie herrschte, wovon sie lebten, was als anständig galt und
 * wovor sie Angst hatten. Ohne das liest man antike Texte mit heutigen Augen,
 * ohne es zu merken.
 */
...
export interface CommentaryEntry {
  ...
  reception?: string;
  /**
   * Die Welt, in der der Abschnitt spielt – Alltag, Recht, Herrschaft,
   * Wirtschaft und das, was damals niemand begründen musste.
   */
  world?: WorldNote[];
...
export const COMMENTARY: CommentaryEntry[] = [
  {
    ...
    world: [
      {
        aspect: 'macht',
        text: 'Babylon ließ sein Schöpfungsepos nicht in Bibliotheken verstauben: Das Enuma Elisch wurde beim Neujahrsfest im Frühjahr öffentlich vorgetragen, während der König an der Hand der Marduk-Statue durch die Prozessionsstraße zog. Wer im Exil lebte, hörte diese Weltdeutung also jährlich als Staatsakt – und der Sieben-Tage-Text ist die Antwort darauf.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Warum es Menschen gibt, beantwortete Mesopotamien nüchtern: Im Atrachasis-Epos werden sie geschaffen, damit die niederen Götter die Kanalarbeit loswerden. Der Mensch ist Arbeitskraft, entstanden aus Bequemlichkeit. Dass hier stattdessen ein Segen und ein Auftrag stehen, war die eigentliche Zumutung.',
      },
      {
        aspect: 'alltag',
        text: 'Eine Sieben-Tage-Woche kannte die Umwelt nicht. Ägypten rechnete in Zehntagewochen, Mesopotamien nach Mondphasen mit Unglückstagen, an denen man bestimmte Dinge unterließ. Ein wiederkehrender Ruhetag für alle, auch für Knechte und Vieh, war eine Sonderbildung – und wurde von römischen Autoren später als Faulheit verspottet.',
      },
      {
        aspect: 'arbeit',
        text: 'Die Verschleppten lebten in Babylonien nicht als Sklaven. Keilschrifttafeln aus dem Ort Al-Jahudu – „Juda-Stadt“ – zeigen judäische Familien über vier Generationen: Sie bewirtschafteten Kronland, zahlten Abgaben, schlossen Verträge, trugen teils babylonische Namen. Die Lage war Entwurzelung mit Existenz, nicht Kerker.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'glaube',
        text: 'Schlangen galten im Alten Orient nicht als Sinnbild des Bösen, sondern als Zeichen von Weisheit, Heilung und Fruchtbarkeit. An der Stirn des Pharao saß die Uräusschlange als Schutzzeichen, in Timna und Megiddo fanden sich bronzene Schlangen aus Heiligtümern, und noch 2. Könige 18 berichtet, dass im Tempel bis zur Reform Hiskias eine eherne Schlange beräuchert wurde.',
      },
      {
        aspect: 'arbeit',
        text: 'Dornen und Disteln sind kein Bild. Ackerbau in Palästina hieß Trockenfeldbau ohne Bewässerung, abhängig vom Winterregen, auf steinigen Hängen, die jedes Jahr neu von Aufwuchs freigehalten werden mussten. Der Fluch über den Acker beschreibt schlicht die Arbeit, die die Zuhörer kannten.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Nacktheit bedeutete Schande, und zwar öffentlich: So wurden Kriegsgefangene abgeführt, so zeigen es assyrische Reliefs. Kleidung war Stand – wer bekleidet war, gehörte dazu. Dass Gott am Ende selbst Röcke aus Fellen macht, ist deshalb kein Nebensatz, sondern eine Wiedereinsetzung.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'arbeit',
        text: 'Mose hütet die Herde seines Schwiegervaters – ein Zugezogener ohne eigenen Besitz, der für die Aufnahme in die Familie arbeitet. Kleinviehhaltung in der Sinai-Halbinsel hieß, mit Schafen und Ziegen weiten Wanderungen zwischen Winterweiden und Sommerquellen zu folgen; die Herde gehörte einem anderen.',
      },
      {
        aspect: 'macht',
        text: 'Der Pharao war kein König unter Königen, sondern Gott in Menschengestalt, Garant der Weltordnung. Ein Aufstand gegen ihn war deshalb nicht nur Hochverrat, sondern Angriff auf den Bestand des Kosmos. Vor diesem Hintergrund ist der Auftrag an einen geflohenen Totschläger eine Farce – und wird von Mose auch so behandelt.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Fronarbeit für staatliche Bauvorhaben war im Ägypten des Neuen Reiches normal und traf Einheimische wie Zugewanderte. Belege aus Arbeitersiedlungen zeigen Ziegelquoten, Rationen und Fehlzeitenlisten. Was Kapitel 5 über Stroh und Ziegelzahlen erzählt, entspricht dieser Verwaltungswirklichkeit genau.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'recht',
        text: 'Rechtssammlungen gab es im Alten Orient seit Jahrhunderten – Ur-Nammu, Lipit-Ischtar, Eschnunna, am bekanntesten der Kodex Hammurapi auf einer über zwei Meter hohen Stele. Alle sind Fallrecht mit gestaffelten Strafen: Wer einem Freien ein Auge ausschlägt, zahlt anders als bei einem Sklaven. Genau dieses Staffeln nach Stand fehlt hier.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Angeredet ist ein freier Grundbesitzer mit Haus, Vieh, Knecht und Magd – erkennbar am letzten Gebot, das aufzählt, was er nicht begehren soll. Frauen, Kinder und Sklaven kommen als Angeredete nicht vor, sondern als das, worüber er verfügt. Die Sabbatregel dagegen nennt sie ausdrücklich.',
      },
      {
        aspect: 'glaube',
        text: 'Götterbilder waren keine Dekoration, sondern der Ort, an dem eine Gottheit anwesend war. Sie wurden in Ritualen zum Leben erweckt, gewaschen, gekleidet, gespeist und bei Siegen des Feindes verschleppt – die Statue mitzunehmen hieß, den Gott gefangen zu nehmen. Ein Kult ohne Bild entzog dem Feind genau diesen Zugriff.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'alltag',
        text: 'Sitzen, gehen, niederlegen, aufstehen – das ist kein frommer Rhythmus, sondern die Beschreibung eines Bauernhaushalts ohne Trennung von Arbeit und Wohnen. Ein Haus hatte einen Raum, oft mit tiefergelegtem Stallbereich; die Familie schlief gemeinsam auf der erhöhten Fläche. Weitergabe geschah dort, wo man ohnehin nebeneinander war.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Lesen konnten wenige. Schätzungen für die Königszeit bewegen sich im niedrigen einstelligen Prozentbereich, beschränkt auf Schreiber, Priester und Verwaltung. Überlieferung lief deshalb über das Sprechen, das Wiederholen und das Auswendiglernen – der Text verlangt genau das und rechnet nicht mit Lesern.',
      },
      {
        aspect: 'glaube',
        text: 'Die Umwelt kannte Götterfamilien mit Zuständigkeiten: einen für Wetter, einen für Krieg, einen für Fruchtbarkeit. Man wandte sich an den, der zuständig war. Sich auf einen einzigen festzulegen hieß, in Dürre, Krieg und Kinderlosigkeit keine zweite Adresse zu haben.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'arbeit',
        text: 'Hirte war ein niedriger Beruf: staubig, einsam, oft an Jüngste oder Bedienstete abgegeben, und mit dem Ruf behaftet, es mit fremdem Weideland nicht genau zu nehmen. Der Stecken war eine Keule gegen Raubtiere, der Stab ein Gehstock mit Haken. Beides sind Werkzeuge, keine Insignien.',
      },
      {
        aspect: 'raum',
        text: 'Grüne Aue und frisches Wasser sind in Juda keine Selbstverständlichkeit, sondern das, was von Ende Mai bis Oktober fehlt. Herden wurden zu Zisternen und Quellen geführt, oft stundenweit; Schafe scheuen fließendes Wasser, weshalb der Hirte sie an ruhige Stellen bringen musste. Der Psalm beschreibt eine gelungene Versorgung, keine Idylle.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Wer in ein Zelt aufgenommen und bewirtet wurde, stand unter dem Schutz des Gastgebers – auch gegen dessen eigene Sippe, auch gegen Verfolger. Diese Pflicht galt als unverbrüchlich und ist in der ganzen Region bezeugt. Der gedeckte Tisch im Angesicht der Feinde ist deshalb eine Rechtsaussage: Wer hier sitzt, ist unantastbar.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'gesellschaft',
        text: 'Krankheit und Entstellung galten als sichtbares Urteil. Wer so aussah, wurde gemieden – nicht aus Rohheit, sondern weil man annahm, die Lage sei verdient und Nähe gefährlich. Das „Wir“ des Liedes gibt genau diese Annahme zu und widerruft sie.',
      },
      {
        aspect: 'macht',
        text: 'Gesprochen ist in eine Lage, in der ein Weltreich das andere ablöste: Babylon fiel 539 an die Perser. Für die Verschleppten hieß das Hoffnung auf Rückkehr – und die Frage, warum es überhaupt so weit gekommen war. Das Lied beantwortet sie nicht mit Schuldzuweisung, sondern mit einer Umkehr im Urteil.',
      },
      {
        aspect: 'recht',
        text: 'Hingerichtet wurde außerhalb, verscharrt wurde bei den Verbrechern; ein ordentliches Grab war Teil der Ehre, die einem Menschen zustand. Dass der Knecht „bei den Gottlosen“ begraben wird und trotzdem Recht bekommt, verkehrt diese Ordnung.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'alltag',
        text: 'Häuser bauen, Gärten pflanzen, heiraten, Enkel erleben – das ist keine Metapher, sondern die Liste dessen, was eine Familie über Generationen trägt. Ein Obstbaum wirft nach Jahren zum ersten Mal ertrag; wer pflanzt, rechnet mit Bleiben. Genau darin liegt die Härte des Briefes.',
      },
      {
        aspect: 'macht',
        text: 'Der Brief ging mit einer offiziellen Gesandtschaft nach Babylon – Kapitel 29 nennt die Überbringer mit Namen. Judäische Könige unterhielten trotz Unterwerfung diplomatischen Verkehr mit dem Hof; Post reiste im Gepäck solcher Delegationen, weil es einen anderen sicheren Weg nicht gab.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Für das Wohl der fremden Stadt zu beten war eine Zumutung: Man betete für die Ordnung derer, die den Tempel niedergebrannt hatten. Zugleich war es die einzige Überlebensstrategie einer Minderheit ohne eigenen Staat – und wurde für zweieinhalb Jahrtausende Diaspora zur Grundregel.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'arbeit',
        text: 'Galiläa war Kleinbauernland unter Steuerdruck. Neben der römischen Abgabe standen die Zehnten für den Tempel und die Pacht an Großgrundbesitzer; schlechte Jahre führten in die Verschuldung, Verschuldung zum Landverlust, Landverlust in die Tagelöhnerei. Wer in dieser Reihe unten ankam, war *ptochos* – Bettler.',
      },
      {
        aspect: 'macht',
        text: 'Herodes Antipas baute in diesen Jahren Sepphoris aus und gründete Tiberias am See – Städte im griechisch-römischen Zuschnitt, finanziert aus dem Umland. Die Bergpredigt wird in Sichtweite dieser Bauprojekte gesprochen, und ihre Seligpreisungen gelten denen, die sie bezahlten.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Ehre und Schande regelten das öffentliche Leben. Ansehen war ein knappes Gut, das man verteidigen musste; Beleidigung verlangte Antwort, sonst verlor die Familie ihren Stand. Vor diesem Hintergrund ist das Lob der Sanftmütigen und der Verfolgten keine Empfehlung zur Milde, sondern eine Absage an die Währung, in der alle rechneten.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'alltag',
        text: 'Brot war zwei Drittel der Nahrung. Gemahlen wurde täglich von Hand, gebacken in einem Lehmofen, oft gemeinschaftlich; Vorräte hielten Familien nur begrenzt. Die Bitte um das Brot für den Tag beschreibt deshalb keine Bescheidenheit, sondern die tatsächliche Reichweite der Planung.',
      },
      {
        aspect: 'arbeit',
        text: 'Schulden waren die drückendste Alltagserfahrung: Kleinbauern liehen für Saatgut und verpfändeten die Ernte, bei Missernte den Acker, zuletzt die Arbeitskraft. Papyri aus der Region zeigen Schuldscheine, Zinssätze und Zwangsvollstreckungen. Die Bitte um Erlass der Schuld hörte sich in diesen Ohren sehr handfest an.',
      },
      {
        aspect: 'glaube',
        text: 'Gebete der Umwelt reihten oft Titel und Beschwörungsformeln aneinander, um die Gottheit sicher zu treffen. Der Abschnitt davor lehnt genau das ab – „plappert nicht wie die Heiden“ – und das Gebet, das folgt, kommt mit einer Anrede und sechs Bitten aus.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'recht',
        text: 'Wer einen Toten berührte, war sieben Tage unrein und brauchte ein Reinigungsverfahren mit der Asche der roten Kuh – für einen diensthabenden Priester das Ende seiner Dienstzeit. Die Regel stand nicht zur Verhandlung; sie war Berufsrecht. Die Erzählung stellt deshalb zwei Pflichten gegeneinander, nicht Pflicht gegen Gefühl.',
      },
      {
        aspect: 'arbeit',
        text: 'Zwei Denare waren zwei Tagelöhne und reichten für etwa zwei Wochen Unterkunft. Der Samariter gibt sie einem Wirt, für den er selbst haftet – „was du mehr aufwendest, will ich dir bezahlen“ ist ein Zahlungsversprechen, das nur einlösbar ist, wenn er wiederkommt. Er bindet sich also über den Tag hinaus.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Samaritaner und Juden trennten Jahrhunderte alter Streit um Tempel und Tora; unter Hyrkanos war das Heiligtum auf dem Garizim zerstört worden, und Josephus berichtet von Übergriffen an Pilgerstraßen in beide Richtungen. Die Feindschaft war gegenseitig und alltäglich – nicht Kulisse, sondern Grund für die Wahl der Figur.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'recht',
        text: 'Das Erbe war Land, und Land ließ sich zu Lebzeiten des Vaters nur mit dessen Zustimmung übertragen. Selbst dann behielt er üblicherweise den Nießbrauch. Der Sohn verlangt also nicht nur früh, sondern in einer Form, die den Vater bei lebendigem Leib entmachtet – und der Vater gibt nach.',
      },
      {
        aspect: 'arbeit',
        text: 'Schweinehüten war die letzte Stufe: unrein, entwürdigend, und offenbar nicht einmal ausreichend bezahlt, weil der Sohn vom Schweinefutter essen möchte. Die Schoten sind Johannisbrot, Viehfutter in Notzeiten. Die Erzählung schildert damit keinen Absturz ins Elend, sondern seinen tiefsten bekannten Punkt.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Der Vater läuft, und dazu muss er das Gewand raffen und die Beine zeigen – für einen älteren Hausherrn ein Verlust an Würde vor dem ganzen Dorf. Zugleich fängt er den Sohn ab, bevor dieser den Ort erreicht: In einer Dorfgemeinschaft, die den Verrat kannte, war der Empfang am Ortsrand zugleich Schutz.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'gesellschaft',
        text: 'Für griechisch gebildete Leser war der Leib das Vergängliche, aus dem die Seele befreit werden sollte. Ein göttliches Prinzip, das Fleisch wird, war nicht erhaben, sondern unappetitlich – Kelsos spottete im 2. Jahrhundert genau darüber. Die Zumutung des Prologs lag nicht im Logos, sondern im Fleisch.',
      },
      {
        aspect: 'glaube',
        text: 'Die Vorstellung eines Mittlerwesens zwischen Gott und Welt war verbreitet: Philon von Alexandria, ein jüdischer Zeitgenosse, nannte den Logos das Werkzeug der Schöpfung und den „ersten Sohn“. Der Prolog bewegt sich in dieser Denkform – und bricht sie an einer Stelle, an der Philon nie mitgegangen wäre.',
      },
      {
        aspect: 'macht',
        text: 'Das Evangelium entsteht wohl in den Jahrzehnten nach 70, als der Tempel zerstört und die Zugehörigkeit neu verhandelt wurde. Seine Gemeinde erlebte den Bruch mit der Synagoge; Kapitel 9 spricht vom Ausschluss aus ihr. Die schroffen Abgrenzungen des Buches stammen aus dieser Lage und sind kein Urteil über ein Volk.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'gesellschaft',
        text: 'Nikodemus kommt bei Nacht, und das hat einen handfesten Grund: Ein Mitglied des Hohen Rates, das einen Wanderlehrer aufsucht, riskierte seinen Stand. Öffentliche Zuordnung entschied über Ansehen, Ämter und Geschäfte; ein nächtliches Gespräch war die einzige Form, die keinen Schaden anrichtete.',
      },
      {
        aspect: 'glaube',
        text: 'Der Vers steht hinter dem Hinweis auf die eherne Schlange in der Wüste. Für die Hörer war das kein frommes Bild: Erhöhte Zeichen, an denen Heilung hing, gehörten in die Welt der Amulette und Heilkulte – und ausgerechnet dieses Zeichen war nach 2. Könige 18 aus dem Tempel entfernt worden, weil man ihm opferte.',
      },
      {
        aspect: 'macht',
        text: 'Dass eine Gottheit ihren Sohn hingibt, war antiken Ohren nicht fremd; fremd war, für wen. Kaiserliche Wohltaten galten Verdienten, Bündnispartnern, der eigenen Stadt. Hier gilt die Zuwendung ausdrücklich der Welt, die sich verweigert – ein Adressat, den kein Herrscher jemals gewählt hätte.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'raum',
        text: 'Zum Wochenfest kamen Wallfahrer aus dem ganzen Mittelmeerraum und aus dem Osten; Jerusalem hatte vielleicht 30.000 Einwohner und vervielfachte sich zu den drei Festen. Die Völkerliste ab Vers 9 ist deshalb keine Kulisse, sondern beschreibt, wer an solchen Tagen tatsächlich in der Stadt war.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Griechisch war Verkehrssprache, Aramäisch die Alltagssprache Judäas, Hebräisch die Sprache des Kultes, Latein die der Besatzung. Vielsprachigkeit war Normalzustand. Bemerkenswert ist deshalb nicht, dass viele Sprachen vorkommen, sondern dass jeder die eigene hört – die Muttersprache, nicht die Verkehrssprache.',
      },
      {
        aspect: 'alltag',
        text: 'Der Einwand, die Gruppe sei betrunken, wird mit der Uhrzeit entkräftet: Es ist die dritte Stunde, also gegen neun Uhr morgens. Gegessen wurde die Hauptmahlzeit am späten Nachmittag, Wein gehörte dazu – vormittags betrunken zu sein war auffällig genug, um es überhaupt zu erwähnen.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'gesellschaft',
        text: 'Korinth war eine römische Neugründung auf zerstörtem griechischem Boden, Hafenstadt an zwei Meeren, voller Zugezogener und Freigelassener ohne alte Familienbindung. In einer solchen Stadt entschied Leistung über Rang – und in der Gemeinde wurde entsprechend darüber gestritten, welche Geistesgabe mehr zählt.',
      },
      {
        aspect: 'alltag',
        text: 'Spiegel bestanden aus poliertem Metall, meist Bronze; Korinth war für ihre Herstellung bekannt. Sie zeigten ein brauchbares, aber mattes und leicht verzerrtes Bild. Das Bild vom Sehen „durch einen Spiegel“ ist deshalb keine Klage über Blindheit, sondern die genaue Beschreibung eines Alltagsgegenstands.',
      },
      {
        aspect: 'glaube',
        text: 'Ekstatisches Reden gehörte zur religiösen Erfahrung der Umwelt und galt als Zeichen echter Gottesnähe – von den Orakeln bis zu den Mysterienkulten. Wer in Korinth Zungenrede beanspruchte, beanspruchte damit einen anerkannten Rang. Die Aufzählung am Anfang des Kapitels entwertet genau diese Rangfolge.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'gesellschaft',
        text: 'Die drei genannten Paare sind die Grundunterscheidungen der antiken Rechtsordnung: Bürgerrecht, Freiheitsstand, Geschlecht. An ihnen hing, ob jemand Verträge schließen, vor Gericht auftreten, erben oder wählen konnte. Sie zu nennen und für aufgehoben zu erklären, betraf nicht Empfindungen, sondern Rechtsfähigkeit.',
      },
      {
        aspect: 'alltag',
        text: 'Die Taufe fand als Untertauchen statt; danach wurde ein Gewand angelegt. Kleidung zeigte in der Antike unmittelbar Stand und Herkunft – Toga, Sklaventracht, Provinztracht. Dass alle dasselbe anzogen, war eine sichtbare Aussage, bevor sie eine gedachte war.',
      },
      {
        aspect: 'glaube',
        text: 'Beschneidung war das Zeichen der Zugehörigkeit und im griechisch-römischen Umfeld zugleich Gegenstand von Spott; römische Autoren führen sie unter den Absonderlichkeiten der Juden. Wer sie von Nichtjuden verlangte, verlangte einen sozial teuren Schritt – darum ging der Streit, der diesen Brief auslöste.',
      },
    ],
    terms: [
      {
...

  {
    ...
    reception:
      'Weil Psalm 1 dem Psalter vorangestellt ist, hat er der ganzen Sammlung eine Leserichtung gegeben: Die Psalmen sind nicht nur Gebete, sondern Lehrtexte. Im Judentum ist er deshalb bis heute Grundlage der Vorstellung, dass Beten und Lernen zusammengehören.\n\nDie Zweiwegelehre, die er aufstellt, hat eine lange Nachgeschichte – von der Didache im 1. Jahrhundert über mittelalterliche Erbauungsschriften bis zu Bunyans *Pilgerreise*. Ihre Schwäche ist bekannt und wird in der Bibel selbst benannt: Hiob und Psalm 73 widersprechen der Zusage, dass es dem Gerechten wohlgeht.',
    terms: [
      {
        word: 'hebr. aschre',
        rendered: 'Wohl dem',
        note: 'Ein Ausruf, kein Segenswort: „Glückwunsch dem, der …“ Dasselbe Wortfeld übersetzt die griechische Bibel mit *makarios* – demselben Wort, mit dem die Seligpreisungen beginnen.',
      },
      {
        word: 'hebr. tora',
        rendered: 'Gesetz',
        note: 'Weisung, Unterweisung. Luthers „Gesetz“ ist eine der folgenreichsten Übersetzungsentscheidungen der deutschen Bibel: Aus einer Wegweisung wird eine Vorschrift, aus Lust an ihr eine Pflicht.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Psalm gehört zu den meistgesprochenen Segenstexten bei Reisen, Auswanderungen und Abschieden und steht in vielen Kirchen am Ausgang. Mendelssohn machte aus den Versen 1 bis 4 im *Elias* das Terzett „Hebe deine Augen auf“, eines der bekanntesten Chorstücke des 19. Jahrhunderts.\n\nDie Zusage, dass kein Übel widerfährt, wird in der Seelsorge zurückhaltend verwendet: Sie ist in dieser Form nicht einlösbar, und Trauernden vorgehalten kann sie verletzen. Ausleger weisen darauf hin, dass der Psalm einem Wanderer gilt, dem konkrete Gefahren drohen – Sonnenstich, Steinschlag, Überfall –, und keine Aussage über das Leben im Ganzen macht.',
    terms: [
      {
        word: 'hebr. schir hammaalot',
        rendered: 'Lied im höhern Chor',
        note: 'Wörtlich „Lied der Aufstiege“ – die Überschrift der fünfzehn Psalmen 120 bis 134. Gemeint ist wohl der Aufstieg nach Jerusalem, das auf 750 Metern liegt. Luthers „höherer Chor“ ist eine musikalische Deutung.',
      },
      {
        word: 'hebr. schamar',
        note: 'Behüten, bewachen. Das Wort steht in diesem kurzen Psalm sechsmal und gibt ihm seine Struktur – im Deutschen wechselt Luther zwischen „behüten“ und „bewahren“, sodass die Wiederholung untergeht.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die ersten Verse sind über Verdis Gefangenenchor in *Nabucco* und über den Reggae-Klassiker „Rivers of Babylon“ weit über die Kirche hinaus bekannt geworden – beide Male ohne den Schluss. Für die Rastafari-Bewegung wurde „Babylon“ zum Namen jeder unterdrückenden Ordnung.\n\nDer Fluch der letzten Verse ist eines der schwersten Probleme der Leseordnungen. Die katholische Stundenliturgie lässt ihn seit 1971 weg, viele evangelische Gesangbücher drucken den Psalm gekürzt. Die Gegenposition lautet, dass gerade das Aussprechen des Hasses vor Gott ihn der Tat entzieht – und dass ein Gebetbuch, das solche Sätze streicht, Menschen in äußerster Lage allein lässt.',
    world: [
      {
        aspect: 'raum',
        text: 'Babylonien war ein Land aus Wasser: Euphrat und Tigris, dazu ein dichtes Netz von Bewässerungskanälen, an denen die Verschleppten angesiedelt wurden und deren Unterhalt ihnen oblag. „An den Wassern zu Babel“ meint diese Kanäle – der Ort der Klage ist zugleich der Ort der Zwangsarbeit.',
      },
      {
        aspect: 'macht',
        text: 'Assyrer und Babylonier stellten Deportationen auf ihren Reliefs als Ordnungsleistung dar: Familien mit Bündeln, Karren, Vieh, geleitet von Soldaten. Verschleppt wurden gezielt Handwerker, Schreiber und Oberschicht – wer ein Land wehrlos machen wollte, nahm ihm die, die es verwalten konnten.',
      },
      {
        aspect: 'arbeit',
        text: 'Tempelmusiker waren Berufsleute mit Anstellung am Heiligtum. Mit dem Tempel fiel ihre Existenzgrundlage weg, und die Aufforderung der Sieger, ein Zionslied vorzutragen, verlangte von ihnen, ihr zerstörtes Handwerk zur Unterhaltung vorzuführen.',
      },
    ],
    terms: [
      {
        word: 'hebr. bat babel',
        note: 'Wörtlich „Tochter Babel“ – eine übliche Personifizierung der Stadt, wie auch „Tochter Zion“. Der Fluch am Ende gilt damit sprachlich der Stadt, nicht einzelnen Kindern; das entschärft ihn nicht, verschiebt aber die Ebene.',
      },
      {
        word: 'hebr. schir',
        rendered: 'Lied',
        note: 'Lied, auch Tempelgesang. Die Aufforderung der Sieger, ein Zionslied zu singen, verlangt vom Besiegten, seinen zerstörten Kult zur Unterhaltung vorzuführen – darin liegt die Demütigung, nicht im Singen selbst.',
      },
    ],
    interpretations: [
      {
...

  {
    ...
    world: [
      {
        aspect: 'gesellschaft',
        text: 'Verlobt wurde früh, oft mit zwölf bis vierzehn Jahren; die Verlobung war rechtlich bindend und ließ sich nur durch Scheidungsbrief lösen. Eine Schwangerschaft in dieser Zeit brachte die Frau in Lebensgefahr und die Familie in Schande. Das Lied wird aus dieser Lage heraus gesungen.',
      },
      {
        aspect: 'macht',
        text: 'Herrscher vom Thron zu stoßen war keine fromme Redewendung: Innerhalb weniger Jahrzehnte hatte Judäa Hasmonäer, Herodes, seine Söhne und römische Statthalter erlebt, dazu Aufstände und deren Niederschlagung. Wer von Umstürzen sang, sang über Erlebtes.',
      },
      {
        aspect: 'arbeit',
        text: 'Nazareth war ein Dorf mit vielleicht zweihundert bis vierhundert Einwohnern, ohne Synagogenbau aus Stein, ohne Straße, mit Höhlen als Vorratsräumen. Vier Kilometer entfernt wuchs Sepphoris zur Residenzstadt. Wer die Hungrigen und die Reichen besingt, hatte beides in Sichtweite.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'macht',
        text: 'Eine Schätzung war Steuererfassung, und Steuererfassungen lösten Aufstände aus: Josephus berichtet, dass die Zählung des Quirinius im Jahr 6 den Aufstand des Judas Galiläus auslöste, aus dem die Bewegung der Zeloten hervorging. Wer den ersten Satz hörte, hörte keinen Kalendereintrag, sondern eine Reizvokabel.',
      },
      {
        aspect: 'alltag',
        text: 'Häuser hatten einen Raum mit erhöhtem Wohnbereich und einer tiefer gelegenen Fläche, auf der nachts das Vieh stand; Futterkrippen lagen an der Schwelle dazwischen. Eine Krippe im Haus ist deshalb kein Notbehelf im Freien, sondern die naheliegende Ablage für einen Säugling in einem überfüllten Wohnraum.',
      },
      {
        aspect: 'arbeit',
        text: 'Hirten arbeiteten nachts und im Freien, waren dadurch von Sabbat und Tempelbesuch weitgehend abgeschnitten und galten als Zeugen vor Gericht wenig. Die rabbinische Literatur führt sie unter den Berufen mit schlechtem Ruf. Die Nachricht ergeht an Leute, deren Aussage vor keinem Gericht gezählt hätte.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'raum',
        text: 'Der See liegt 210 Meter unter dem Meeresspiegel, umgeben von Hochland. Kalte Luft von den Golanhöhen fällt in den warmen Kessel und erzeugt binnen Minuten steile, kurze Wellen. Fischer kannten das und fuhren nachts trotzdem – dann standen die Schwärme.',
      },
      {
        aspect: 'arbeit',
        text: 'Das Boot, das 1986 am Seeufer gefunden wurde, misst gut acht Meter und bot Platz für rund fünfzehn Mann – ein Familienbetrieb mit Schleppnetz. Fischerei war ein reguliertes Gewerbe mit Pachtabgaben an den Landesherrn; die Zebedäus-Söhne hatten Tagelöhner, gehörten also zum besseren Mittelstand.',
      },
      {
        aspect: 'glaube',
        text: 'Das Meer galt als Sitz des Chaos, nicht als Erholungsraum; Israel war kein Seefahrervolk, und das Tier der Offenbarung steigt aus dem Wasser. Wer einem Sturm gebietet wie einem Dämon, greift damit an einer Stelle ein, die nach allgemeiner Überzeugung Gott vorbehalten war.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'alltag',
        text: 'Schafe und Ziegen weideten gemeinsam und wurden abends getrennt: Ziegen sind kälteempfindlich und kamen unter Dach, Schafe blieben im Freien. Das Bild beschreibt einen Handgriff, den jeder Hirte täglich tat – keine Wertung des Tieres, sondern eine Routine.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Gefangene wurden von der Obrigkeit nicht verpflegt: Wer im Kerker saß, war auf Angehörige angewiesen, die Essen brachten. Ein Gefängnisbesuch war deshalb keine Geste, sondern Versorgung – und er brachte den Besucher selbst in den Verdacht, zur Sache des Häftlings zu gehören.',
      },
      {
        aspect: 'arbeit',
        text: 'Die sechs Handlungen sind die Grundleistungen der Gastfreundschaft und der Nachbarschaftshilfe: speisen, tränken, beherbergen, kleiden, pflegen, besuchen. Fünf davon stehen bereits bei Jesaja 58. Es ist die Liste dessen, was ein Haushalt für einen Fremden tun konnte, ohne Geld auszugeben.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'recht',
        text: 'Zum Beweis eines Ehebruchs verlangte das Recht zwei Zeugen der Tat selbst – eine Hürde, die kaum je zu nehmen war und die den Vorgang hier verdächtig macht. Zudem hätten beide Beteiligten vor Gericht gehört; der Mann fehlt. Und die Zeugen mussten den ersten Stein werfen, also die Hinrichtung beginnen.',
      },
      {
        aspect: 'macht',
        text: 'Todesurteile waren dem Statthalter vorbehalten. Eine Steinigung durchzuführen hieß also, römisches Recht zu brechen; sie zu verweigern hieß, sich gegen die Tora zu stellen. Die Falle funktioniert nur, weil beide Rechtsordnungen gleichzeitig galten.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Die Frau steht „in der Mitte“ – öffentlich vorgeführt vor einer Menge im Tempelbezirk. Ehre war das entscheidende Gut, und die Bloßstellung war bereits die halbe Strafe. Der Text lässt sie bis zum vorletzten Vers schweigen und niemand fragt sie.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'gesellschaft',
        text: 'Die Jünger sitzen hinter verschlossenen Türen „aus Furcht vor den Juden“ – gemeint sind die Behörden, nicht das Volk. Nach der Hinrichtung des Anführers war der Kreis der Anhänger gefährdet; Rom verfuhr mit Restgruppen von Aufständischen gründlich. Die Szene spielt in einem Versteck.',
      },
      {
        aspect: 'macht',
        text: 'Domitian, unter dem das Evangelium vermutlich entsteht, ließ sich nach Sueton als „dominus et deus“ anreden. Wer diese Formel einem Hingerichteten zusprach, sprach sie dem Kaiser ab. Das Bekenntnis des Thomas war damit nicht nur fromm, sondern gefährlich.',
      },
      {
        aspect: 'glaube',
        text: 'Auferstehung erwarteten Pharisäer am Ende der Zeiten und für alle; Sadduzäer bestritten sie ganz. Dass ein Einzelner mitten in der Geschichte aufersteht, passte in keine der beiden Vorstellungen – der Zweifel des Thomas ist deshalb der Normalfall, nicht die Ausnahme.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'raum',
        text: 'Galiläa lag drei Tagereisen von Jerusalem entfernt und galt als Provinz: gemischt besiedelt, mit eigenem Dialekt, den man in der Hauptstadt heraushörte. Dass der Auftrag dort ergeht und nicht im Tempel, ist eine Ortswahl gegen das Zentrum.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Reisen bedeutete zu Fuß gehen, etwa 25 bis 30 Kilometer am Tag, auf Straßen mit Wegelagerern und in Herbergen mit schlechtem Ruf. „Gehet hin in alle Welt“ war für die ersten Hörer keine Redewendung, sondern eine Zumutung mit Wegzeit in Monaten.',
      },
      {
        aspect: 'glaube',
        text: 'Übertritte zum Judentum gab es, aber sie liefen über Beschneidung, Tauchbad und Gesetzesbindung und blieben eine Ausnahme. Eine Bewegung, die planmäßig Nichtjuden aufnimmt, ohne dies zu verlangen, hatte in der Umwelt kein Vorbild.',
      },
    ],
    terms: [
      {
...

  {
    ...
    world: [
      {
        aspect: 'glaube',
        text: 'Kinderopfer waren in der Umwelt bezeugt und werden im Alten Testament immer wieder scharf verboten – ein Verbot braucht man nur für das, was vorkommt. Aus punischen Städten wie Karthago sind Bezirke mit Urnen von Kleinkindern bekannt, deren Deutung bis heute umstritten ist. Für die ersten Hörer war der Auftrag also nicht undenkbar, sondern schrecklich denkbar.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Der erstgeborene Sohn war keine Gefühlssache, sondern die Altersversorgung, der Rechtsnachfolger und der Träger des Namens. Wer ihn verlor, verlor seine Zukunft im wörtlichen Sinn. Isaak ist zudem das Kind, an dem die ganze Zusage von Kapitel 12 hängt.',
      },
      {
        aspect: 'recht',
        text: 'Über Leben und Tod der Angehörigen entschied im Alten Orient der Hausherr; die väterliche Gewalt reichte weit und wurde von keinem Gericht überprüft. Die Erzählung setzt dieses Recht voraus – und stellt sich am Ende dagegen, indem sie es zurückruft.',
      },
    ],
    terms: [
      {
    ...
    terms: [
      {
        ...
        note: 'Wörtlich „der Mann zwischen beiden“ – der Vorkämpfer, der den Zweikampf stellvertretend für sein Heer austrägt. Die Form ist auch aus griechischen und hethitischen Quellen bekannt.',
      },
      {
        word: 'hebr. milchama',
        rendered: 'Streit',
        note: 'Krieg, Schlacht. Der Satz „der Streit ist des HERRN“ nimmt eine feste Wendung der Kriegserzählungen auf und dreht sie um: Nicht Waffen entscheiden, und die Beute gehört nicht dem Sieger.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die Szene gilt als der klassische Fall prophetischer Machtkritik und wird in kirchlichen Stellungnahmen zu Amtsmissbrauch regelmäßig herangezogen – zuletzt in den Aufarbeitungsberichten zu sexualisierter Gewalt in beiden großen Kirchen, wo Nathan als Gegenbild zur Vertuschung genannt wird.\n\nIn der Literaturgeschichte hat der Kunstgriff Schule gemacht: Eine Geschichte, die den Zuhörer zum Richter macht, bevor sie ihn zum Angeklagten macht, findet sich von der antiken Rhetorik bis in Shakespeares Dramen. Dass Israel die Erzählung über seinen größten König aufbewahrt hat, ist im Alten Orient ohne Beispiel.',
    terms: [
      {
        word: 'hebr. atta haisch',
        rendered: 'Du bist der Mann',
        note: 'Drei Wörter im Hebräischen, an der Stelle, an der David selbst das Urteil gesprochen hat. Die Wendung ist zum Musterfall dafür geworden, wie eine Erzählung einen Hörer überführt, den ein direkter Vorwurf nicht erreicht hätte.',
      },
      {
        word: 'hebr. arbatajim',
        rendered: 'vierfältig',
        note: 'Vierfacher Ersatz – genau das, was 2. Mose 21 für ein gestohlenes Schaf vorschreibt. David spricht also geltendes Recht, ohne zu wissen, dass er sich selbst verurteilt.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'hinkt ihr auf beide Seiten',
        note: 'Wörtlich „hinken auf zwei Ästen“ oder „auf zwei Schwellen“. Dasselbe Verb beschreibt später den Tanz der Baalspropheten um den Altar – der Erzähler stellt beides mit einem Wortspiel nebeneinander.',
      },
      {
        word: 'hebr. baal',
        rendered: 'Baal',
        note: 'Wörtlich „Herr“, „Besitzer“. Kein Eigenname, sondern ein Titel des Wettergottes, der Regen gibt – deshalb ist eine Dürre der Streitfall, an dem sich seine Zuständigkeit erweisen muss.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    terms: [
      {
        word: 'aram. we hen la',
        rendered: 'Und wo er\'s nicht tun will',
        note: 'Der Satz, an dem die ganze Erzählung hängt: „und wenn nicht“. Die drei rechnen ausdrücklich damit, dass die Rettung ausbleibt, und ändern ihre Antwort trotzdem nicht.',
      },
      {
        word: 'aram. zelem',
        rendered: 'Bild',
        note: 'Standbild, Statue – dasselbe Wort, mit dem Genesis 1 den Menschen als Bild Gottes bezeichnet. Der Erzähler stellt zwei Bilder gegeneinander: das goldene des Königs und das lebendige, das sich weigert.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Das Buch wird im Judentum am Nachmittag des Versöhnungstags vollständig gelesen – ein Text über Umkehr, die auch Feinden offensteht, am strengsten Bußtag des Jahres. Die Schlussfrage bleibt dabei unbeantwortet stehen, und die Gemeinde geht mit ihr nach Hause.\n\nDie letzten Worte des Buches – „dazu auch viele Tiere“ – haben eine eigene Wirkung entfaltet: In der theologischen Tierethik gehören sie zu den meistzitierten Sätzen der Bibel, weil Gott sein Erbarmen ausdrücklich auch auf die Tiere der Stadt bezieht.',
    terms: [
      {
        word: 'hebr. qiqajon',
        rendered: 'Rizinus',
        note: 'Eine Pflanze, die nur hier vorkommt und schnell wächst – Rizinus oder Flaschenkürbis. Hieronymus’ Entscheidung für „Efeu“ statt „Kürbis“ löste im 5. Jahrhundert einen Streit mit Augustinus aus; in Nordafrika soll es deswegen Tumulte gegeben haben.',
      },
      {
        word: 'hebr. chus',
        rendered: 'jammert',
        note: 'Mitleid haben, schonen. Dasselbe Verb steht für Jonas Mitleid mit der Pflanze und für Gottes Mitleid mit der Stadt – die Schlussfrage besteht darin, dass es zweimal dasselbe Wort ist.',
      },
    ],
    interpretations: [
      {
...

  {
    ...
    world: [
      {
        aspect: 'arbeit',
        text: 'Gesät wurde vor dem Pflügen: Der Sämann ging über das Stoppelfeld und streute breitwürfig, danach wurde untergepflügt. Dass Körner auf den Weg, auf Fels und in Dornen fallen, ist deshalb kein Missgeschick, sondern der normale Verlust eines Verfahrens ohne Reihensaat.',
      },
      {
        aspect: 'raum',
        text: 'Ein Feld im Bergland war selten eine ebene Fläche: Zwischen Terrassen lagen Pfade, unter der Krume stand oft Kalkfels, an den Rändern wuchs Gestrüpp. Alle vier Bodenarten des Gleichnisses konnten auf demselben Acker vorkommen – die Zuhörer sahen keinen Vergleich, sondern ihre Parzelle.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Erträge lagen bei fünf- bis zehnfacher Aussaat; ein Drittel der Ernte ging für Saatgut, Abgaben und Zehnten wieder ab. Dreißig-, sechzig- und hundertfach war deshalb keine gute Ernte, sondern eine unmögliche – die Zahl markiert das Ende der gewohnten Rechnung.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'recht',
        text: 'Gekreuzigt wurden Sklaven und Aufrührer, nie römische Bürger. Der Verurteilte trug den Querbalken selbst zum Hinrichtungsort, durch die Stadt, als abschreckende Vorführung. Wer „sein Kreuz auf sich nehmen“ hörte, sah diesen Zug – das Bild war öffentlich und regelmäßig zu besichtigen.',
      },
      {
        aspect: 'macht',
        text: 'Rom kreuzigte planmäßig gegen Aufstände: Nach dem Tod des Herodes ließ Varus bei Jerusalem zweitausend Menschen hinrichten. Wer in Galiläa aufwuchs, hatte solche Reihen gesehen. Eine Nachfolge, die mit diesem Wort beschrieben wird, kündigt eine politische Einordnung an.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Ein Anführer, der scheiterte, entwertete seine Anhänger mit: Man wechselte zur nächsten Bewegung. Genau deshalb ist Petrus’ Widerspruch naheliegend und nicht kleinmütig – ein leidender Messias war nach allem, was man kannte, ein widerlegter Messias.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'raum',
        text: 'Sechzig Stadien sind rund elf Kilometer – zwei bis drei Stunden zu Fuß, also eine Strecke, die man am Nachmittag beginnt und vor Dunkelheit beendet. Deshalb drängen die beiden am Ende zum Bleiben: Nach Einbruch der Nacht reiste niemand freiwillig weiter.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Gastfreundschaft war Pflicht, aber sie hatte eine Ordnung: Der Hausherr brach das Brot und sprach den Segen. Dass der Gast das übernimmt, ist ein Bruch der Rollen – und genau in diesem Moment erkennen sie ihn.',
      },
      {
        aspect: 'macht',
        text: '„Wir hofften, er werde Israel erlösen“ ist eine politische Erwartung. Erlösung meinte das Ende der Besatzung, wie sie die Makkabäer erreicht hatten. Die Enttäuschung der beiden ist deshalb konkret: Sie gehen von einem gescheiterten Aufstand nach Hause.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'alltag',
        text: 'Wasserholen war Frauenarbeit und geschah morgens und abends gemeinsam – der Brunnen war der Nachrichtenumschlagplatz des Dorfes. Ein Krug fasste rund zwanzig Liter und wurde auf dem Kopf getragen. Dass diese Frau zur heißesten Tageszeit allein kommt, sagt über ihre Stellung im Ort mehr als jede Beschreibung.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Ein Mann sprach eine fremde Frau nicht öffentlich an, ein Lehrer schon gar nicht; die Jünger wundern sich im Text ausdrücklich darüber. Hinzu kam die Speise- und Reinheitsfrage: Aus dem Gefäß einer Samaritanerin zu trinken galt vielen als unmöglich. Drei Grenzen fallen in einem einzigen Satz.',
      },
      {
        aspect: 'recht',
        text: 'Über Ehen entschieden Männer. Eine Frau konnte in der Regel nicht scheiden, wohl aber verstoßen werden – wegen Kinderlosigkeit, wegen eines Streits, nach damaliger Schuldebatte teils schon wegen einer angebrannten Mahlzeit. Fünf Männer sind deshalb zuerst eine Auskunft über fünf Verstoßungen oder Todesfälle, nicht über ihren Lebenswandel.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'gesellschaft',
        text: 'Athen lebte zu dieser Zeit von seiner Vergangenheit: politisch bedeutungslos, aber Universitätsstadt des Reiches, in der man sich Bildung holte. Lukas’ spöttische Bemerkung über Leute, die nichts anderes taten, als Neues zu hören, trifft ein zeitgenössisches Klischee über die Stadt.',
      },
      {
        aspect: 'glaube',
        text: 'Epikureer und Stoiker, die der Text nennt, waren keine Religionen, sondern Lebenslehren: Die einen erklärten die Götter für unbeteiligt, die anderen sahen die Welt von einer Vernunft durchwaltet. Beide bestritten eine leibliche Auferstehung – die einen, weil danach nichts kommt, die anderen, weil der Leib das Geringere ist.',
      },
      {
        aspect: 'macht',
        text: 'Der Areopag war ein alter Rat mit Aufsicht über Kult und Lehre in der Stadt. Sokrates war knapp fünfhundert Jahre zuvor wegen Einführung neuer Gottheiten hingerichtet worden – der Vorwurf gegen Paulus in Vers 18 lautet fast wörtlich gleich. Das ist keine Podiumsdiskussion.',
      },
    ],
    terms: [
      {
    ...
    terms: [
      {
        word: 'hebr. chaschab',
        rendered: 'gedachtet',
        note: 'Planen, berechnen, anrechnen. Derselbe Ausdruck steht für die Brüder und für Gott: „Ihr plantet es böse, Gott plante es gut.“ Das Hebräische stellt zwei Rechnungen nebeneinander, ohne die erste zu streichen.',
      },
      {
        word: 'hebr. hatachat elohim ani',
        rendered: 'ich bin unter Gott',
        note: 'Wörtlich „bin ich an Gottes Statt?“ – eine rhetorische Frage. Josef weist die Rolle des Richters zurück, statt einen Freispruch zu erteilen. Luthers Fassung ist enger als der hebräische Wortlaut.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'alltag',
        text: 'Fleisch war Festessen, nicht Alltagskost – ein Bauernhaushalt schlachtete wenige Male im Jahr. Gegessen wurde am Abend, im Kreis um eine Schüssel, mit den Fingern und mit Fladenbrot als Löffel. Dass für einen einzigen Abend ein ganzes Tier draufging, markierte den Ausnahmetag.',
      },
      {
        aspect: 'glaube',
        text: 'Blut an Türpfosten und Sturz gehört zu den ältesten Schutzbräuchen überhaupt und ist aus mehreren Kulturen bezeugt. Die Tür war die Schwelle zwischen dem geordneten Innen und dem, was draußen umging; sie wurde markiert, gesalbt, mit Zeichen versehen. Der Ritus setzt diese Vorstellung voraus, statt sie zu erklären.',
      },
      {
        aspect: 'arbeit',
        text: 'Der Termin ist kein Zufall: Das Fest liegt am Beginn der Gerstenernte, dem gefährlichsten Punkt des Bauernjahres, an dem sich entscheidet, ob ein Haushalt durch das Jahr kommt. Hirten wiederum brachen im Frühjahr zu den Sommerweiden auf. Beide Lebensformen hatten in diesen Wochen ihren Wendepunkt.',
      },
    ],
    terms: [
      {
    ...
    terms: [
      {
        word: 'hebr. asasel',
        rendered: 'Asasel',
        note: 'Ein Wort, dessen Bedeutung unbekannt ist: ein Ortsname, ein Dämon der Wüste oder eine Wendung für „vollständige Entfernung“. Luther behält es unübersetzt; die griechische Bibel machte daraus den „Fortgeschickten“, woraus im Englischen der *scapegoat* wurde.',
      },
      {
        word: 'hebr. kipper',
        rendered: 'versöhne',
        note: 'Bedecken oder abwischen – der Fachausdruck für das, was am Versöhnungstag geschieht. Vom selben Wort kommt der Name des Tages: Jom Kippur.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Satz „Ich aber und mein Haus wollen dem HERRN dienen“ steht auf Hausinschriften, Grußkarten und in Ordinationsgottesdiensten und ist einer der meistzitierten Bekenntnissätze überhaupt – meist ohne den Vers danach, in dem Josua dem Volk die Zusage schlicht nicht abnimmt: „Ihr könnt dem HERRN nicht dienen.“\n\nDie Erzählung setzt voraus, dass unter den Versammelten Menschen sehr verschiedener Herkunft waren – solche „jenseits des Stroms“ und aus Ägypten. Die Forschung liest darin die Erinnerung an einen Zusammenschluss unterschiedlicher Gruppen zu einem Bund, nicht die Bekehrung eines bereits bestehenden Volkes.',
    terms: [
      {
        word: 'hebr. bacharu lachem',
        rendered: 'erwählt euch',
        note: 'Wählt euch aus. Die Aufforderung setzt voraus, dass es etwas zu wählen gibt – der Text rechnet mit einer Versammlung, in der keineswegs alle dasselbe glauben.',
      },
      {
        word: 'hebr. abad',
        rendered: 'dienen',
        note: 'Dienen, arbeiten für – dasselbe Verb wie für den Sklavendienst in Ägypten. Die Frage lautet nicht, woran man glaubt, sondern wem man arbeitet.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Das Vlies, mit dem Gideon zweimal ein Zeichen erbittet, ist in die Frömmigkeitssprache eingegangen: „ein Vlies auslegen“ heißt in evangelikalen Kreisen bis heute, Gott um ein Zeichen für eine Entscheidung zu bitten. Der Erzähler bewertet die Bitte nicht, aber sie steht in einer Reihe von Rückversicherungen, die immer neue Bestätigung verlangen.\n\nDie Fortsetzung wird selten mitgelesen: Gideon lehnt am Ende das Königtum ab – „der HERR soll über euch herrschen“ –, lässt sich aber das Gold der Beute geben und macht daraus ein Kultbild, dem Israel nachläuft. Das Buch erzählt seinen Helden bis zu diesem Schluss.',
    terms: [
      {
        word: 'hebr. gibbor hechajil',
        rendered: 'streitbarer Held',
        note: 'Wörtlich „Held der Kraft“ – eine militärische Auszeichnung. Sie trifft einen Mann, der gerade Weizen in einer Kelter drischt, um ihn vor Plünderern zu verstecken. Der Erzähler stellt Anrede und Lage mit Absicht gegeneinander.',
      },
      {
        word: 'hebr. hazzair',
        rendered: 'der Kleinste',
        note: 'Der Jüngste, der Geringste. Gideons Einwand folgt einem Muster, das sich durch die ganze Bibel zieht – Mose, Saul, Jeremia antworten ähnlich, und keiner wird damit entlassen.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'Dein Volk ist mein Volk',
        note: 'Die Reihenfolge ist bemerkenswert: erst das Volk, dann Gott. Rut schließt sich einer Familie an, und der Glaube kommt mit. Im Judentum gilt der Satz als Grundtext für den Übertritt.',
      },
      {
        word: 'hebr. mara',
        note: 'Die Bittere. Noomi, „die Liebliche“, verlangt in Vers 20 diesen Namen für sich – ein Wortspiel, das im Deutschen verschwindet und den Ton des ganzen Kapitels bestimmt.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'hebr. zaraat',
        rendered: 'Aussatz',
        note: 'Ein Sammelbegriff für Hautveränderungen, der auch Schimmel an Wänden und Kleidern bezeichnet – nicht die heutige Lepra. Die Folge war nicht Todesgefahr, sondern kultische Unreinheit und Ausschluss aus der Gemeinschaft.',
      },
      {
        word: 'hebr. lech leschalom',
        rendered: 'Zieh hin mit Frieden',
        note: 'Die übliche Verabschiedung. Elisa antwortet damit auf Naamans Frage, ob er weiter im Tempel des Rimmon dienen dürfe – und entscheidet sie damit gerade nicht. Der Text lässt die Frage offen stehen.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    terms: [
      {
        word: 'hebr. meforasch',
        rendered: 'klar und verständlich',
        note: 'Das Wort ist unklar: „deutlich“, „abschnittweise“ oder „übersetzt“. Die dritte Bedeutung ist gut möglich – das Volk sprach inzwischen Aramäisch, und die Leviten hätten den hebräischen Text mündlich übertragen. Damit stünde hier die früheste Nachricht über Bibelübersetzung.',
      },
      {
        word: 'hebr. chedwat JHWH',
        rendered: 'Freude am HERRN',
        note: 'Ein seltenes Wort für Freude. Der Satz ist keine Stimmungsaufforderung: Er wird Menschen gesagt, die beim Hören des Gesetzes zu weinen begonnen haben, und lenkt den Tag ausdrücklich weg von der Trauer.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'von einem andern Ort her',
        note: 'Wörtlich „von einem anderen Ort“. Die rabbinische Tradition liest „der Ort“ als Umschreibung für Gott – Mordechai sagt dann verhüllt, was das Buch sonst nie ausspricht. Sicher ist das nicht.',
      },
      {
        word: 'hebr. kaascher awadti awadti',
        rendered: 'komme ich um, so komme ich um',
        note: 'Eine Verdopplung desselben Verbs, wie sie das Hebräische für Entschiedenheit gebraucht – vergleichbar mit „ich gehe, und damit basta“. Kein Fatalismus, sondern eine Entscheidung.',
      },
    ],
    interpretations: [
      {
...

  {
    ...
    reception:
      'Händels *Messiah* macht aus dem Vers die Sopranarie „I know that my Redeemer liveth“ und stellt sie an den Beginn des dritten Teils, unmittelbar vor die Auferstehungstexte. Diese Verbindung hat die christliche Wahrnehmung des Verses geprägt: Er gilt seither als alttestamentliches Osterzeugnis und steht auf unzähligen Grabsteinen.\n\nDer hebräische Text trägt das nicht ohne weiteres. Er gehört zu den am schwersten zu übersetzenden Stellen der Bibel, und der Zusammenhang ist eine Anklage: Hiob verlangt einen Rechtsbeistand gegen Gott. Dass ein Vers aus einem Prozess gegen Gott zum Trostwort am Grab wurde, ist eine der bemerkenswertesten Verschiebungen der Auslegungsgeschichte.',
    terms: [
      {
        word: 'hebr. goel',
        rendered: 'Erlöser',
        note: 'Der Löser: der nächste Verwandte, der verpflichtet ist, einen Verarmten freizukaufen, sein Land zurückzuerwerben oder sein Blut zu rächen. Ein Rechtsbegriff aus dem Sippenrecht – Hiob verlangt einen Anwalt, keinen Erlöser im späteren Sinn.',
      },
      {
        word: 'hebr. acharon',
        rendered: 'der letzte',
        note: 'Der Letzte, der Spätere. Der Satz kann heißen, dass der Löser zuletzt auftritt – am Ende des Verfahrens –, oder dass er über dem Staub des Grabes steht. Beide Deutungen sind vertretbar, und daran hängt, ob der Vers von Auferstehung spricht.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Aus Vers 23 wurde das Lied „Great Is Thy Faithfulness“, eines der meistgesungenen englischsprachigen Kirchenlieder des 20. Jahrhunderts, und im deutschen Sprachraum „Alle Morgen neu“. Der Vers steht in unzähligen Andachtsbüchern als Morgengebet.\n\nSein Ort im Buch wird dabei selten mitgesagt: Er steht mitten in einer Sammlung von Klageliedern über die Zerstörung Jerusalems 587 vor Christus, unmittelbar nach der Aussage, Gott habe den Beter „mit Bitterkeit gesättigt“ – und danach geht die Klage weiter. Das Buch endet mit einer offenen Frage, nicht mit dem Trost. In der Synagoge wird es am 9. Aw gelesen, dem Gedenktag beider Tempelzerstörungen.',
    terms: [
      {
        word: 'hebr. chesed',
        rendered: 'Güte',
        note: 'Güte und Vertragstreue zugleich – die Zuwendung, zu der niemand verpflichtet ist und die trotzdem gehalten wird. Der Vers steht im Plural: Gottes Gütigkeiten sind es, dass wir nicht aufgehört haben.',
      },
      {
        word: 'hebr. emuna',
        rendered: 'Treue',
        note: 'Von derselben Wurzel wie „Amen“: Festigkeit, Verlässlichkeit. Nicht ein Gefühl der Treue, sondern die Eigenschaft, dass etwas trägt.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'hebr. alma',
        rendered: 'Jungfrau',
        note: 'Junge Frau im heiratsfähigen Alter. Ob sie unverheiratet ist, sagt das Wort nicht; dafür gäbe es im Hebräischen *betula*. Die griechische Übersetzung des 3. Jahrhunderts vor Christus wählte *parthenos*, das „Jungfrau“ heißen kann – und Matthäus zitiert diese Fassung.',
      },
      {
        word: 'hebr. immanu el',
        rendered: 'Immanuel',
        note: 'Ein Satzname: „Mit uns Gott“. Im Zusammenhang ist er ein Datum – solange das Kind noch nicht unterscheiden kann, wird die Bedrohung vorbei sein.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Händels *Messiah* beginnt mit diesem Kapitel – „Comfort ye, my people“ ist die erste gesungene Nummer des Werks –, und in der Adventsliturgie ist es der meistgelesene Prophetentext. Im Judentum eröffnet es die Reihe der sieben Trostlesungen zwischen dem 9. Aw und dem Neujahrsfest; der Sabbat danach heißt nach dem ersten Wort Schabbat Nachamu.\n\nDie Beobachtung, dass die Kapitel 40 bis 55 rund 150 Jahre nach dem historischen Jesaja in die Exilszeit sprechen, geht auf Johann Christoph Döderlein 1775 zurück. Sie gehört heute zum Grundbestand der Forschung und wird in Teilen evangelikaler Auslegung bis heute bestritten.',
    terms: [
      {
        word: 'hebr. nachamu',
        rendered: 'Tröstet',
        note: 'Eine Befehlsform in der Mehrzahl, zweimal gesetzt. Wer angeredet wird, sagt der Text nicht – vermutlich der himmlische Hofstaat. Der Prophet hört zu, wie ein Auftrag erteilt wird, der nicht ihm gilt.',
      },
      {
        word: 'hebr. bammidbar',
        rendered: 'in der Wüste',
        note: 'Die Wortstellung ist mehrdeutig: „eine Stimme ruft in der Wüste“ oder „bereitet in der Wüste den Weg“. Die griechische Bibel wählt das erste, und die Evangelien folgen ihr, wenn sie Johannes den Täufer so beschreiben.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'hebr. naar',
        rendered: 'zu jung',
        note: 'Junge, Bursche, Diener – die Spanne reicht vom Kind bis zum jungen Mann. Der Einwand meint nicht ein Alter, sondern einen Rang: Wer *naar* ist, hat nichts zu sagen.',
      },
      {
        word: 'hebr. jadati',
        rendered: 'Ich kannte dich',
        note: 'Erkennen im Sinn eines Verhältnisses, nicht einer Information. Derselbe Ausdruck steht für Gottes Erwählen – die Aussage lautet nicht, dass Gott etwas über Jeremia wusste, sondern dass er ihn kannte.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Matthäus zitiert Vers 1 – „aus Ägypten habe ich meinen Sohn gerufen“ – für die Rückkehr der Familie aus Ägypten. Bei Hosea steht der Satz in der Vergangenheit und meint den Auszug Israels; das Zitat ist ein Musterbeispiel dafür, wie das Neue Testament alttestamentliche Sätze neu besetzt.\n\nTheologisch ist der Abschnitt einer der meistdiskutierten des Alten Testaments, weil er einen Sinneswandel in Gott beschreibt. Die klassische Lehre von der Unveränderlichkeit Gottes hat damit Mühe; die Prozesstheologie des 20. Jahrhunderts und Abraham Joshua Heschels Werk über das „Pathos Gottes“ berufen sich ausdrücklich auf ihn.',
    terms: [
      {
        word: 'hebr. nehpach libbi',
        rendered: 'mein Herz ist andern Sinnes',
        note: 'Wörtlich „mein Herz hat sich in mir umgewandt“ – dasselbe Verb beschreibt das Umstürzen von Sodom und Gomorra. Was sonst Städte zerstört, geschieht hier in Gott selbst.',
      },
      {
        word: 'hebr. nichumaj',
        rendered: 'Barmherzigkeit',
        note: 'Trost, Mitleid, Reue – von derselben Wurzel wie „sich erbarmen“ und „seinen Sinn ändern“. Der Vers sagt wörtlich, dass Gottes Mitleid „heiß wird“ oder sich „erregt“.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    terms: [
      {
        word: 'hebr. jom JHWH',
        rendered: 'des HERRN Tag',
        note: 'Ursprünglich wohl der Tag, an dem Gott für sein Volk in den Krieg zieht – also ein Siegestag. Amos ist der erste, der ihn umkehrt: Finsternis und nicht Licht. Von ihm aus wächst die ganze spätere Rede vom Gerichtstag.',
      },
      {
        word: 'hebr. mischpat / zedaka',
        rendered: 'Recht',
        note: 'Recht und Gerechtigkeit, im Hebräischen ein festes Wortpaar. Gemeint ist keine abstrakte Ordnung, sondern das, was einem Menschen im Rechtsstreit am Stadttor zusteht.',
      },
    ],
    interpretations: [
      {
...

  {
    ...
    reception:
      'Aus den Weisen wurden Könige – wegen Psalm 72 und Jesaja 60 –, dann drei, dann Caspar, Melchior und Balthasar; seit dem Mittelalter ruhen ihre Gebeine angeblich im Kölner Dom, wohin sie 1164 aus Mailand gebracht wurden. Die Sternsinger, die als C+M+B an Türen schreiben, gehen auf diese Legendenbildung zurück.\n\nDie politische Seite der Erzählung wird seltener erzählt: Auf den Besuch folgt der Kindermord in Bethlehem und die Flucht nach Ägypten. Matthäus zeichnet die Kindheit Jesu als Fluchtgeschichte, und in kirchlichen Stellungnahmen zum Flüchtlingsschutz ist dieses Kapitel der meistzitierte Text.',
    world: [
      {
        aspect: 'macht',
        text: 'Herodes der Große regierte als von Rom eingesetzter Klientelkönig und sicherte seine Stellung mit Bauwerken und mit Blut: Josephus berichtet von der Hinrichtung dreier eigener Söhne und seiner Frau Mariamne. Kaiser Augustus soll gespottet haben, er wäre lieber Herodes’ Schwein als sein Sohn. Wer das wusste, fand den Kindermord nicht unwahrscheinlich.',
      },
      {
        aspect: 'glaube',
        text: 'Sterndeutung war Wissenschaft, nicht Aberglaube: In Babylonien wurden über Jahrhunderte Himmelsbeobachtungen aufgezeichnet, und Herrscherwechsel las man am Himmel ab. Ein Hof, der von auswärtigen Sterndeutern die Geburt eines Königs gemeldet bekam, hatte einen ernsten Anlass zur Sorge.',
      },
      {
        aspect: 'raum',
        text: 'Von Jerusalem nach Bethlehem sind es rund neun Kilometer – eine Wegstunde. Der Ort war klein und unbedeutend; seine einzige Bekanntheit bezog er aus der Davidsüberlieferung. Die Flucht nach Ägypten führte dagegen über etwa 500 Kilometer in eine Provinz mit großer jüdischer Bevölkerung.',
      },
    ],
    terms: [
      {
        word: 'griech. magoi',
        rendered: 'Weisen',
        note: 'Ursprünglich eine persische Priesterkaste, dann allgemein Sterndeuter und Traumausleger. Von Königen steht im Text nichts, von einer Dreizahl auch nicht – die drei ergeben sich aus den drei Gaben. Beides ist erst im 3. bis 6. Jahrhundert dazugekommen.',
      },
      {
        word: 'griech. aster',
        rendered: 'Stern',
        note: 'Stern, Gestirn. Vorschläge zur Deutung reichen von einer Konjunktion von Jupiter und Saturn im Jahr 7 vor Christus über einen Kometen bis zu einer Nova. Der Text beschreibt allerdings einen Stern, der vorangeht und stehenbleibt – das leistet kein Himmelskörper.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'glaube',
        text: 'Cäsarea Philippi lag an einer Quellgrotte, die dem Hirtengott Pan geweiht war; Nischen für Götterbilder sind im Fels bis heute sichtbar. Herodes der Große hatte daneben einen Tempel für Augustus errichtet. Die Frage nach dem Messias fällt vor einer Kulisse aus griechischer und römischer Verehrung.',
      },
      {
        aspect: 'macht',
        text: 'Messias hieß für die meisten Zeitgenossen: ein König aus Davids Haus, der die Fremdherrschaft beendet. Die Psalmen Salomos aus dem 1. Jahrhundert vor Christus beschreiben ihn genau so. Petrus verwendet also einen politischen Begriff – und versteht die Leidensankündigung deshalb als Widerspruch.',
      },
      {
        aspect: 'recht',
        text: 'Binden und lösen war Fachsprache der Schriftgelehrten für verbindliche Auslegung: Was erlaubt und was verboten ist, wer zur Gemeinschaft gehört und wer ausgeschlossen wird. Schlüssel wiederum standen für die Verwaltung eines Hauses. Beide Bilder stammen aus dem Rechts- und Verwaltungsalltag, nicht aus dem Jenseits.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'macht',
        text: 'Die Kopfsteuer wurde seit der Provinzwerdung Judäas im Jahr 6 erhoben und war das Zeichen der Unterwerfung schlechthin – sie traf jeden Erwachsenen unabhängig vom Einkommen. Ihre Einführung löste den Aufstand des Judas Galiläus aus; die Frage betraf also einen Konflikt mit Toten.',
      },
      {
        aspect: 'glaube',
        text: 'Der Denar trug Bild und Titel des Kaisers, der sich als Sohn des vergöttlichten Augustus bezeichnete. Für strenge Kreise war das ein doppelter Verstoß: ein Bildnis und ein Gotteslästerungsanspruch. Im Tempelbezirk waren römische Münzen deshalb nicht zugelassen; man musste wechseln.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Pharisäer und Herodianer traten sonst nicht gemeinsam auf: Die einen lehnten die Fremdherrschaft ab, die anderen lebten von ihr. Dass sie hier zusammen fragen, zeigt die Falle – jede Antwort hätte eine der beiden Seiten gegen Jesus aufgebracht, und beide waren als Zeugen vor Ort.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'alltag',
        text: 'Häuser in Kapernaum bestanden aus Basaltbruchstein mit Dächern aus Balken, Zweigen und gestampftem Lehm, zugänglich über eine Außentreppe. Ein solches Dach ließ sich mit einfachem Gerät aufbrechen und in wenigen Stunden wieder schließen – der Schaden war ärgerlich, nicht ruinös.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Lähmung bedeutete Betteln: Es gab keine Versorgung, nur Almosen und die Familie. Ein Gelähmter wurde getragen, auf einer Matte, die zugleich sein Bett war. Dass vier Männer ihn Stunden weit schleppen, ist der eigentliche Aufwand der Erzählung.',
      },
      {
        aspect: 'glaube',
        text: 'Krankheit und Schuld galten als verbunden – nicht als Strafe im engen Sinn, aber als Zeichen einer gestörten Ordnung. Vergebung zuzusprechen war deshalb Sache des Tempels, mit Opfer und Priester. Wer sie ohne beides zusprach, umging eine Institution samt ihren Einnahmen.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'arbeit',
        text: 'Tyrus und Sidon waren reiche Hafenstädte, die ihr Getreide aus dem galiläischen Hinterland bezogen; Josephus beschreibt die Abhängigkeit ausdrücklich. In Hungerjahren ging das Korn zuerst in die zahlungskräftige Stadt. „Zuerst die Kinder satt werden“ hatte für galiläische Ohren einen wirtschaftlichen Klang.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Die Frau tritt allein auf, ohne männlichen Fürsprecher, spricht einen fremden Lehrer an und widerspricht ihm. Jeder dieser Schritte verstieß gegen die Ordnung. Dass Markus sie als „Griechin“ einführt, meint dabei ihren Stand: gebildet, städtisch, wohlhabend.',
      },
      {
        aspect: 'alltag',
        text: 'Hunde waren keine Haustiere, sondern Straßentiere, die den Abfall der Städte fraßen; das Wort galt als Beschimpfung. Die Verkleinerungsform, die die Frau aufnimmt, meint dagegen Tiere, die im Haus geduldet wurden. Sie verschiebt das Bild um genau diesen Schritt – vom Hof unter den Tisch.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'alltag',
        text: 'Purpur und feines Leinen waren die teuersten Stoffe überhaupt: Purpur wurde aus Meeresschnecken gewonnen, tausende für ein Gewand, und war in Rom zeitweise dem Kaiserhaus vorbehalten. Täglich so gekleidet zu sein und zu schlemmen beschreibt keinen Wohlstand, sondern Prunk.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Bettler saßen am Tor des Hauses, weil dort die Gäste vorbeikamen und Reste ausgetragen wurden; man wischte sich bei Tisch die Hände an Brotstücken ab, die anschließend weggeworfen wurden. Lazarus wartet also auf etwas, das ohnehin anfiel – und bekommt es nicht.',
      },
      {
        aspect: 'glaube',
        text: 'Abrahams Schoß meint den Ehrenplatz an der Seite des Gastgebers beim Mahl. Die Jenseitsvorstellung des Gleichnisses – zwei Bereiche, eine Kluft, Sichtkontakt – entspricht dem, was zur Zeit Jesu umlief, und ist aus ägyptischen und rabbinischen Erzählungen bekannt. Der Text erfindet sie nicht, er benutzt sie.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'recht',
        text: 'Der Statthalter besaß die Gerichtsgewalt über Leben und Tod; der Hohe Rat besaß sie nicht. Kreuzigungen wurden an Ausfallstraßen vollzogen, damit möglichst viele sie sahen, und die Leichen blieben oft hängen. Die Tafel mit der Anklage über dem Kopf gehörte zum Verfahren.',
      },
      {
        aspect: 'macht',
        text: 'Die beiden Mitgekreuzigten heißen bei Markus mit einem Wort, das Aufständische meint. Kreuzigung war die Strafe für Widerstand gegen Rom; ein gewöhnlicher Dieb wurde anders bestraft. Die drei Kreuze zeigen also wahrscheinlich eine politische Hinrichtung.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Zum Sterben gehörte, dass jemand den Namen im Gedächtnis behielt – ohne Nachkommen und ohne Grab war ein Mensch endgültig verloren. „Gedenke an mich“ ist deshalb die bescheidenste denkbare Bitte: nicht Rettung, sondern Erinnerung.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'alltag',
        text: 'Man ging in offenen Sandalen auf Wegen, die zugleich Viehtrieb und Abwasserrinne waren. Die Füße zu waschen war deshalb keine Zeremonie, sondern Notwendigkeit vor dem Essen – und da man zu Tisch lag, lagen die Füße der anderen in Sichtweite.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Fußwaschung galt als die niedrigste Sklavenarbeit; jüdischen Sklaven durfte sie nach rabbinischer Auffassung nicht zugemutet werden, nichtjüdischen schon. Ein Lehrer, der sie an seinen Schülern vollzieht, kehrt damit nicht Bescheidenheit, sondern die Ständeordnung um. Petrus’ Widerstand ist die erwartbare Reaktion.',
      },
      {
        aspect: 'recht',
        text: 'Wer mit jemandem aß, stand in einem Verhältnis, das Verrat besonders schwer machte – Tischgemeinschaft galt als Schutz und Bindung zugleich. Dass Judas mitisst und die Füße gewaschen bekommt, verschärft nach antikem Empfinden alles Weitere.',
      },
    ],
    terms: [
      {
...

  {
    ...
    world: [
      {
        aspect: 'macht',
        text: 'Cäsarea Maritima war Sitz des Statthalters, mit künstlichem Hafen, Theater und Kaisertempel – eine römische Stadt an der Küste, in der Nichtjuden die Mehrheit stellten. Ein Hauptmann dort gehörte zur Besatzungsmacht und befehligte etwa achtzig Mann.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Die „Gottesfürchtigen“ waren eine feste Größe: Nichtjuden, die sich an die Synagoge hielten, Almosen gaben und die Gebetszeiten einhielten, ohne beschnitten zu sein. Inschriften aus Aphrodisias nennen sie eigens. Sie standen zwischen den Welten – und aus ihnen kamen viele der ersten Christen.',
      },
      {
        aspect: 'alltag',
        text: 'Das Haus eines Nichtjuden zu betreten galt vielen als verunreinigend, weil man nicht wusste, was dort gelagert und gekocht wurde. Es ging weniger um ein Verbot als um Tischgemeinschaft: Wer mitaß, konnte nicht kontrollieren, woher das Fleisch stammte und ob es Götterbildern geweiht war.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'macht',
        text: 'Rom bedeutete für Provinzbewohner zuerst Verwaltung: Straßen, Münzen, Gerichtstermine, Wasserleitungen – und Legionen. Kaiser Claudius hatte um 49 Juden aus Rom ausgewiesen; unter Nero durften sie zurückkehren. Die Angeredeten waren also eine Gemeinde, in der Vertriebene und Dagebliebene wieder zusammenfinden mussten.',
      },
      {
        aspect: 'arbeit',
        text: 'Steuern wurden verpachtet: Wer die Erhebung ersteigerte, holte sich seinen Einsatz mit Aufschlag zurück. Tacitus berichtet für die Jahre um 58 von Beschwerden über die Willkür dieser Pächter und von einer Reformdebatte im Senat. Die Verse 6 und 7 über Zoll und Steuer treffen genau diesen Streitpunkt.',
      },
      {
        aspect: 'recht',
        text: 'Das Schwert in Vers 4 ist kein Bild: Der Statthalter besaß die Gerichtsgewalt über Leben und Tod, das *ius gladii*. Wer den Abschnitt hörte, dachte an Hinrichtungen, die öffentlich vollzogen wurden – und wusste, dass er selbst als Provinzbewohner ohne Bürgerrecht wenig dagegensetzen konnte.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'alltag',
        text: 'Gefeiert wurde im Privathaus eines wohlhabenden Mitglieds. Der Speiseraum fasste nach Ausgrabungsbefunden neun bis zwölf Personen auf Liegen, der Innenhof deutlich mehr im Stehen oder Sitzen. Wer eingeladen war und wer im Hof blieb, ergab sich aus dem Rang – die Trennung war gebaut, nicht beschlossen.',
      },
      {
        aspect: 'arbeit',
        text: 'Handwerker und Sklaven arbeiteten bis zum Abend, Wohlhabende konnten früher kommen. Wenn die einen bereits gegessen hatten, bevor die anderen eintrafen, war das keine Unhöflichkeit, sondern die Zeitordnung der Stadt. Paulus greift damit nicht schlechte Manieren an, sondern eine Selbstverständlichkeit.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Bei römischen Gastmählern war es üblich, nach Rang verschieden zu bewirten: Der Gastgeber und seine Freunde bekamen besseren Wein als die übrigen. Plinius und Martial spotten darüber als Sitte, die niemanden überraschte. Korinth machte es also wie alle – und genau das nennt Paulus unwürdig.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'recht',
        text: 'Ein entlaufener Sklave galt als Diebstahl an sich selbst. Wer einen aufnahm, haftete dem Eigentümer gegenüber; wer ihn zurückbrachte, konnte Belohnung erwarten. Papyri überliefern Steckbriefe mit Personenbeschreibung und Fundlohn. Vor diesem Hintergrund ist jeder Satz des Briefes eine Verhandlung.',
      },
      {
        aspect: 'arbeit',
        text: 'Sklaven waren in einem städtischen Haushalt nicht Randfiguren, sondern Verwalter, Schreiber, Lehrer, Handwerker; ein Teil führte Geschäfte selbständig und legte Geld für den Freikauf zurück. „Nützlich“ war entsprechend eine wirtschaftliche Kategorie – und der Name Onesimus benennt sie.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Der Brief ist an einen Hausherrn, zwei weitere Personen und die Gemeinde in seinem Haus gerichtet. Damit wird die Bitte vor Zeugen gestellt, in einer Kultur, in der öffentliche Erwartung stärker band als jede Vereinbarung. Paulus verzichtet auf den Befehl und setzt etwas Wirksameres ein.',
      },
    ],
    terms: [
      {
...

  {
    ...
    reception:
      'Der Lobpreis ist über den Schluss des Vaterunsers zum meistgesprochenen Gebetsende der Christenheit geworden – auch wenn dieser Zusatz in den ältesten Handschriften des Matthäusevangeliums fehlt und aus dem gottesdienstlichen Gebrauch stammt.\n\nDas Gebet steht am Ende der Sammlung für den Tempelbau, und die Chronik verzeichnet zuvor gewaltige Spendensummen. Der Satz „von deiner Hand haben wir dir’s gegeben“ ist die theologische Antwort darauf: Er entzieht der Spende jeden Verdienstcharakter – und ist bis heute der meistzitierte Vers in Formularen kirchlicher Stiftungen.',
    terms: [
      {
        word: 'hebr. lecha JHWH hammamlacha',
        rendered: 'Dein, HERR, ist das Reich',
        note: 'Der Satz, der über die griechische Überlieferung in den Schluss des Vaterunsers gekommen ist – „denn dein ist das Reich und die Kraft und die Herrlichkeit“. Die drei Wörter stehen hier beieinander.',
      },
      {
        word: 'hebr. mijjadcha',
        rendered: 'von deiner Hand',
        note: 'Aus deiner Hand. Der Kern des Gebets: Was gegeben wird, war vorher empfangen. Dieselbe Denkfigur trägt bis heute jede Kollektenformel.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Vers ist die meistzitierte Bibelstelle der amerikanischen Gebetsbewegungen und steht hinter dem National Day of Prayer ebenso wie hinter zahllosen Aufrufen zur „Heilung des Landes“. Er wird dabei regelmäßig auf einen modernen Staat bezogen.\n\nExegetisch ist das die Schwierigkeit: Die Zusage ergeht an Salomo, ist an den Tempel gebunden und gilt „meinem Volk, das nach meinem Namen genannt ist“ – im Zusammenhang Israel. Ob und wie sie sich übertragen lässt, ist die eigentliche Streitfrage, und sie wird selten gestellt.',
    terms: [
      {
        word: 'hebr. kana',
        rendered: 'demütigt',
        note: 'Sich beugen, sich klein machen. Die Chronik gebraucht das Wort als Fachausdruck: Wo ein König sich demütigt, wendet sich das Unheil – auch bei Königen, die sonst schlecht bewertet werden.',
      },
      {
        word: 'hebr. rafa',
        rendered: 'heilen',
        note: 'Heilen. Dass ein Land geheilt wird, ist eine ungewöhnliche Wendung; sie meint die Wiederherstellung der Fruchtbarkeit nach Dürre und Seuche, von denen der Vers davor spricht.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die Szene ist zu einem der meistzitierten biblischen Bilder für Ambivalenz geworden – in Predigten zu Jubiläen, Kirchenschließungen, Neuanfängen nach Verlusten. Dass Weinen und Jubel im selben Raum stattfinden und ununterscheidbar werden, gilt in der Seelsorge als eine der genauesten Beschreibungen von Trauer, die die Bibel enthält.\n\nHistorisch markiert der Vorgang den Beginn des zweiten Tempels um 536 vor Christus. Der Bau kam ins Stocken und wurde erst zwanzig Jahre später unter dem Zuspruch Haggais und Sacharjas vollendet – die Enttäuschung der Alten war also nicht unbegründet.',
    terms: [
      {
        word: 'hebr. jasad',
        rendered: 'gegründet',
        note: 'Den Grund legen. Das Wort steht in diesen Versen dreimal – die Szene handelt nicht von einer Einweihung, sondern von einem Anfang, dessen Ende niemand absehen kann.',
      },
      {
        word: 'hebr. hekim',
        rendered: 'Geschrei',
        note: 'Ein Wort, das Jubelruf und Klageschrei gleichermaßen bezeichnen kann. Genau darauf läuft die Szene hinaus: Niemand konnte die beiden Geräusche voneinander unterscheiden.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Petrus legt die Pfingstereignisse mit diesem Text aus, und die Pfingstbewegung des 20. Jahrhunderts hat ihn zu ihrem Grundtext gemacht. Die Erweckung in der Azusa Street ab 1906 berief sich ausdrücklich darauf – und zwar auf die Aufzählung: Dass Frauen und Schwarze dort predigten, wurde mit diesem Vers begründet.\n\nIn der Debatte um Frauenordination gehört er zu den meistzitierten alttestamentlichen Stellen, weil er das prophetische Reden ausdrücklich Töchtern und Mägden zusagt. Die Zählung weicht hier von der gedruckten Lutherbibel ab: Dort steht der Abschnitt als Joel 3,1–5.',
    terms: [
      {
        word: 'hebr. kol basar',
        rendered: 'alles Fleisch',
        note: 'Alles Lebendige. Die Ausweitung ist der Kern des Verses: Was bisher Einzelnen zukam – Propheten, Königen, Priestern –, gilt jetzt allen, und die Aufzählung nennt ausdrücklich Söhne und Töchter, Alte und Junge, Knechte und Mägde.',
      },
      {
        word: 'hebr. schafach',
        rendered: 'ausgießen',
        note: 'Ausgießen wie Wasser oder Blut – ein Wort für Verschwendung, nicht für Zuteilung. Der Geist wird nicht verteilt, sondern ausgeschüttet.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Obadja ist das kürzeste Buch des Alten Testaments und besteht fast nur aus einem Gerichtswort über ein Nachbarvolk. Das hat ihm in Kirche und Synagoge wenig Aufmerksamkeit eingebracht; Predigtreihen lassen es meist aus.\n\nSein Thema hat dennoch Gewicht: Vorgeworfen wird nicht der Angriff, sondern das Zusehen – Schadenfreude, Plünderung, das Ausliefern von Flüchtenden an den Wegscheiden. In der Aufarbeitung von Kollaboration und Zuschauerschaft im 20. Jahrhundert ist der Abschnitt gelegentlich herangezogen worden, weil er genau diese Rolle beschreibt.',
    terms: [
      {
        word: 'hebr. achicha',
        rendered: 'deinem Bruder',
        note: 'Dein Bruder. Edom gilt als Nachkomme Esaus, des Bruders Jakobs – der Vorwurf lautet deshalb nicht Feindschaft, sondern Verrat unter Verwandten.',
      },
      {
        word: 'hebr. jom',
        rendered: 'Zeit',
        note: 'Tag. In den Versen 12 bis 14 steht das Wort achtmal: „am Tag seines Elends“, „am Tag seines Jammers“, „am Tag der Angst“. Die Wiederholung ist der eigentliche Vorwurf – es war ein einziger Tag, an dem sich alles entschied.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Das Buch beginnt mit einem alphabetischen Gedicht, dessen strenge Form für ein Gerichtswort ungewöhnlich ist. Es verbindet Zorn und Zuflucht in wenigen Zeilen und ist damit einer der Texte, an denen die Frage nach dem Zorn Gottes am schärfsten gestellt wird.\n\nIn der Auslegungsgeschichte ist Nahum lange als Beispiel für eine überwundene Stufe der Gottesvorstellung gelesen worden. Neuere Auslegung widerspricht: Der Text spricht aus der Lage eines Volkes, das unter assyrischer Gewaltherrschaft stand, und die Alternative zum Zorn Gottes wäre in dieser Lage nicht Milde, sondern Gleichgültigkeit gegenüber dem Unrecht.',
    terms: [
      {
        word: 'hebr. maoz',
        rendered: 'Feste',
        note: 'Zuflucht, Festung. Vers 7 stellt dem Zorn eine Bergungsmöglichkeit gegenüber – im selben Gedicht, in derselben Bildsprache.',
      },
      {
        word: 'hebr. erech appajim',
        rendered: 'geduldig',
        note: 'Wörtlich „lang von Zorn“ – langmütig. Der Ausdruck stammt aus der Gnadenformel von 2. Mose 34; Nahum zitiert sie und setzt sie in einen Zusammenhang, in dem es um Vergeltung geht.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Kein halber Vers hat die abendländische Geschichte stärker bewegt. Paulus zitiert ihn in Römer 1 und Galater 3, der Hebräerbrief in Kapitel 10, und Luther fand darin 1517 den Schlüssel zu seiner Theologie. Über die Reformation hat der Satz Konfessionen, Kriege und Verfassungen mitgeprägt.\n\nIn Qumran ist ein Kommentar zu Habakuk gefunden worden, der den Vers auf die eigene Gemeinschaft deutet – die Treue zum „Lehrer der Gerechtigkeit“. Damit lässt sich an einem einzigen Satz zeigen, wie verschieden dieselben Worte in verschiedenen Gemeinschaften gelesen wurden, lange bevor der Streit zwischen den Konfessionen begann.',
    terms: [
      {
        word: 'hebr. emuna',
        rendered: 'Glaubens',
        note: 'Von der Wurzel für Festigkeit – Verlässlichkeit, Treue. Im Hebräischen meint der Satz zunächst: Der Gerechte wird durch seine Treue am Leben bleiben. Die griechische Bibel übersetzt mit *pistis*, und Paulus liest darin den Glauben.',
      },
      {
        word: 'hebr. mischmarti',
        rendered: 'auf meiner Hut',
        note: 'Der Wachposten. Der Prophet stellt sich auf die Mauer wie ein Wächter und wartet auf Antwort – ein Bild, das die Zwiesprache des ganzen Buches trägt: Habakuk klagt an, und Gott antwortet.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Vers gehört zu den meistvertonten Sätzen der neueren Lobpreismusik und wird in vielen Gemeinden als Zusage an Einzelne gesungen. Sein Ort ist das Ende eines Buches, das fast ganz aus Gerichtsworten besteht – Zefanja kündigt den Tag des HERRN in den schärfsten Bildern an, die die Bibel kennt.\n\nGerade dieser Kontrast macht den Schluss bemerkenswert: Dass Gott über Menschen jubelt, steht in demselben Buch, in dem der Tag des Zorns beschrieben wird. Ob die Schlussverse zum ursprünglichen Bestand gehören, ist umstritten; als Bauform ist der Wechsel in mehreren Prophetenbüchern zu beobachten.',
    terms: [
      {
        word: 'hebr. jasis alajich besimcha',
        rendered: 'wird sich über dich freuen',
        note: 'Sich freuen, jubeln – ein Wort für eine überschwängliche Regung. Es wird hier von Gott gesagt, und zwar über Menschen. Das ist im Alten Testament selten.',
      },
      {
        word: 'hebr. jacharisch beahabato',
        rendered: 'dir freundlich sein',
        note: 'Wörtlich „er wird schweigen in seiner Liebe“. Der hebräische Text ist an dieser Stelle unsicher; Luther deutet, andere übersetzen „er wird still sein in seiner Liebe“ – ein Bild, das die Auslegung seit jeher beschäftigt.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Haggai ist eines der wenigen Bücher, deren Wirkung sich datieren lässt: Nach seinem Auftreten im Jahr 520 vor Christus wurde der Tempelbau tatsächlich wieder aufgenommen und binnen fünf Jahren vollendet. Esra 5 nennt ihn und Sacharja ausdrücklich als die, auf deren Wort hin gebaut wurde.\n\nDas Bild vom „löchrigen Beutel“ ist sprichwörtlich geworden. In der kirchlichen Wirtschaftsethik wird der Abschnitt gelegentlich gegen die Vorstellung angeführt, privater Wohlstand und öffentliche Aufgaben ließen sich unabhängig voneinander betrachten – wobei zu sagen bleibt, dass Haggai von einem konkreten Bau spricht und nicht von einem Prinzip.',
    terms: [
      {
        word: 'hebr. sefunim',
        rendered: 'getäfelten',
        note: 'Getäfelt, mit Holz verkleidet – ein Zeichen von Wohlstand. Dasselbe Wort beschreibt Salomos Palast. Der Vorwurf trifft keine Armen.',
      },
      {
        word: 'hebr. simu lebabchem',
        rendered: 'Schauet, wie es euch geht',
        note: 'Wörtlich „richtet euer Herz auf eure Wege“. Der Satz steht in diesem kurzen Buch viermal und ist seine eigentliche Aufforderung: nachrechnen, was das eigene Verhalten einbringt.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Maleachi ist das letzte Buch des christlichen Alten Testaments, und sein Schluss kündigt die Wiederkunft Elias an. Die Evangelien greifen beides auf und deuten Johannes den Täufer als diesen Boten; die christliche Bibelanordnung setzt damit einen Bogen, den die hebräische Bibel nicht kennt – dort steht Maleachi in der Mitte, und die Sammlung endet mit den Chronikbüchern.\n\nIm Judentum ist der Elia-Schluss anders präsent: Beim Sederabend wird ein Becher für Elia gefüllt und die Tür geöffnet. Die Erwartung, die derselbe Text trägt, hat in beiden Traditionen eine ganz eigene Gestalt angenommen.',
    terms: [
      {
        word: 'hebr. malachi',
        rendered: 'meinen Engel',
        note: 'Wörtlich „mein Bote“ – dasselbe Wort, das dem Buch seinen Namen gibt. Ob Maleachi ein Eigenname ist oder die Überschrift „mein Bote“, ist bis heute umstritten.',
      },
      {
        word: 'hebr. boreet mekabbesim',
        rendered: 'Seifen der Wäscher',
        note: 'Die Lauge des Walkers, mit der Wolle gereinigt wurde – ein scharfes, ätzendes Mittel. Zusammen mit dem Schmelzfeuer des Goldschmieds ergibt das zwei Bilder derselben Art: Reinigung, die angreift.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    terms: [
      {
        word: 'griech. ataktos',
        rendered: 'unordentlich',
        note: 'Aus der Reihe tanzend, undiszipliniert – ein militärisches Wort für den, der die Ordnung nicht hält. Es beschreibt nicht Faulheit im heutigen Sinn, sondern das Ausscheren aus einer Gemeinschaft.',
      },
      {
        word: 'griech. periergazomenous',
        rendered: 'treiben Vorwitz',
        note: 'Ein Wortspiel: „nicht arbeiten, sondern herumarbeiten“ – sich um anderer Leute Sachen kümmern. Der Vorwurf lautet Wichtigtuerei, nicht Untätigkeit.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'Leutseligkeit',
        note: 'Menschenfreundlichkeit – ein Begriff aus der hellenistischen Herrschertugend. Luthers „Leutseligkeit“ hat im 16. Jahrhundert genau diesen Klang; heute ist das Wort abgesunken.',
      },
      {
        word: 'griech. loutron palingenesias',
        rendered: 'Bad der Wiedergeburt',
        note: 'Das Bad der Wiedergeburt – eine der wenigen Stellen, an denen das Neue Testament die Taufe mit einem so dichten Bild beschreibt. Das Wort für Wiedergeburt kommt sonst nur noch bei Matthäus vor, dort für die Erneuerung der Welt.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'Verantwortung',
        note: 'Verteidigungsrede vor Gericht – daher das Wort Apologetik. Der Zusammenhang ist kein Streitgespräch, sondern eine Befragung, bei der man sich rechtfertigen muss.',
      },
      {
        word: 'griech. prautetos kai phobou',
        rendered: 'Sanftmütigkeit und Furcht',
        note: 'Sanftmut und Ehrfurcht. Die Art der Antwort wird ausdrücklich vorgeschrieben – ein Zusatz, der in der Verwendung des Verses als Aufforderung zur Verteidigung des Glaubens oft übergangen wird.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Satz vom Tag, der wie tausend Jahre ist, hat eine ausufernde Rechengeschichte ausgelöst: Von den Kirchenvätern, die daraus eine Weltwoche von sechstausend Jahren ableiteten, bis zu heutigen Versuchen, die Schöpfungstage mit erdgeschichtlichen Zeiträumen zu vereinbaren. Der Brief zitiert Psalm 90 und will damit gerade keine Umrechnung anbieten.\n\nSeine Aussage ist seelsorglich: Was von außen wie Gleichgültigkeit aussieht, deutet er als Geduld, die niemanden aufgibt. Der Vers gehört damit zu den wenigen neutestamentlichen Stellen, die ausdrücklich sagen, Gott wolle nicht, dass jemand verloren gehe.',
    terms: [
      {
        word: 'griech. bradynei',
        rendered: 'verzieht',
        note: 'Zögern, säumen. Der Brief bestreitet nicht, dass es dauert – er bestreitet, dass Verzögerung der Grund ist. Was wie Säumnis aussieht, nennt er Geduld.',
      },
      {
        word: 'griech. makrothymei',
        rendered: 'Geduld',
        note: 'Langmut – wörtlich „langer Atem“. Dasselbe Wort steht in der Beschreibung Gottes im Alten Testament und im Hohelied der Liebe an erster Stelle.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die Anweisung, Irrlehrer nicht ins Haus zu nehmen und nicht zu grüßen, gehört zu den härtesten Sätzen des Neuen Testaments und ist in der Kirchengeschichte zur Begründung von Ausschluss und Bann gebraucht worden – von der Alten Kirche bis in freikirchliche Gemeindeordnungen der Gegenwart.\n\nDer Zusammenhang mildert nichts, erklärt aber etwas: Angesprochen sind Wanderlehrer, die eine Gemeinde von innen umdrehen wollten, und die Aufnahme ins Haus bedeutete öffentliche Anerkennung. Dass derselbe Verfasser das Gebot der Liebe zum Maßstab macht, gehört zu den offenen Spannungen der johanneischen Briefe.',
    terms: [
      {
        word: 'griech. eklekte kyria',
        note: 'Die „auserwählte Herrin“ in der Anrede – vermutlich eine Umschreibung für eine Gemeinde, möglicherweise aber auch eine tatsächliche Frau als Gastgeberin einer Hausgemeinde. Beide Deutungen sind vertreten.',
      },
      {
        word: 'griech. me lambanete',
        rendered: 'nehmet nicht ins Haus',
        note: 'Nicht aufnehmen. In einer Zeit ohne Gasthäuser bedeutete das für Wanderprediger den Ausschluss vom Auskommen – und für die Gemeinde die Verweigerung ihrer wichtigsten Tugend, der Gastfreundschaft.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Brief ist das kürzeste Buch des Neuen Testaments und der einzige Text darin, der einen kirchlichen Machtkonflikt beim Namen nennt: Diotrephes nimmt keine Boten auf und stößt die aus, die es tun. Wer im Recht war, sagt der Brief nur aus einer Perspektive.\n\nIn der Erforschung der frühen Gemeindeordnung ist er deshalb ein Schlüsseltext: Er zeigt eine Zeit, in der die Stellung eines örtlichen Leiters und die Autorität eines wandernden Lehrers noch nicht geklärt waren – und in der ein einzelner Hausherr eine ganze Gemeinde abschotten konnte.',
    terms: [
      {
        word: 'griech. philoproteuon',
        rendered: 'hochgehalten sein will',
        note: 'Wörtlich „der gern der Erste sein will“ – ein Wort, das im ganzen Neuen Testament nur hier vorkommt. Es beschreibt keinen Irrtum in der Lehre, sondern einen Charakterzug.',
      },
      {
        word: 'griech. xenous',
        rendered: 'Brüder',
        note: 'Der Brief lobt Gajus dafür, dass er auch Fremden hilft. Gastfreundschaft war für die Ausbreitung der frühen Gemeinden entscheidend – ohne Herbergen hing die Reise eines Boten an privaten Häusern.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Judasbrief ist wegen seiner scharfen Polemik und wegen seiner Zitate aus außerkanonischen Schriften – dem Henochbuch und der Himmelfahrt des Mose – in der Alten Kirche umstritten gewesen. Luther zählte ihn zu den Büchern zweiten Ranges. Dass ein biblisches Buch nichtbiblische Schriften als Autorität anführt, gehört zu den lehrreichsten Beobachtungen zur Kanongeschichte.\n\nSein Schlusslobpreis dagegen ist einer der meistgesprochenen Segenstexte überhaupt und beschließt Gottesdienste in fast allen Konfessionen – meist ohne dass die Gemeinde weiß, woher er stammt.',
    terms: [
      {
        word: 'griech. epagonizesthai',
        note: 'Der Aufruf in Vers 3, für den überlieferten Glauben zu „kämpfen“ – ein Wort aus dem Wettkampf. Es ist in der Geschichte oft zur Rechtfertigung von Härte gebraucht worden; der Brief selbst verlangt zwei Verse vor dem Schluss Barmherzigkeit.',
      },
      {
        word: 'griech. eleate',
        rendered: 'erbarmet',
        note: 'Erbarmt euch. Der Brief unterscheidet drei Gruppen und drei Umgangsweisen: Erbarmen mit den Zweifelnden, Rettung der Gefährdeten, Vorsicht bei den Übrigen. Diese Abstufung ist im Neuen Testament einmalig.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'hebr. rea',
        rendered: 'Nächsten',
        note: 'Der Nächste, der Mitmensch. Im Zusammenhang meint das Wort zunächst den Volksgenossen; wenige Verse später wird das Gebot ausdrücklich auf den Fremden ausgedehnt, der im Land wohnt.',
      },
      {
        word: 'hebr. kamocha',
        rendered: 'wie dich selbst',
        note: 'Wie dich selbst – möglich ist auch die Übersetzung „denn er ist wie du“. Die zweite Fassung macht aus einem Maßstab eine Begründung: Liebe ihn, weil er ist wie du.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die Kundschaftererzählung ist zum Standardbild für Mutlosigkeit angesichts einer Aufgabe geworden – zehn sehen Riesen, zwei sehen Trauben. In der Erweckungs- und Missionsliteratur ist sie ein Dauerthema, meist mit dem Aufruf, zur Minderheit zu gehören.\n\nDie Kehrseite der Erzählung wird seltener gepredigt: Sie begründet, warum eine ganze Generation im Sand stirbt, und sie tut das mit einer Strafarithmetik – ein Jahr für jeden Tag der Erkundung. In der Auslegung gilt das als eines der härtesten Beispiele für die Vorstellung kollektiver Haftung, gegen die später Hesekiel 18 ausdrücklich Einspruch erhebt.',
    terms: [
      {
        word: 'hebr. lun',
        rendered: 'murrten',
        note: 'Murren, sich beklagen. Ein Leitwort der Wüstenerzählungen – dasselbe Verb steht bei Wasser, Fleisch, Manna. Es beschreibt kein Aufbegehren, sondern ein Nörgeln, das die Befreiung selbst in Frage stellt.',
      },
      {
        word: 'hebr. eretz sawat chalaw udwasch',
        rendered: 'Milch und Honig',
        note: 'Eine feste Wendung für ein fruchtbares Land, auch außerhalb der Bibel belegt. Der Honig ist dabei eher Dattel- oder Feigensirup als Bienenhonig.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'hebr. cherem',
        rendered: 'verbannten',
        note: 'Bann – die vollständige Weihung einer Stadt an Gott durch Vernichtung. Kein Kriegsgewinn: Was gebannt ist, darf niemand behalten. Der Begriff findet sich auch außerhalb der Bibel, etwa auf der moabitischen Mescha-Stele.',
      },
      {
        word: 'hebr. schofar',
        rendered: 'Posaunen',
        note: 'Das Widderhorn, kein Blechinstrument. Es diente als Signalgerät bei Krieg und Fest; im Judentum wird es bis heute zum Neujahrsfest geblasen.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'hebr. schofetet',
        rendered: 'Richterin',
        note: 'Die weibliche Form von „Richter“. Sie kommt in der Bibel nur hier vor. Die Richter sind dabei keine Juristen, sondern Anführer in Krisenzeiten – Debora ist die einzige, von der beides berichtet wird: Rechtsprechung und Kriegführung.',
      },
      {
        word: 'hebr. nebia',
        rendered: 'Prophetin',
        note: 'Prophetin. Neben Debora nennt die hebräische Bibel Mirjam, Hulda, Noadja und die Frau Jesajas – die Zahl ist klein, aber die Reihe zieht sich durch alle Epochen.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Stoff ist über Händels Oratorium *Samson* und Saint-Saëns’ Oper *Samson et Dalila* in die Musikgeschichte eingegangen; Rembrandt und Rubens haben die Blendung gemalt. Miltons Versdrama *Samson Agonistes* von 1671 machte aus dem Schluss eine Meditation über Blindheit und Gottes Verborgenheit.\n\nDer Schluss ist in der Gegenwart neu befragt worden. Dass ein biblischer Held sich selbst tötet, um möglichst viele Feinde mitzunehmen, wird seit den 1990er Jahren regelmäßig im Zusammenhang mit Selbstmordattentaten diskutiert. Ausleger weisen darauf hin, dass der Text die Tat nicht empfiehlt, sondern eine Richterzeit beschreibt, in der „jeder tat, was ihn recht dünkte“ – und dass Simsons Bitte ausdrücklich Rache heißt.',
    terms: [
      {
        word: 'hebr. nasir',
        note: 'Der Geweihte. Simson ist von Geburt an Nasiräer: kein Wein, keine Berührung von Toten, ungeschnittenes Haar. Von den drei Geboten bricht er im Lauf der Erzählung alle drei.',
      },
      {
        word: 'hebr. tamot nafschi',
        rendered: 'Meine Seele sterbe',
        note: 'Wörtlich „meine Kehle sterbe“ – das Wort meint das Leben selbst, nicht eine unsterbliche Seele. Simsons letzter Satz bittet ausdrücklich um den eigenen Tod.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    terms: [
      {
        word: 'hebr. goel',
        note: 'Der Löser – der nächste Verwandte, der verpflichtet ist, Land zurückzukaufen und die Familie fortzuführen. Das Buch buchstabiert dieses Rechtsinstitut Schritt für Schritt durch, bis hin zur Übergabe des Schuhs vor den Ältesten im Tor.',
      },
      {
        word: 'hebr. towa lach mischschiwa banim',
        rendered: 'besser ist als sieben Söhne',
        note: 'Sieben Söhne galten als das höchste Glück einer Frau. Dass eine moabitische Schwiegertochter mehr wert genannt wird, ist im Kontext der stärkstmögliche Satz.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die Szene ist der Standardtext für Berufungsgottesdienste und Einführungen und einer der wenigen biblischen Texte, in denen ein Kind der Handelnde ist. In der Jugendarbeit und in der geistlichen Begleitung gilt sie als Grundmuster: Nicht der Erfahrene hört, sondern der Anfänger – und er braucht den Erfahrenen, um zu verstehen, was er hört.\n\nDer Inhalt der ersten Botschaft wird selten mitgelesen: Sie ist ein Gerichtswort über Eli und dessen Söhne, also über den Mann, der Samuel eben erst zum Hören angeleitet hat. Samuels erster Auftrag besteht darin, seinem Lehrer eine vernichtende Nachricht zu überbringen.',
    terms: [
      {
        word: 'hebr. dabar',
        rendered: 'Wort',
        note: 'Wort, Sache. Der erste Vers stellt fest, das Wort des HERRN sei „teuer“ – selten geworden – zu jener Zeit. Die Erzählung setzt bei einem Mangel an, nicht bei einer Fülle.',
      },
      {
        word: 'hebr. dabber ki schomea abdecha',
        rendered: 'Rede, denn dein Knecht hört',
        note: 'Auffällig ist, was fehlt: Eli hatte Samuel geraten, „Rede, HERR“ zu sagen. Samuel lässt den Gottesnamen weg. Ob aus Scheu oder aus Unsicherheit, sagt der Text nicht.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        note: 'Das „Recht des Königs“ in Vers 11 – die Aufzählung dessen, was ein König nehmen wird: Söhne für das Heer, Töchter für den Hof, Äcker, den Zehnten, schließlich die Menschen selbst. Der Text nennt es nicht Missbrauch, sondern Recht.',
      },
      {
        word: 'hebr. maasu',
        rendered: 'verworfen',
        note: 'Verwerfen, ablehnen. Der Vorwurf gilt nicht der Person Samuels: Gott sagt, sie hätten ihn verworfen. Der Wunsch nach einem König erscheint damit als Absage an eine Ordnung, nicht als Kritik an einem Amtsträger.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'hebr. schalach',
        rendered: 'sandte',
        note: 'Senden. Das Verb strukturiert das ganze Kapitel: David sendet Joab, sendet nach der Frau, sendet nach Uria, sendet den Brief, der Urias Tod anordnet. Er tut alles, ohne den Palast zu verlassen.',
      },
      {
        word: 'hebr. wattitchazzaq',
        rendered: 'reinigte sich',
        note: 'Der Halbsatz über die Reinigung nach der Monatsblutung steht im Text an einer beiläufigen Stelle. Er sagt aber zweierlei: dass Batseba nicht schwanger war, als David sie holen ließ – und dass die Vaterschaft eindeutig ist.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Das „salomonische Urteil“ ist als Redewendung in viele Sprachen eingegangen – meist im Sinn eines klugen Kompromisses, was die Erzählung auf den Kopf stellt: Das Teilen ist gerade nicht das Urteil, sondern der Trick, mit dem der König die Wahrheit herausfindet.\n\nÄhnliche Erzählungen sind aus Indien und aus dem hellenistischen Raum bekannt; Bertolt Brecht griff das Motiv im *Kaukasischen Kreidekreis* auf und drehte es um: Dort bekommt das Kind nicht die leibliche Mutter, sondern die, die für es gesorgt hat. Der Vergleich beider Fassungen gehört zu den bekanntesten Beispielen für Wirkungsgeschichte in der Literatur.',
    terms: [
      {
        word: 'hebr. sona',
        rendered: 'Huren',
        note: 'Prostituierte. Der Text nennt den Stand der beiden Frauen ohne Umschweife – und ohne Wertung. Sie haben keinen Mann, keinen Zeugen und keinen Fürsprecher; genau deshalb landet der Fall beim König.',
      },
      {
        word: 'hebr. rachamim',
        rendered: 'mütterliches Herz',
        note: 'Erbarmen – ein Wort, das mit *rechem*, dem Mutterleib, verwandt ist. Luthers „mütterliches Herz“ trifft den Anklang: Das Erbarmen der Mutter ist im Hebräischen sprachlich in ihrem Leib verwurzelt.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'meiner Väter Erbe',
        note: 'Der Erbbesitz der Familie. Nach 3. Mose 25 war Land in Israel unverkäuflich – es gehörte Gott und war der Sippe nur zugeteilt. Nabots Weigerung ist deshalb kein Starrsinn, sondern Gesetzestreue.',
      },
      {
        word: 'hebr. gan jaraq',
        rendered: 'Kohlgarten',
        note: 'Ein Gemüsegarten. Der Erzähler wählt das Wort mit Bedacht: Ein Weinberg, der Generationen gehört, soll zum Küchengarten neben dem Palast werden.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Aus den Deportierten des Nordreichs sind in der Legendenbildung die „zehn verlorenen Stämme“ geworden. Von Bene Israel in Indien über die Beta Israel in Äthiopien bis zu Gruppen in Nordostindien haben sich zahlreiche Gemeinschaften auf sie berufen; im 19. Jahrhundert entstand daraus in Großbritannien und den USA der Britische Israelismus, aus dem später rassistische Ideologien hervorgingen.\n\nHistorisch ist die Lage klarer: Die Assyrer deportierten Oberschichten, nicht ganze Völker. Ein erheblicher Teil der Bevölkerung blieb im Land, und aus der Mischung mit angesiedelten Gruppen entstand die Bevölkerung, aus der sich später die Samaritaner entwickelten.',
    terms: [
      {
        word: 'hebr. galut',
        note: 'Die Wegführung, das Exil. Die assyrische Deportationspolitik ist durch Inschriften Sargons II. bezeugt, der von 27.290 Weggeführten aus Samaria spricht – die erste dokumentierte Massendeportation dieser Art.',
      },
      {
        word: 'hebr. jare',
        rendered: 'fürchteten',
        note: 'Fürchten im Sinn von: verehren. Das Kapitel schließt mit der Feststellung, die neu Angesiedelten hätten den HERRN gefürchtet und zugleich ihren eigenen Göttern gedient – die Grundlage der späteren Abgrenzung gegen die Samaritaner.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die Szene gilt als Geburtsstunde des Kanons: Zum ersten Mal wird ein Buch als verbindlich anerkannt und ein ganzes Reformprogramm daran gebunden. Josia zentralisiert daraufhin den Kult in Jerusalem und lässt die Höhenheiligtümer zerstören – der Vorgang, den das Deuteronomium fordert.\n\nDie Frage, ob das Buch gefunden oder für den Anlass geschrieben wurde, ist seit dem 19. Jahrhundert diskutiert und nicht entscheidbar. Bemerkenswert ist unabhängig davon, was der Text erzählt: Eine Reform beginnt damit, dass jemand einen alten Text liest und erschrickt.',
    terms: [
      {
        word: 'hebr. sefer hattora',
        rendered: 'Gesetzbuch',
        note: 'Das Buch der Weisung. Was gefunden wurde, ist nicht gesagt; die Forschung setzt seit Wilhelm Martin Leberecht de Wette 1805 überwiegend eine Vorform des Deuteronomiums an, weil Josias Reform genau dessen Forderungen umsetzt.',
      },
      {
        word: 'hebr. chulda',
        note: 'Hulda, die Prophetin, an die der König sich wendet – obwohl Jeremia und Zefanja zur selben Zeit wirkten. Sie beglaubigt das Buch. Die Frage, warum ausgerechnet sie gefragt wird, hat die Auslegung von der rabbinischen Literatur bis in die Gegenwart beschäftigt.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        note: 'Der Befehlshaber der Leibwache, dessen Name in babylonischen Quellen als Nabu-zer-iddina belegt ist. Er taucht in einer Verwaltungsliste Nebukadnezars auf – einer der Fälle, in denen eine biblische Nebenfigur außerbiblisch bezeugt ist.',
      },
      {
        word: 'hebr. dallat haarez',
        rendered: 'Geringsten im Lande',
        note: 'Wörtlich „das Ärmste des Landes“. Wer nichts hatte, blieb – und bekam Weinberge und Äcker. Der Untergang des Staates war für einen Teil der Bevölkerung ein sozialer Aufstieg; der Text erwähnt das ohne Kommentar.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'In der hebräischen Bibel stehen die Chronikbücher am Schluss, nicht die Prophetenbücher – der jüdische Kanon endet damit mit einem Aufbruch nach Jerusalem. Die christliche Anordnung folgt der griechischen Bibel und endet mit Maleachi, also mit der Ankündigung des kommenden Boten. Zwei Kanonordnungen, zwei ganz verschiedene Schlussakkorde.\n\nDie Vorstellung, das Land selbst habe Anspruch auf Ruhe, ist in der Umweltethik neu aufgegriffen worden: Sie macht aus einer Kultbestimmung eine Aussage über die Belastbarkeit von Böden – ein Argument, das in kirchlichen Papieren zur Landwirtschaft regelmäßig auftaucht.',
    terms: [
      {
        word: 'hebr. schabbetot',
        rendered: 'Sabbate',
        note: 'Die Sabbatjahre aus 3. Mose 25, in denen das Land brachliegen sollte. Die Chronik deutet die siebzig Jahre Exil als Nachholen der versäumten Ruhejahre – eine Rechnung, die das Land selbst zum Gläubiger macht.',
      },
      {
        word: 'hebr. jaal',
        rendered: 'ziehe hinauf',
        note: 'Hinaufziehen. Mit diesem Wort endet die hebräische Bibel – als Aufforderung des Perserkönigs an die Verbannten, nach Jerusalem hinaufzuziehen. Der letzte Satz des Kanons ist eine Erlaubnis zum Aufbruch.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Kyros-Zylinder, 1879 in Babylon gefunden und heute im Britischen Museum, beschreibt eine allgemeine Politik der Rückführung deportierter Kulte und ist mehrfach als „erste Menschenrechtserklärung“ bezeichnet worden – eine Deutung, die Historiker für überzogen halten, weil es sich um Herrschaftspropaganda handelt. Israel wird darin nicht erwähnt.\n\nDass die Bibel einen persischen Großkönig zum Werkzeug Gottes erklärt und ihn sogar salbt, gehört zu ihren bemerkenswertesten politischen Aussagen: Rettung kommt hier nicht aus dem eigenen Volk und nicht aus dem eigenen Glauben.',
    terms: [
      {
        word: 'hebr. koresch',
        rendered: 'Kores',
        note: 'Kyros II., der 539 vor Christus Babylon einnahm. Jesaja 45 nennt ihn „Gesalbten“ – der einzige Nichtisraelit, der diesen Titel in der Bibel trägt.',
      },
      {
        word: 'hebr. heir JHWH et ruach',
        rendered: 'erweckte der HERR den Geist',
        note: 'Den Geist erwecken, antreiben. Die Formel schreibt eine persische Verwaltungsentscheidung Gott zu – dieselbe Wendung steht im selben Vers für die Rückkehrwilligen.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Nehemia ist zum Standardtext der christlichen Führungsliteratur geworden: Analyse, Vision, Teambildung, Umgang mit Widerstand – ganze Ratgeberreihen bauen auf den ersten Kapiteln auf. Diese Verwendung ist mit Vorsicht zu genießen; der Text ist eine Ich-Erzählung, die ihren Verfasser gut aussehen lässt.\n\nDas Buch hat zugleich eine problematische Seite: Kapitel 13 berichtet, wie Nehemia Mischehen gewaltsam auflöst und Männer schlägt. Neben dem Buch Rut gelesen ergibt sich einer der schärfsten innerbiblischen Widersprüche – und die Sammlung hat beide behalten.',
    terms: [
      {
        word: 'hebr. tirschata',
        note: 'Ein persischer Amtstitel für den Statthalter, den Nehemia trägt. Das Buch ist damit auch ein Verwaltungsbericht: Es nennt Genehmigungen, Geleitbriefe, Baumaterialzuweisungen aus königlichen Forsten.',
      },
      {
        word: 'hebr. cherpa',
        rendered: 'Schmach',
        note: 'Schande, Schmach. Die eingerissene Mauer ist für Nehemia keine Sicherheitsfrage, sondern eine Frage der Ehre – der Zustand der Stadt beschämt, wer sich zu ihr rechnet.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die Gottesreden gehören zu den großen Naturdichtungen der Weltliteratur: Sternbilder, Wildesel, Strauß, Ross, Adler. Sie sind vielfach vertont und illustriert worden – William Blakes Radierungen von 1826 sind die berühmtesten. Carl Gustav Jung nahm sie 1952 in *Antwort auf Hiob* zum Ausgangspunkt einer Deutung, die weit über die Theologie hinaus gewirkt hat.\n\nWas sie nicht enthalten, ist die Antwort auf Hiobs Frage. Kein Wort über sein Leid, keine Erklärung, keine Rechtfertigung – stattdessen eine Reihe von Gegenfragen über die Schöpfung. In der Seelsorge wird gerade das als Hinweis gelesen: Es gibt Fragen, auf die eine Erklärung die falsche Antwort wäre.',
    terms: [
      {
        word: 'hebr. seara',
        rendered: 'Wetter',
        note: 'Sturm, Wirbelwind. Dasselbe Wort steht bei der Entrückung Elias. Gott antwortet Hiob nicht in der Stille, sondern aus dem Unwetter – aus dem, wovor man sich in Sicherheit bringt.',
      },
      {
        word: 'hebr. behemot / liwjatan',
        note: 'Die beiden Tiere der zweiten Gottesrede in Kapitel 40 und 41: Nilpferd und Krokodil – oder mythische Chaoswesen. Der Text lässt beides offen, und die Übersetzungen entscheiden verschieden.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Abschnitt war der meistumkämpfte alttestamentliche Text des arianischen Streits: Arius las in „der HERR hat mich gehabt im Anfang“ den Beweis, dass der Sohn geschaffen sei; Athanasius bestritt die Gleichsetzung von Weisheit und Sohn an dieser Stelle. Das Konzil von Nizäa 325 entschied gegen Arius – und damit über die Auslegung dieser Verse mit.\n\nIn der feministischen Theologie ist die Weisheit – hebräisch *Chochma*, griechisch *Sophia* – zu einer zentralen Gestalt geworden: eine weibliche Figur, die bei Gott ist, in der Schöpfung wirkt und auf den Straßen ruft. Die Sophiologie der russischen Theologie des 20. Jahrhunderts, bei Sergej Bulgakow, geht ebenfalls von diesem Kapitel aus.',
    terms: [
      {
        word: 'hebr. qanani',
        rendered: 'gehabt',
        note: 'Das Verb kann „erwerben“, „besitzen“ und „hervorbringen“ heißen. Im arianischen Streit des 4. Jahrhunderts hing an dieser Mehrdeutigkeit viel: Wurde die Weisheit geschaffen oder war sie immer da?',
      },
      {
        word: 'hebr. amon',
        note: 'Ein Wort in Vers 30, dessen Bedeutung unsicher ist: „Werkmeister“, „Liebling“ oder „Pflegekind“. Je nach Entscheidung ist die Weisheit Mitschöpferin oder ein Kind, das vor Gott spielt.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die Bilderreihe gehört zu den kunstvollsten Altersdarstellungen der Weltliteratur. Ob sie als Allegorie gemeint ist oder als Beschreibung eines untergehenden Hauswesens, wird bis heute diskutiert – manche Ausleger lesen darin den Verfall eines Anwesens, andere ein aufziehendes Unwetter, wieder andere einen Trauerzug.\n\nDer „silberne Strick“ und der „goldene Becher“ am Ende sind über Poe und zahlreiche Grabinschriften in die Literatur eingegangen. In der Altenseelsorge gilt der Abschnitt als einer der wenigen biblischen Texte, die das Altwerden ohne Verklärung beschreiben – und die es trotzdem nicht als Unglück bezeichnen.',
    terms: [
      {
        word: 'hebr. borecha',
        rendered: 'Schöpfer',
        note: 'Dein Schöpfer. Der Text ist an dieser Stelle unsicher; sehr ähnlich geschrieben wären „deine Grube“ und „deine Frau“. Manche Ausleger vermuten ein bewusstes Wortspiel des Autors.',
      },
      {
        word: 'hebr. jom haraa',
        rendered: 'bösen Tage',
        note: 'Die schlimmen Tage. Was folgt, ist eine Reihe von Bildern, die traditionell auf das Altern gedeutet werden: die zitternden Hüter des Hauses, die dunkel werdenden Fenster, die versiegende Mühle.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die Thronwagenvision ist der Ausgangspunkt der jüdischen Merkaba-Mystik, der ältesten mystischen Tradition des Judentums. Die rabbinische Überlieferung hat ihre Auslegung streng begrenzt: Nur wer weise ist und selbst versteht, dürfe darüber unterrichtet werden, und dann nur unter vier Augen.\n\nIn der Neuzeit ist die Vision Gegenstand esoterischer und pseudowissenschaftlicher Deutungen geworden – Erich von Dänikens Behauptung, hier werde ein Raumschiff beschrieben, ist die bekannteste. Fachleute weisen darauf hin, dass die Bildelemente – Mischwesen, Räder, Kristallgewölbe – aus der babylonischen Ikonographie stammen, die Hesekiel im Exil vor Augen hatte.',
    terms: [
      {
        word: 'hebr. chaschmal',
        note: 'Ein Wort, das nur bei Hesekiel vorkommt und dessen Bedeutung unbekannt ist – etwa „glänzendes Metall“. Im modernen Hebräisch bedeutet es „Elektrizität“; Elieser Ben-Jehuda griff das rätselhafte Wort für den neuen Begriff auf.',
      },
      {
        word: 'hebr. kebod JHWH',
        rendered: 'Herrlichkeit des HERRN',
        note: 'Wörtlich das „Gewicht“ Gottes – seine wahrnehmbare Gegenwart. Das Entscheidende an der Vision ist, wo sie geschieht: am Fluss Kebar in Babylonien, weit weg vom Tempel.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Das Kapitel markiert einen Wendepunkt im biblischen Rechtsdenken: weg von der Sippenhaftung, hin zur persönlichen Verantwortung. Es steht damit gegen andere Stellen desselben Kanons – etwa das Wort im Dekalog, Gott suche die Schuld der Väter an den Kindern heim.\n\nIn der Rechtsgeschichte wird der Text als früher Beleg für den Grundsatz herangezogen, dass Strafe nur den Täter trifft. In der Seelsorge hat er eine andere Wirkung: Wo Menschen sich für die Schuld ihrer Eltern verantwortlich fühlen – in Familien mit Gewaltgeschichte, in Nachkriegsgenerationen –, ist dieses Kapitel einer der meistzitierten Texte.',
    terms: [
      {
        word: 'hebr. maschal',
        rendered: 'Sprichwort',
        note: 'Spruch, Gleichnis, Sprichwort. Das zitierte Sprichwort – die Väter haben Herlinge gegessen, den Kindern werden die Zähne stumpf – steht auch bei Jeremia 31 und wird dort ebenfalls zurückgewiesen.',
      },
      {
        word: 'hebr. nefesch',
        rendered: 'Seele',
        note: 'Leben, Person. „Die Seele, die sündigt, soll sterben“ heißt: der Mensch, der sündigt – keine Aussage über eine unsterbliche Seele, sondern über persönliche Haftung.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Das Kapitel steht hinter dem Bild vom guten Hirten in Johannes 10 und hinter dem Gleichnis vom verlorenen Schaf. Es ist zugleich der schärfste Text der Bibel gegen Amtsträger, die sich selbst versorgen – und wird in kirchlichen Aufarbeitungsprozessen zu Macht- und Amtsmissbrauch regelmäßig zitiert.\n\nIn der Befreiungstheologie und in der kirchlichen Sozialkritik gehört es zum Grundbestand. Bemerkenswert ist der Schluss: Gott kündigt an, selbst Hirte zu sein – aber auch, zwischen den Schafen zu richten, die einander wegdrängen. Die Kritik endet nicht bei der Führung.',
    terms: [
      {
        word: 'hebr. roim',
        rendered: 'Hirten',
        note: 'Hirten – im Alten Orient ein Königstitel; Hammurapi nennt sich so. Die Anklage gilt damit nicht Priestern, sondern der politischen Führung.',
      },
      {
        word: 'hebr. baqar',
        rendered: 'suchen',
        note: 'Aufsuchen, sich kümmern um. Der Vorwurf lautet nicht, die Hirten hätten falsch geführt, sondern gar nicht: Sie haben das Verlorene nicht gesucht, das Kranke nicht verbunden, sich selbst geweidet.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die siebzig Jahrwochen in den Versen 24 bis 27 gehören zu den meistberechneten Zahlen der Bibel. Aus ihnen sind Weltendedaten abgeleitet worden – von mittelalterlichen Rechnungen über William Millers Vorhersage für 1844 bis zu heutigen dispensationalistischen Zeitplänen. Keine dieser Rechnungen ist eingetroffen.\n\nDie historisch-kritische Auslegung bezieht die Zahlen auf die Zeit des Antiochus IV. und den Mord an dem Hohenpriester Onias III. Bemerkenswert ist unabhängig davon der Aufbau des Kapitels: Es beginnt damit, dass jemand die Schrift liest, sie nicht versteht und darüber ins Gebet gerät.',
    terms: [
      {
        word: 'hebr. schibim schanim',
        rendered: 'siebzig Jahre',
        note: 'Die siebzig Jahre aus Jeremia 25 und 29. Daniel liest sie und betet – und bekommt zur Antwort, es seien „siebzig Wochen“ gemeint. Aus einer Zahl wird eine Auslegung der Zahl.',
      },
      {
        word: 'hebr. zedaqot',
        rendered: 'Gerechtigkeit',
        note: 'Im Plural: Gerechtigkeitserweise, Wohltaten. Das Gebet beruft sich ausdrücklich nicht auf eigene Gerechtigkeit, sondern auf Gottes „große Barmherzigkeit“.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Das Bild der Ehe zwischen Gott und Israel, das hier beginnt, prägt Jeremia, Hesekiel und über das Hohelied hinaus die ganze christliche Mystik – bis zur Rede von der Kirche als Braut Christi.\n\nIn der feministischen Exegese ist es scharf kritisiert worden: Die Bildhälfte, in der die untreue Frau entblößt und bestraft wird, hat in Hesekiel 16 und 23 Ausmaße, die als sexualisierte Gewaltdarstellung gelesen werden. Dass die Untreue durchgehend weiblich besetzt ist und die strafende Gewalt männlich, gehört zu den Punkten, an denen heutige Auslegung ausdrücklich Einspruch erhebt – ohne den Text zu streichen.',
    terms: [
      {
        word: 'hebr. eschet senunim',
        rendered: 'Hurenweib',
        note: 'Wörtlich „Weib der Hurereien“. Ob Gomer Prostituierte war, an einem Fruchtbarkeitskult teilnahm oder ob der Ausdruck vorwegnimmt, was später geschieht, ist unentschieden. Luthers Wort ist härter als der hebräische Befund.',
      },
      {
        word: 'hebr. lo ruchama / lo ammi',
        note: 'Die Namen der Kinder: „Nicht-Erbarmen“ und „Nicht-mein-Volk“. Kapitel 2 dreht beide um – aus „Nicht-mein-Volk“ wird „mein Volk“. Der erste Petrusbrief greift genau diese Umkehrung auf.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Heuschreckenplagen sind im Nahen Osten bis heute eine reale Bedrohung; die Ernährungs- und Landwirtschaftsorganisation der Vereinten Nationen unterhält ein eigenes Warnsystem dafür. Die Beschreibung in Joel 1 gilt Entomologen als sachlich genaue Schilderung eines Schwarmzugs.\n\nIn der ökologischen Theologie ist das Buch neu gelesen worden: Es beschreibt, wie eine Katastrophe alle trifft – Bauern, Priester, Tiere – und macht daraus einen Aufruf zur gemeinsamen Klage. Dass die Tiere ausdrücklich mitschreien, gehört zu den meistzitierten Zügen des Buches in Texten zur Schöpfungsverantwortung.',
    terms: [
      {
        word: 'hebr. arbe',
        rendered: 'Heuschrecken',
        note: 'Das Kapitel gebraucht vier verschiedene Wörter für Heuschrecken in einem Vers. Ob es sich um Arten, Entwicklungsstadien oder eine Steigerungsfigur handelt, ist unklar – die Übersetzungen behelfen sich mit „Raupen“, „Käfer“, „Geschmeiß“.',
      },
      {
        word: 'hebr. jom JHWH',
        note: 'Der Tag des HERRN. Joel deutet die Heuschreckenplage als dessen Vorzeichen und lässt beides ineinander übergehen – die Grenze zwischen Naturereignis und Endzeitbild verschwimmt absichtlich.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'des Königs Heiligtum',
        note: 'Bethel wird von Amazja ausdrücklich als königliches Heiligtum bezeichnet – ein Staatstempel. Genau darin liegt der Konflikt: Der Priester verteidigt eine Einrichtung, nicht eine Lehre.',
      },
      {
        word: 'hebr. boqer',
        rendered: 'ein Hirt',
        note: 'Rinderhirt. Amos bestreitet, Berufsprophet zu sein: Er ist Viehzüchter und Maulbeerfeigenzüchter. Damit weist er die Unterstellung zurück, er verdiene mit seinen Worten Geld.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die Predigt Jonas ist die kürzeste der Bibel – fünf Wörter im Hebräischen – und hat den größten Erfolg. Die Erzählung treibt damit ein Spiel mit den Erwartungen an Prophetie: Ein Prophet, der nichts kann und nichts will, bewirkt, woran alle anderen scheitern.\n\nDass auch die Tiere in Sack und Asche gehen und mitfasten, gehört zu den Zügen, die als Humor gelesen werden. Zugleich hat der Text eine ernste Wirkung: Jesus nennt bei Matthäus die Leute von Ninive als Zeugen gegen seine eigene Generation – ein fremdes Volk, das auf einen unwilligen Boten hin umkehrte.',
    terms: [
      {
        word: 'hebr. hafak',
        rendered: 'untergehen',
        note: 'Umkehren, umstürzen. Dasselbe Verb beschreibt den Untergang Sodoms – und daneben das Sich-Umwenden. Jonas Predigt ist im Hebräischen doppeldeutig: Ninive wird umgestürzt, und Ninive kehrt um.',
      },
      {
        word: 'hebr. nicham',
        rendered: 'reute',
        note: 'Seinen Sinn ändern, bereuen. Der Text sagt ohne Umschweife, dass Gott „das Übel gereute“ und er es nicht tat. Genau daran entzündet sich Jonas Zorn im nächsten Kapitel.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Matthäus lässt die Schriftgelehrten diesen Vers zitieren, als Herodes fragt, wo der Messias geboren werden solle – und ändert dabei den Wortlaut: Aus dem „kleinsten unter den Städten“ wird bei ihm „keineswegs die kleinste“. Der Vergleich beider Fassungen ist ein Schulbeispiel dafür, wie das Neue Testament zitiert.\n\nDie Geburtskirche in Bethlehem, im 4. Jahrhundert unter Konstantin errichtet und im 6. neu gebaut, ist eine der ältesten durchgehend genutzten Kirchen der Welt. Dass ein unbedeutender Ort zum Ziel wird, ist in der Auslegung durchgehend als Pointe des Verses gelesen worden.',
    terms: [
      {
        word: 'hebr. bet lechem efrata',
        rendered: 'Bethlehem Ephrata',
        note: 'Der Doppelname unterscheidet den Ort in Juda von einem gleichnamigen in Sebulon. „Bethlehem“ heißt „Haus des Brotes“, „Ephrata“ wohl „Fruchtbarkeit“ – zwei Namen für einen unbedeutenden Flecken.',
      },
      {
        word: 'hebr. mimme olam',
        rendered: 'von Anfang',
        note: 'Wörtlich „von den Tagen der Vorzeit her“. Der Ausdruck kann die Herkunft aus alter Zeit meinen – also aus dem Haus David – oder eine Herkunft vor aller Zeit. Beide Lesarten haben eine lange Geschichte.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Ninive fiel 612 vor Christus an ein Bündnis aus Babyloniern und Medern; die Ausgrabungen bei Mossul haben die Zerstörungsschicht freigelegt. Das Buch Nahum ist damit eines der wenigen prophetischen Bücher, deren Ankündigung sich zeitnah erfüllte.\n\nDas macht es nicht leichter. Ein Buch, das den Untergang einer Stadt bejubelt, steht in demselben Kanon wie Jona, wo Gott dieselbe Stadt verschont. Die Sammlung stellt beide Bücher nebeneinander, und die Auslegung hat aus diesem Nebeneinander mehr gelernt als aus jedem der beiden allein.',
    terms: [
      {
        word: 'hebr. ir damim',
        rendered: 'mörderischen Stadt',
        note: 'Wörtlich „Stadt der Blutschuld“. Die assyrischen Königsinschriften selbst beschreiben Pfählungen, Häutungen und Deportationen als Ruhmestaten – der Vorwurf trifft eine Praxis, die die Täter dokumentiert haben.',
      },
      {
        word: 'hebr. sona',
        rendered: 'Hure',
        note: 'Die Stadt wird als Prostituierte beschrieben und ihre Entblößung angekündigt. Dieses Bild gehört zu den Stellen, an denen heutige Auslegung ausdrücklich Einspruch erhebt: Es überträgt die Bestrafung eines Reiches in die Sprache sexualisierter Gewalt gegen eine Frau.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die Verse gehören zu den meistzitierten Texten in wirtschaftlicher Not und sind in Kriegs- und Hungerzeiten immer wieder gebetet worden. Ihre Besonderheit liegt in der Bauart: Sie zählen erst auf, was alles ausbleibt – Feigenbaum, Weinstock, Ölbaum, Schafe, Rinder –, und stellen die Freude dann ausdrücklich daneben, nicht dagegen.\n\nDas Buch als Ganzes ist eine Zwiesprache: Habakuk klagt zweimal an, Gott antwortet zweimal, und das Schlusskapitel ist die Antwort des Propheten darauf. Dass ein Prophetenbuch mit einem Gebet endet und nicht mit einer Ansage, ist im Zwölfprophetenbuch einmalig.',
    terms: [
      {
        word: 'hebr. tefilla',
        note: 'Gebet. Kapitel 3 trägt eine eigene Überschrift und musikalische Anweisungen – es ist ein Psalm, der in ein Prophetenbuch eingefügt wurde, und in den Rollen vom Toten Meer fehlt er im Habakuk-Kommentar.',
      },
      {
        word: 'hebr. ajjalot',
        rendered: 'Hirschfüße',
        note: 'Hirschkühe. Das Bild vom sicheren Tritt auf Höhen stammt aus dem Bergland: Wer dort geht, braucht Füße, die auf Fels halten. Derselbe Vers steht fast wörtlich in Psalm 18.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der zweite Tempel, um dessen bescheidene Gestalt es hier geht, wurde 515 vor Christus geweiht und stand bis zur Zerstörung durch die Römer im Jahr 70 – länger als der salomonische. Herodes der Große ließ ihn ab 20 vor Christus prachtvoll ausbauen; die Westmauer dieses Baus ist die Klagemauer.\n\nDer Zuspruch an die Enttäuschten – der zweite Bau werde herrlicher sein als der erste – ist in der Auslegung oft auf die Enttäuschung überhaupt bezogen worden: über kleinere Gemeinden, schwindende Mitgliederzahlen, unscheinbare Anfänge. Der Text selbst nennt keinen Zeitpunkt.',
    terms: [
      {
        word: 'hebr. kaajin',
        rendered: 'nichts',
        note: 'Wie nichts. Die Frage an die Alten – ob der neue Bau ihnen nicht wie nichts erscheine – nimmt eine Enttäuschung auf, die Esra 3 ausdrücklich beschreibt: Die Alten weinten, als der Grund gelegt wurde.',
      },
      {
        word: 'hebr. chemdat kol haggojim',
        rendered: 'aller Heiden Bestes',
        note: 'Wörtlich „das Kostbare aller Völker“. Die lateinische Bibel übersetzte im Singular – „der Ersehnte aller Völker“ – und bezog es auf Christus; über Händels *Messiah* ist diese Deutung weit verbreitet. Der hebräische Text meint eher Schätze.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Leuchter aus dieser Vision ist das Staatswappen Israels; die Darstellung geht auf die Abbildung des Titusbogens in Rom zurück, auf dem die Beute aus dem Tempel gezeigt wird. Sacharja 4,6 steht auf der offiziellen Erläuterung des Wappens.\n\nDer Satz „nicht durch Heer und nicht durch Kraft“ gehört zu den meistzitierten Versen in Friedensbewegungen und in der Auseinandersetzung um Gewaltfreiheit – und wird in Israel selbst in politischen Debatten regelmäßig angeführt, von beiden Seiten.',
    terms: [
      {
        word: 'hebr. menora',
        rendered: 'Leuchter',
        note: 'Der siebenarmige Leuchter des Tempels. Die Vision beschreibt ihn mit einer Ölschale darüber und Röhren zu den Lampen – ein Leuchter, der sich selbst speist. Der Text erklärt die Bilder nicht vollständig.',
      },
      {
        word: 'hebr. lo bechajil welo bechoach',
        note: 'Der Kernsatz in Vers 6: „Nicht durch Heer und nicht durch Kraft, sondern durch meinen Geist.“ Das erste Wort meint militärische Macht, das zweite körperliche Stärke.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Vers ist die meistzitierte Bibelstelle in der Kollektenpredigt und in der Wohlstandsverkündigung, wo er als Ertragsversprechen gelesen wird: Wer gibt, bekommt mehr zurück. Die Kritik daran ist alt und richtet sich weniger gegen das Geben als gegen die Rechnung.\n\nDer Zusammenhang ist konkret: Maleachi spricht zu einer verarmten nachexilischen Gemeinde, deren Tempelbetrieb nicht mehr getragen wird, und die Abgabe war eine Sozialleistung, aus der auch Witwen, Waisen und Fremde lebten. Das Kapitel davor wirft den Priestern vor, minderwertige Tiere zu opfern – die Kritik trifft zuerst sie.',
    terms: [
      {
        word: 'hebr. maaser',
        rendered: 'Zehnten',
        note: 'Der Zehnte – eine Abgabe, die im Alten Testament unterschiedlich geregelt ist: für die Leviten, für Feste, alle drei Jahre für Arme, Witwen und Fremde. Ein einheitliches System gibt es nicht.',
      },
      {
        word: 'hebr. bochanu na',
        rendered: 'Prüft mich',
        note: 'Prüft mich, stellt mich auf die Probe. Die einzige Stelle der Bibel, an der Gott ausdrücklich zu einem Versuch auffordert – anderswo heißt es, man solle Gott nicht versuchen.',
      },
    ],
    interpretations: [
      {
...

  {
    ...
    reception:
      'Das Lied ist ein Zitat aus dem Psalter: Die Chronik setzt Psalm 105, 96 und 106 zu einem neuen Text zusammen. Das ist einer der klarsten Fälle, in denen sich beobachten lässt, wie biblische Bücher mit biblischen Texten arbeiten – die Chronik schreibt hier nicht, sie komponiert.\n\nIn der Kirchenmusik ist der Anfang über zahllose Vertonungen präsent, und in der Liturgie eröffnet er bis heute Dankgottesdienste. Die Zusammenstellung dreier Psalmen zu einem Lied für die Überführung der Lade zeigt zugleich, wie die Chronik ihre eigene Zeit in die Erzählung hineinschreibt: Sie legt David den Gottesdienst des zweiten Tempels in den Mund.',
    terms: [
      {
        word: 'hebr. hodu',
        rendered: 'Danket',
        note: 'Danken, bekennen. Der Ruf eröffnet zahlreiche Psalmen und ist bis heute der Beginn des Dankgebets in Synagoge und Kirche.',
      },
      {
        word: 'hebr. baqschu panaw',
        rendered: 'suchet sein Angesicht',
        note: 'Das Angesicht suchen – ursprünglich der Gang zum Heiligtum, wo man „vor Gottes Angesicht“ trat. Die Wendung ist später ins Innerliche übertragen worden.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Purim ist der ausgelassenste Feiertag des jüdischen Jahres: Verkleidung, Lärminstrumente bei jeder Nennung Hamans, Festmahl, Geschenke. Die Esterrolle wird zweimal öffentlich vorgelesen, und die Tradition erlaubt an diesem Tag ausdrücklich Ausgelassenheit.\n\nDas Kapitel hat auch eine dunkle Seite: Es berichtet von 75.000 Getöteten unter den Feinden der Juden. In der christlichen Auslegung wurde das lange gegen das Buch gewendet; jüdische Ausleger verweisen darauf, dass es sich um eine Rachephantasie einer Minderheit ohne Rechte handelt und dass der Text ausdrücklich vermerkt, an der Beute habe man sich nicht vergriffen.',
    terms: [
      {
        word: 'hebr. pur',
        rendered: 'Pur',
        note: 'Das Los – ein akkadisches Lehnwort, das der Text ausdrücklich erklärt. Haman lost den Termin für die Vernichtung aus; das Fest trägt den Namen dieses Loses.',
      },
      {
        word: 'hebr. manot',
        rendered: 'Geschenke',
        note: 'Anteile, Portionen. Zum Fest gehört ausdrücklich, einander Speisen zu schicken und den Armen etwas zu geben – zwei der vier bis heute geltenden Purim-Gebote stehen in diesem Vers.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Frühlingsabschnitt gehört zu den meistvertonten Texten der Bibel und ist über Kirchenlieder, Motetten und die Trauliturgie weit verbreitet. In der jüdischen Tradition wird das Hohelied am Passafest gelesen – im Frühjahr, zu dem der Text passt.\n\nDie allegorische Auslegung hat den Abschnitt über anderthalb Jahrtausende auf das Verhältnis zwischen Gott und Seele bezogen; Bernhard von Clairvaux und die spätere Brautmystik leben davon. Seit dem 18. Jahrhundert setzte sich die Lesart als Liebesdichtung durch, und beide stehen heute nebeneinander – die Kirchen lesen den Text bei Trauungen und in der Mystik.',
    terms: [
      {
        word: 'hebr. dodi',
        rendered: 'Mein Freund',
        note: 'Mein Geliebter. Das Wort ist im Hohenlied die stehende Anrede und mit dem Namen David verwandt. Es kommt im Buch über dreißigmal vor.',
      },
      {
        word: 'hebr. tor',
        rendered: 'Turteltaube',
        note: 'Die Turteltaube – ein Zugvogel, dessen Rückkehr im Frühjahr das Ende des Winters anzeigt. Die Naturbeschreibung ist botanisch und ornithologisch genau: Feigenknoten und Weinblüte fallen in dieselben Wochen.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die Klagelieder enden ohne Auflösung. Das ist in der Synagoge liturgisch aufgefangen worden: Beim Vortrag am 9. Aw wird nach dem letzten Vers Vers 21 noch einmal wiederholt, damit die Lesung nicht mit der Verwerfung schließt. Dieselbe Praxis gilt bei Jesaja, Maleachi und Kohelet.\n\nIn der christlichen Auslegung ist der offene Schluss lange überspielt worden, indem man ihn mit Ostern beantwortete. Die Seelsorgeliteratur der letzten Jahrzehnte liest ihn anders: Als Erlaubnis, dass eine Klage stehen bleiben darf, wenn es nichts zu antworten gibt.',
    terms: [
      {
        word: 'hebr. haschibenu',
        rendered: 'Bringe uns, HERR, wieder',
        note: 'Wende uns um, bringe uns zurück. Dasselbe Verb steht für Umkehr und für Heimkehr – die Bitte meint beides zugleich und lässt offen, was zuerst kommt.',
      },
      {
        word: 'hebr. ki im maos meastanu',
        rendered: 'du hast uns verworfen',
        note: 'Der letzte Vers ist grammatisch schwierig: Er kann als Feststellung, als Frage oder als Bedingung gelesen werden – „es sei denn, du hättest uns ganz verworfen“. Keine Übersetzung kann die Offenheit bewahren.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Schlussvers hat dem kürzesten Buch des Alten Testaments seine bleibende Bedeutung gegeben. Er nimmt der vorangehenden Vergeltungsansage ihre letzte Konsequenz: Die Herrschaft fällt nicht dem Sieger zu.\n\nIn der Auslegung wird das Buch meist zusammen mit Jona gelesen, das ebenfalls von einem Nachbarvolk handelt und zum entgegengesetzten Ergebnis kommt. Wer nur eines von beiden liest, bekommt ein schiefes Bild von dem, was die Sammlung über Feinde sagt.',
    terms: [
      {
        word: 'hebr. peleta',
        rendered: 'Errettung',
        note: 'Die Entronnenen, der Rest, der übrigbleibt. Ein Schlüsselwort prophetischer Hoffnung: Nicht alles wird gerettet, aber etwas bleibt – und aus diesem Rest wird neu angefangen.',
      },
      {
        word: 'hebr. hammeluka la JHWH',
        note: 'Der letzte Satz des Buches: „und das Königreich wird des HERRN sein“. Nach einem Buch voller Vergeltung endet Obadja damit, dass die Herrschaft nicht bei Israel liegt, sondern bei Gott.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Aus diesen Versen stammt der Anfang des *Dies irae*, das dem Requiem seit dem 13. Jahrhundert seine Gestalt gab. Thomas von Celano wird meist als Verfasser genannt; die Sequenz war bis zur Liturgiereform von 1970 fester Bestandteil der Totenmesse und ist musikalisch bis heute allgegenwärtig.\n\nDas Buch selbst ist kurz und wird selten gelesen. Sein Bild vom Tag des HERRN steht zwischen Amos, der ihn umkehrte, und der späteren Apokalyptik – und es endet, anders als der Anfang vermuten lässt, mit einem Jubellied.',
    terms: [
      {
        word: 'hebr. jom ebra',
        rendered: 'Tag des Grimmes',
        note: 'Tag des Zorns. Die lateinische Fassung *dies irae* wurde zum Namen der berühmtesten Sequenz der Totenmesse und über Mozart, Verdi und Berlioz zu einem der bekanntesten Motive der Musikgeschichte.',
      },
      {
        word: 'hebr. schofar',
        rendered: 'Posaune',
        note: 'Das Widderhorn als Alarmsignal. Die Aufzählung in Vers 15 und 16 reiht sechs Bestimmungen desselben Tages aneinander – eine Steigerungsfigur, die den Tag von allen Seiten beschreibt.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'irdischen Gefäßen',
        note: 'Tongefäße – billige Wegwerfware der Antike, in der man Öl, Getreide oder auch Schriftrollen aufbewahrte. Die Rollen vom Toten Meer haben in solchen Krügen zweitausend Jahre überdauert.',
      },
      {
        word: 'griech. exaporoumenoi',
        rendered: 'verzagen',
        note: 'Ratlos sein bis zur Ausweglosigkeit. Paulus baut in den Versen 8 und 9 vier Gegensatzpaare, die jedes Mal ein Wort und sein verschärftes Gegenstück verwenden – bedrängt, aber nicht erdrückt; ratlos, aber nicht verzweifelt.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'neue Kreatur',
        note: 'Neue Schöpfung. Der Ausdruck kann den einzelnen Menschen meinen und die ganze Welt – im Griechischen fehlt das Wort „ist“, sodass auch „so ist neue Schöpfung“ möglich ist. Beide Lesarten sind vertreten.',
      },
      {
        word: 'griech. katallage',
        rendered: 'Versöhnung',
        note: 'Ein Wort aus dem Geldwechsel und aus der Diplomatie: den Zustand ändern, verfeindete Parteien zusammenbringen. Auffällig ist die Richtung – Gott versöhnt, und die Menschen werden gebeten, sich versöhnen zu lassen.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'Lindigkeit',
        note: 'Milde, Nachgiebigkeit, Billigkeit – die Bereitschaft, auf dem eigenen Recht nicht zu bestehen. Ein Begriff aus der Rechtssprache: Er beschreibt den Richter, der den Einzelfall über den Buchstaben stellt.',
      },
      {
        word: 'griech. phrourese',
        rendered: 'bewahre',
        note: 'Bewachen wie eine Garnison. Philippi war eine römische Veteranenkolonie mit Militärbesatzung – das Bild vom Frieden, der Herz und Sinne bewacht, war den Lesern vor Augen.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'ziehet nun an',
        note: 'Anziehen wie ein Kleid. Der Abschnitt davor spricht vom „Ausziehen“ des alten Menschen – die Bildreihe stammt aus der Taufe, bei der die Täuflinge tatsächlich die Kleidung wechselten.',
      },
      {
        word: 'griech. splanchna oiktirmou',
        rendered: 'herzliches Erbarmen',
        note: 'Wörtlich „Eingeweide des Erbarmens“. Das Griechische lokalisiert das Mitgefühl im Bauch, wie das Hebräische im Mutterleib – eine Körperlichkeit, die deutsche Übersetzungen durchweg glätten.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'wie ein Dieb in der Nacht',
        note: 'Ein Bild, das auch in den Evangelien, im zweiten Petrusbrief und in der Offenbarung steht – offenbar ein früh verbreitetes Wort. Es sagt nichts über den Zeitpunkt, sondern über dessen Unberechenbarkeit.',
      },
      {
        word: 'griech. huioi photos',
        rendered: 'Kinder des Lichtes',
        note: 'Söhne des Lichts. Dieselbe Selbstbezeichnung findet sich in den Rollen vom Toten Meer, wo die Gemeinschaft von Qumran sich so nennt – ein Hinweis darauf, wie verbreitet diese Sprache im Judentum der Zeit war.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'Abfall',
        note: 'Abfall, Aufstand. Das Wort ist politisch und religiös zugleich; in der griechischen Bibel bezeichnet es den Abfall von Gott, im politischen Sprachgebrauch den Aufstand gegen eine Herrschaft.',
      },
      {
        word: 'griech. ho katechon',
        note: 'Der „Aufhaltende“ in Vers 6 und 7 – eine der dunkelsten Wendungen des Neuen Testaments. Wer oder was gemeint ist, war schon in der Alten Kirche unbekannt; Vorschläge reichen vom römischen Reich über die Verkündigung bis zu einer Engelmacht.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'Genügen',
        note: 'Selbstgenügsamkeit – ein Grundbegriff der stoischen und kynischen Ethik, der das Unabhängigsein von äußeren Gütern bezeichnet. Der Brief übernimmt ihn und bindet ihn an die Frömmigkeit.',
      },
      {
        word: 'griech. philargyria',
        rendered: 'Geiz',
        note: 'Wörtlich „Silberliebe“, Geldgier. Der berühmte Satz sagt nicht, Geld sei die Wurzel des Übels, sondern die Liebe zum Geld – und im Griechischen steht „eine Wurzel“, nicht „die Wurzel“.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'geopfert',
        note: 'Als Trankopfer ausgegossen werden. Das Bild stammt aus dem antiken Opferbetrieb, in dem Wein neben das Opfer gegossen wurde – nicht die Hauptsache, sondern die Beigabe.',
      },
      {
        word: 'griech. analysis',
        rendered: 'Abscheiden',
        note: 'Das Loswerfen der Schiffstaue, der Abbruch eines Zeltlagers. Ein Wort für den Aufbruch, nicht für das Ende – dieselbe Wurzel wie im deutschen Fremdwort Analyse.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'erschienen',
        note: 'Aufscheinen, sichtbar werden – daher das Fest Epiphanias. Das Wort gehörte zur Sprache der Herrscherverehrung: Die Ankunft des Kaisers in einer Stadt hieß *epiphaneia*.',
      },
      {
        word: 'griech. paideuousa',
        rendered: 'züchtigt',
        note: 'Erziehen, unterweisen – von *pais*, dem Kind; daher Pädagogik. Luthers „züchtigen“ klingt heute nach Strafe; gemeint ist Erziehung, die zu einem selbständigen Leben anleitet.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'Wolke von Zeugen',
        note: 'Eine Wolke von Zeugen. Das Bild stammt aus dem Stadion: Die Menge auf den Rängen. Die „Zeugen“ sind dabei nicht Zuschauer, sondern solche, die selbst gelaufen sind – das Kapitel davor hat sie aufgezählt.',
      },
      {
        word: 'griech. archegon kai teleioten',
        rendered: 'Anfänger und Vollender',
        note: 'Anführer und Vollender. Das erste Wort meint den, der vorangeht und den Weg bahnt – nicht den, der etwas beginnt. Das Bild bleibt im Stadion: Er läuft voraus und ist zuerst am Ziel.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'Anfechtungen',
        note: 'Prüfungen und Versuchungen zugleich. Der Brief spielt mit beiden Bedeutungen: In Vers 2 sind es Widrigkeiten von außen, in Vers 13 Versuchungen von innen, für die Gott ausdrücklich nicht verantwortlich ist.',
      },
      {
        word: 'griech. haplos',
        rendered: 'einfältig',
        note: 'Schlicht, ohne Hintergedanken. Gott gibt „einfach so“ – ohne Bedingungen und ohne es nachträglich vorzuhalten. Luthers „einfältig“ meint im 16. Jahrhundert genau das.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'griech. mythois',
        rendered: 'Fabeln',
        note: 'Mythen, erdachte Geschichten. Der Brief grenzt sich ausdrücklich gegen Erfundenes ab und beruft sich auf Augenzeugenschaft – ein Argumentationsmuster, das in der antiken Geschichtsschreibung geläufig war.',
      },
      {
        word: 'griech. phosphoros',
        rendered: 'Morgenstern',
        note: 'Der Lichtträger, der Morgenstern – lateinisch *lucifer*. Das Wort bezeichnet hier Christus; erst über eine spätere Auslegung von Jesaja 14 wurde daraus der Name des gefallenen Engels.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'griech. phos',
        rendered: 'Licht',
        note: 'Licht. Der Brief gebraucht es nicht als Bild für Erkenntnis, sondern für Offenheit: Im Licht wandeln heißt, nichts zu verbergen zu haben – deshalb folgt unmittelbar das Bekennen der Sünden.',
      },
      {
        word: 'griech. koinonia',
        rendered: 'Gemeinschaft',
        note: 'Gemeinschaft, Teilhabe. Ein Wort aus dem Geschäftsleben für die Teilhaberschaft. Der Brief verbindet damit zwei Richtungen: Gemeinschaft mit Gott und miteinander, und er lässt sie nicht auseinanderfallen.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Vers ist der biblische Kerntext der christlichen Ehelehre. Jesus zitiert ihn im Streitgespräch über die Ehescheidung, und die katholische Kirche leitet aus ihm die Unauflöslichkeit der sakramentalen Ehe ab; das Kirchenrecht bindet daran bis heute die Frage der Wiederheirat.\n\nAuffällig ist zudem, was nicht dasteht: kein Wort von Nachkommen, keines von einem Rechtsakt, keine Zeugen. In heutigen Debatten über Ehe, Wiederheirat und Segnung wird genau diese Kargheit von verschiedenen Seiten geltend gemacht – die einen sehen darin die Beschränkung auf das Wesentliche, die anderen den Beleg, dass der Vers keine Rechtsordnung stiftet.',
    terms: [
      {
        word: 'hebr. dabaq',
        rendered: 'hangen',
        note: 'Ankleben, festhalten an. Dasselbe Verb steht im Deuteronomium für das Anhangen an Gott – es beschreibt eine Bindung, die man nicht beiläufig löst.',
      },
      {
        word: 'hebr. basar echad',
        rendered: 'ein Fleisch',
        note: 'Wörtlich „ein Fleisch“ – nicht „eine Seele“ oder „ein Herz“. Der Ausdruck meint die leibliche und die verwandtschaftliche Einheit zugleich; im Hebräischen ist „mein Fleisch“ eine Bezeichnung für die eigene Sippe.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'gesellschaft',
        text: 'Ohne Sippe war ein Mensch rechtlos. Die Großfamilie stellte Schutz, Erbrecht, Blutrache, Versorgung im Alter und die Bestattung im Familiengrab – eine andere Absicherung gab es nicht. „Geh aus deinem Vaterhaus“ verlangt also nicht Fernweh, sondern den Verzicht auf jede Rückversicherung.',
      },
      {
        aspect: 'raum',
        text: 'Der Weg von Haran nach Kanaan führt rund 900 Kilometer am Rand der syrischen Wüste entlang, entlang der Karawanenstraße über Damaskus. Halbnomadische Familien mit Kleinvieh legten so etwa 15 bis 20 Kilometer am Tag zurück und richteten sich nach Brunnen und Weidegründen, nicht nach Städten.',
      },
      {
        aspect: 'glaube',
        text: 'Götter waren an Gebiete gebunden. Wer auswanderte, wechselte üblicherweise die Gottheit, weil die alte im neuen Land nichts galt – noch 1. Samuel 26 setzt diese Vorstellung voraus. Ein Gott, der mitgeht und im fremden Land derselbe bleibt, war der ungewöhnliche Teil dieser Berufung.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    reception:
      'Die Zusage „ich bin mit dir“ gehört zu den meistgewählten Tauf- und Reisesegen und steht auf unzähligen Karten. Ihr Ort in der Erzählung ist bemerkenswert: Sie ergeht ohne jede Bedingung und ohne dass die frische Schuld auch nur erwähnt würde – und Jakob antwortet darauf mit einem Gelübde, das ein Geschäft ist: Wenn Gott ihn behütet und heimbringt, dann werde er ihm den Zehnten geben.\n\nBethel wurde später eines der beiden Reichsheiligtümer des Nordreichs und von den Propheten scharf angegriffen. Die Erzählung von der Himmelsleiter erklärt seine Heiligkeit – und die deuteronomistische Bearbeitung, die das Heiligtum ablehnt, hat sie dennoch stehen lassen.',
    terms: [
      {
        word: 'hebr. maqom',
        rendered: 'Ort',
        note: 'Ort, Stätte – im späteren Judentum wird „der Ort“ zu einer Umschreibung für Gott selbst. Jakob nennt die Stelle Bethel, „Haus Gottes“; das Wort steht in dieser Erzählung sechsmal.',
      },
      {
        word: 'hebr. sullam',
        note: 'Das Wort kommt nur hier vor und wird meist mit „Leiter“ übersetzt. Wahrscheinlicher ist eine Rampe oder Treppe, wie sie mesopotamische Stufentempel hatten – ein Aufgang, über den die Gottheit herabkommt.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Das Kapitel steht unmittelbar nach dem goldenen Kalb, und die Bitte des Mose ist eine Verhandlung: Er ringt Gott ab, dass er trotz des Bruchs mitgeht. In der jüdischen Auslegung gilt Mose hier als Vorbild des Fürbitters, der nicht nachgibt.\n\nDie Verse 18 bis 23 – Mose darf nur den Rücken Gottes sehen – gehören zu den Grundtexten der negativen Theologie. Gregor von Nyssa hat daraus im 4. Jahrhundert eine ganze Mystik entwickelt: Gotteserkenntnis sei ein Aufstieg, der nie ankommt, weil Gott immer weiter voraus ist.',
    terms: [
      {
        word: 'hebr. panim',
        rendered: 'Angesicht',
        note: 'Gesicht, Gegenwart. „Mein Angesicht geht mit“ heißt: ich selbst gehe mit, nicht ein Bote. Dasselbe Wort steht wenige Verse später, wenn Mose Gottes Angesicht sehen will und die Antwort lautet, das könne kein Mensch überleben.',
      },
      {
        word: 'hebr. jadati beschem',
        rendered: 'ich kenne dich mit Namen',
        note: 'Wörtlich „ich kenne dich beim Namen“. Eine Auszeichnungsformel: nicht als einen von vielen, sondern als diesen Bestimmten. Dieselbe Wendung steht bei der Berufung des Kyros in Jesaja 45.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Vers gehört zu den meistgesprochenen Zusagen bei Amtsübergaben, Auszügen und Abschieden. Seine Lage ist eine Abschiedsszene: Mose ist 120 Jahre alt und darf das Land nicht betreten; was er weitergibt, ist eine Zusage, die er selbst nicht mehr eingelöst sieht.\n\nDie Wirkungsgeschichte hat, wie bei Josua 1, eine problematische Seite: Der Zuspruch steht am Anfang einer Landnahmeerzählung und ist in Siedlerbewegungen als göttliche Rückendeckung gelesen worden. Die Trennung von Zuspruch und Kriegsauftrag gehört zu den Aufgaben jeder heutigen Auslegung dieser Kapitel.',
    terms: [
      {
        word: 'hebr. lo arpecha',
        rendered: 'die Hand nicht abtun',
        note: 'Wörtlich „ich lasse dich nicht los“. Der Hebräerbrief zitiert diese Zusage in Kapitel 13 mit einer Verstärkung, die in keiner alttestamentlichen Handschrift steht – ein Beispiel dafür, wie frei das Neue Testament zitiert.',
      },
      {
        word: 'hebr. chasaq weemaz',
        rendered: 'getrost und unverzagt',
        note: 'Sei stark und fest – ein militärischer Zuruf vor der Schlacht. Er steht in diesem Kapitel dreimal und rahmt die Übergabe des Amtes an Josua.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Das Gebet Salomos ist der klassische Text gegen jede Verwechslung von Gebäude und Gottheit und wird bei Kirchweihen ebenso gelesen wie bei Kirchenschließungen. Stephanus zitiert es in seiner Rede in Apostelgeschichte 7 gegen den Tempel, und Paulus greift denselben Gedanken auf dem Areopag auf.\n\nAuffällig ist die Bitte, die der König anschließt: Gott möge auch das Gebet des Fremden hören, der von ferne kommt. In einer Zeit, in der Heiligtümer national gedacht waren, ist das eine bemerkenswerte Öffnung – und einer der Gründe, warum das Kapitel in Debatten über religiöse Gastfreundschaft regelmäßig zitiert wird.',
    terms: [
      {
        word: 'hebr. schme haschschamajim',
        rendered: 'aller Himmel Himmel',
        note: 'Wörtlich „die Himmel der Himmel“ – eine hebräische Steigerungsform für das Äußerste, wie „Lied der Lieder“ für das schönste Lied. Gemeint ist nicht ein Stockwerk, sondern der größtmögliche Raum.',
      },
      {
        word: 'hebr. schem',
        rendered: 'Name',
        note: 'Der Name als Stellvertretung: Nicht Gott wohnt im Tempel, sondern sein Name. Diese Unterscheidung ist die Antwort der deuteronomistischen Theologie auf die Frage, wie ein Haus Gott fassen soll.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Vers gehört zu den meistzitierten in der geistlichen Kampfliteratur und in Predigten über Angst. Was dabei meist untergeht: Die Feuerwagen kämpfen nicht. Elisa führt das feindliche Heer stattdessen mit Blindheit geschlagen nach Samaria – und lässt ihm dort ein Mahl vorsetzen, statt es zu töten.\n\nGenau dieser Schluss macht den Abschnitt in der Friedensethik interessant: Die Erzählung endet damit, dass die Streifzüge aufhören, weil die Gefangenen freigelassen und bewirtet wurden. Ein Kriegsbericht, der mit einem Essen endet.',
    terms: [
      {
        word: 'hebr. peqach na et enaw',
        rendered: 'öffne ihm die Augen',
        note: 'Die Bitte gilt nicht dem Feind, sondern dem eigenen Diener. Nichts an der Lage ändert sich – nur die Wahrnehmung dessen, der sich fürchtet.',
      },
      {
        word: 'hebr. rekeb esch',
        rendered: 'feuriger Rosse und Wagen',
        note: 'Feuerwagen. Dasselbe Bild steht bei der Entrückung Elias und ist im Alten Orient die Ausstattung eines Gottes im Krieg. Elisa sieht damit, was der Diener nicht sieht – und keiner der Wagen greift ein.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Petrus legt in Apostelgeschichte 2 den ganzen Psalm auf die Auferstehung aus, und Paulus tut es in Antiochia ebenso. Damit gehört Psalm 16 zu den frühesten alttestamentlichen Texten, die im Christentum österlich gelesen wurden.\n\nIm Hebräischen ist der Psalm zurückhaltender: Er bittet darum, nicht der Grube überlassen zu werden – also um Bewahrung vor einem vorzeitigen Tod, nicht ausdrücklich um Auferstehung. Der Unterschied zwischen hebräischer und griechischer Fassung ist an dieser Stelle einer der lehrreichsten Fälle für die Frage, wie das Neue Testament die Schrift liest.',
    terms: [
      {
        word: 'hebr. orach chajjim',
        rendered: 'Weg zum Leben',
        note: 'Der Lebenspfad. Die griechische Bibel übersetzt „Wege des Lebens“, und in dieser Fassung zitiert Petrus den Psalm in seiner Pfingstpredigt als Aussage über die Auferstehung.',
      },
      {
        word: 'hebr. naim',
        rendered: 'liebliches Wesen',
        note: 'Lieblichkeit, Anmut, Wonne. Ein Wort aus der Poesie, das die deutsche Übersetzung nur umschreiben kann; es beschreibt keinen Zustand, sondern einen Eindruck.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Psalm 32 ist der erste der sieben Bußpsalmen und stand in der mittelalterlichen Bußpraxis neben Psalm 51. Paulus zitiert seine ersten Verse in Römer 4 als Beleg dafür, dass Gott ohne Werke gerecht spricht; Augustinus ließ sich den Psalm nach Überlieferung seines Biographen an die Wand neben sein Sterbebett schreiben.\n\nDer Vers selbst ist ein häufiger Konfirmationsspruch. Sein Bild ist bemerkenswert unaufdringlich: Kein Zaum, kein Gebiss, sondern ein Blick – Führung, die Einsicht voraussetzt statt Zwang.',
    terms: [
      {
        word: 'hebr. askilcha',
        rendered: 'unterweisen',
        note: 'Klug machen, einsichtig machen. Wer in diesen Versen spricht, ist nicht sicher – Gott oder der Beter, der aus Erfahrung redet. Die Anführungszeichen der Lutherbibel treffen eine Entscheidung, die der hebräische Text offenlässt.',
      },
      {
        word: 'hebr. beeni',
        rendered: 'mit meinen Augen',
        note: 'Wörtlich „mit meinem Auge auf dir“. Ein Bild für aufmerksame Begleitung; der Gegensatz im nächsten Vers ist das Pferd, das Zaum und Gebiss braucht, weil es nicht versteht.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Vers ist seit dem 4. Jahrhundert der klassische Kommunionsgesang: Die Jerusalemer Katechesen des Kyrill nennen ihn ausdrücklich, und er steht bis heute in katholischen wie evangelischen Abendmahlsliturgien. Kaum ein anderer Psalmvers ist so eng mit einer einzelnen liturgischen Handlung verbunden.\n\nDer Psalm ist zudem alphabetisch gebaut – jeder Vers beginnt mit dem nächsten Buchstaben –, und ein Buchstabe fehlt. Diese Lücke hat Ausleger seit jeher beschäftigt; eine überzeugende Erklärung gibt es nicht.',
    terms: [
      {
        word: 'hebr. taamu',
        rendered: 'Schmecket',
        note: 'Kosten, prüfen durch Schmecken – ein Wort aus dem Alltag, nicht aus dem Gottesdienst. Die Aufforderung ist auffallend sinnlich: Erst probieren, dann urteilen.',
      },
      {
        word: 'hebr. tow',
        rendered: 'freundlich',
        note: 'Gut, freundlich, angenehm. Luther wählt „freundlich“, wo andere „gütig“ sagen. Im Zusammenhang des Schmeckens klingt beides mit – gut im Sinn von: bekömmlich.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Vers gehört zu den meistzitierten Sätzen in der Ratgeberliteratur und wird dort häufig als Zusage gelesen: Wer sich an Gott freut, bekommt, was er sich wünscht. Der Psalm ist eine Weisheitsdichtung und arbeitet mit Erfahrungssätzen, keine Verheißungssammlung; wenige Verse weiter steht ausdrücklich, dass das Wenige des Gerechten besser sei als der Reichtum vieler Gottlosen.\n\nDas Grundproblem des Psalms – dass es Gottlosen gutgeht – wird in der Bibel selbst weitergetrieben: Psalm 73 und das Buch Hiob widersprechen der einfachen Rechnung, die Psalm 37 aufmacht. Die Sammlung hält beide Stimmen nebeneinander.',
    terms: [
      {
        word: 'hebr. hitannag',
        rendered: 'Habe deine Lust',
        note: 'Sich verwöhnen lassen, sich an etwas erfreuen – ein Wort für Genuss, nicht für Pflicht. Die Aufforderung lautet nicht, Gott zu gehorchen, sondern an ihm Freude zu haben.',
      },
      {
        word: 'hebr. gol al',
        rendered: 'Befiehl',
        note: 'Wörtlich „wälze auf“ – dasselbe Bild wie beim Wälzen eines Steins. Luthers „befiehl“ meint im 16. Jahrhundert „übergib, vertraue an“, nicht „gib einen Befehl“.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der erste Petrusbrief nimmt den Vers auf, und über diese Aufnahme ist er in die christliche Gebetssprache eingegangen. Georg Neumarks Lied „Wer nur den lieben Gott lässt walten“ von 1641 ist eine freie Nachdichtung; Bach hat es mehrfach vertont.\n\nDer Zusammenhang wird selten mitgelesen: Der Psalm klagt über einen Verrat aus nächster Nähe – „du, mein Geselle, mein Freund und mein Verwandter“. Der Trostvers steht am Ende einer Erfahrung, die nicht durch Feinde, sondern durch Vertraute verursacht wurde.',
    terms: [
      {
        word: 'hebr. jehabcha',
        rendered: 'Anliegen',
        note: 'Ein seltenes Wort, das nur hier vorkommt: die Last, die einem zugeteilt ist. Die alten Übersetzungen schwanken zwischen „Sorge“, „Los“ und „Bürde“.',
      },
      {
        word: 'hebr. jechalkelecha',
        rendered: 'versorgen',
        note: 'Versorgen, aushalten, tragen. Dasselbe Verb steht für das Ernähren in der Hungersnot – die Zusage lautet nicht, dass die Last verschwindet, sondern dass der Beter durchgebracht wird.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Psalm ist über Mendelssohns Motette und über zahlreiche Vertonungen ein fester Bestandteil der Kirchenmusik; im Deutschen ist „Meine Seele ist stille zu Gott“ zu einer Formel geworden, die in Andachtsbüchern und auf Grabsteinen steht.\n\nSelten mitzitiert wird die Mitte des Psalms: eine scharfe Beschreibung von Menschen, die schmeicheln und im Herzen fluchen, und die Feststellung, dass Menschen „leichter als nichts“ sind, wenn man sie auf die Waage legt. Die Stille dieses Psalms ist die eines Menschen, der aufgehört hat, sich zu verteidigen.',
    terms: [
      {
        word: 'hebr. ach',
        note: 'Ein Wörtchen, das der Psalm sechsmal an den Anfang eines Verses stellt: „nur“, „gewiss“, „doch“. Luther gibt es unterschiedlich wieder, sodass die Klammer im Deutschen verschwindet.',
      },
      {
        word: 'hebr. dumija',
        rendered: 'stille',
        note: 'Schweigen, Stillsein. Nicht ein Gefühl der Ruhe, sondern das Aufhören des Redens – im Zusammenhang: das Ende des Streitens mit denen, die den Beter stürzen wollen.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Psalm 73 gilt vielen als der ehrlichste Text des Psalters über den Neid: Der Beter gesteht ein, dass er die Gottlosen beneidet hat und beinahe daran gescheitert wäre. Die Wende kommt nicht durch ein Argument, sondern durch den Gang ins Heiligtum – der Text erklärt nicht, was dort geschah.\n\nVers 25 ist einer der meistgewählten Konfirmationssprüche und Grabinschriften. In der Mystik ist er zum Kerntext geworden: Meister Eckhart, Tersteegen und die pietistische Liedtradition beziehen sich auf ihn, wenn sie vom Genügen an Gott allein sprechen.',
    terms: [
      {
        word: 'hebr. cheleq',
        rendered: 'mein Teil',
        note: 'Der Anteil, der Erbteil am Land. Die Leviten bekamen kein Land, und von ihnen heißt es, Gott selbst sei ihr Erbteil. Der Beter überträgt diese Aussage auf sich.',
      },
      {
        word: 'hebr. zur lebabi',
        rendered: 'meines Herzens Trost',
        note: 'Wörtlich „Fels meines Herzens“. Luther wählt „Trost“, wo im Hebräischen ein Baumaterial steht – die Sprache des Psalms ist an dieser Stelle härter, als sie im Deutschen klingt.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Vers ist ein Standardtext der Ermutigungsliteratur und in charismatischen Kreisen ein Kernwort der „geistlichen Kampfführung“. In der Chronik ist er Teil einer Erzählung, in der Sänger vor dem Heer hergehen und der Kampf sich unter den Feinden selbst entscheidet – eine Darstellung, die die Chronik gegenüber ihren Quellen deutlich ausbaut.\n\nIn der Friedensethik wird derselbe Text anders gelesen: als einer der wenigen Kriegsberichte der Bibel, in dem niemand aus dem eigenen Volk eine Waffe führt. Beide Verwendungen berufen sich auf denselben Vers.',
    terms: [
      {
        word: 'hebr. milchama',
        rendered: 'streitet',
        note: 'Der Krieg. Die Wendung „nicht euer ist der Krieg, sondern Gottes“ gehört zur Sprache des heiligen Krieges, in der die Kämpfenden nichts tun – ein Motiv, das schon beim Durchzug durchs Meer steht.',
      },
      {
        word: 'hebr. hitjazzebu',
        rendered: 'Tretet nur hin und steht',
        note: 'Sich aufstellen, Stellung beziehen. Der Befehl lautet nicht „geht weg“, sondern „stellt euch auf und seht zu“ – eine Aufstellung ohne Kampf.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Spruch gehört zu den meistzitierten Sätzen über Planung und Führung und steht in Ratgebern ebenso wie in Traueranzeigen nach unerwarteten Todesfällen. In der Frömmigkeitspraxis wird er gelegentlich gegen jede Vorausplanung gewendet; die Sprüche selbst tun das nirgends.\n\nSprüche 16 enthält gleich mehrere Sätze dieser Bauart – über den Plan des Menschen und die Antwort Gottes, über das Los, das in den Schoß geworfen wird. Die Sammlung umkreist damit eine Erfahrung, die sie nicht auflöst: dass Menschen entscheiden und der Ausgang nicht in ihrer Hand liegt.',
    terms: [
      {
        word: 'hebr. jachschob',
        rendered: 'erdenkt',
        note: 'Planen, berechnen. Der Spruch verwirft die Planung nicht – er stellt sie in ein Verhältnis. Dieselbe Sammlung empfiehlt an anderer Stelle ausdrücklich, Rat einzuholen und vorauszuplanen.',
      },
      {
        word: 'hebr. jakin zaado',
        rendered: 'gibt, daß er fortgehe',
        note: 'Wörtlich „richtet seinen Schritt“. Nicht das Ziel wird bestimmt, sondern der einzelne Tritt – das Bild ist bescheidener, als die deutsche Fassung nahelegt.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Vers steht als Bauspruch an Häusern und Stadttoren und hat über Luthers „Ein feste Burg“ eine Verwandtschaft, die oft angenommen, aber nicht belegt ist – Luthers Lied geht auf Psalm 46 zurück.\n\nAuffällig ist die Beobachtung, die der folgende Vers macht: Der Reiche hält seinen Besitz für eine Mauer, und das Wort für „Einbildung“ sagt, was der Spruch davon hält. Die beiden Verse gehören zusammen und werden fast immer getrennt zitiert.',
    terms: [
      {
        word: 'hebr. migdal os',
        rendered: 'festes Schloß',
        note: 'Ein starker Turm. Luthers „Schloss“ meint die Festung, nicht ein Türschloss – ein Wortgebrauch, der sich seit dem 16. Jahrhundert verschoben hat.',
      },
      {
        word: 'hebr. bemaskito',
        rendered: 'in seinem Dünkel',
        note: 'Wörtlich „in seiner Einbildung“. Der Vers danach stellt zwei Festungen gegeneinander: den Namen Gottes und das Vermögen des Reichen – die zweite besteht nur in der Vorstellung ihres Besitzers.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Die letzten beiden Verse gelten vielen Auslegern als späterer Zusatz eines Bearbeiters, der das skeptische Buch für den Kanon fassbar machen wollte. Ohne sie endet Kohelet mit dem Bild vom zerbrochenen Krug am Brunnen und dem Satz „es ist alles ganz eitel“.\n\nOb das Buch dadurch entschärft oder abgerundet wird, wird seit der Antike gestritten. Die rabbinische Überlieferung berichtet von einer Auseinandersetzung darüber, ob Kohelet überhaupt in den Kanon gehört; der Schluss dürfte dabei den Ausschlag gegeben haben. Was er nicht leistet: die Widersprüche im Buch aufzulösen.',
    terms: [
      {
        word: 'hebr. sof dabar',
        rendered: 'Hauptsumme',
        note: 'Das Ende der Sache, der Schluss der Rede. Ein Buchhalterwort – Kohelet zieht eine Bilanz, wie er es das ganze Buch hindurch tut.',
      },
      {
        word: 'hebr. kol haadam',
        rendered: 'allen Menschen',
        note: 'Wörtlich „das ist der ganze Mensch“. Der Satz ist unvollständig und wird verschieden ergänzt: Das ist die Pflicht jedes Menschen – oder: Darin besteht der Mensch überhaupt.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Vers gehört zu den meistgewählten Konfirmationssprüchen und ist über die englische Fassung „Thou wilt keep him in perfect peace“ in zahlreiche Vertonungen eingegangen. Er steht im sogenannten Jesaja-Apokalypse-Teil, den Kapiteln 24 bis 27, die von einem Weltgericht und einem Festmahl für alle Völker sprechen.\n\nDer Zusammenhang ist entsprechend groß gefasst: Der Friede, von dem hier die Rede ist, gilt einer Stadt in einer Zeit, in der Städte fallen. In der Auslegung wird er meist auf die einzelne Person bezogen – eine Verengung, die den Vers tröstlicher und zugleich kleiner macht.',
    terms: [
      {
        word: 'hebr. schalom schalom',
        rendered: 'stets Frieden',
        note: 'Der hebräische Text wiederholt das Wort: „Frieden, Frieden“ – eine Steigerungsform für vollkommenen Frieden. Luthers „stets“ gibt die Wiederholung als Dauer wieder.',
      },
      {
        word: 'hebr. jezer samuch',
        rendered: 'nach gewisser Zusage',
        note: 'Wörtlich „festes Sinnen“ oder „gestützter Sinn“ – gemeint ist ein Denken, das sich auf etwas verlässt. Die Übersetzungen gehen hier weit auseinander; Luther deutet auf die Zusage Gottes, andere auf die Haltung des Menschen.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Vers gehört zu den meistgesprochenen Zusagen in Taufe, Trauung und Seelsorge und ist über zahlreiche Lieder verbreitet. Sein Ort im Buch ist bemerkenswert: Er steht im Trostbüchlein der Kapitel 30 bis 33, gerichtet an das Nordreich, das seit über hundert Jahren nicht mehr existierte.\n\nDie Zusage gilt damit einer Größe, die es politisch nicht mehr gab. In der Auslegung wird das als der eigentliche Punkt gelesen: Die Liebe, von der Jeremia spricht, hängt nicht daran, dass ihr Gegenüber noch da ist.',
    terms: [
      {
        word: 'hebr. ahabat olam',
        rendered: 'je und je geliebt',
        note: 'Wörtlich „mit ewiger Liebe“. Das hebräische *olam* meint eine Zeit, deren Ende nicht abzusehen ist – nicht Zeitlosigkeit, sondern Dauer ohne erkennbare Grenze.',
      },
      {
        word: 'hebr. betulat jisrael',
        rendered: 'Jungfrau Israel',
        note: 'Eine feste Bezeichnung für ein Volk oder eine Stadt, wie „Tochter Zion“. Sie sagt nichts über Unschuld aus, sondern personifiziert – im selben Kapitel wird dieselbe Gestalt zum Tanz aufgefordert.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'alltag',
        text: 'Ein Bauernhaus hatte einen Raum und wenige, kleine Fenster. Die Tonlampe mit Olivenöl und Docht brannte auf einem Ständer und beleuchtete tatsächlich alles, was da war. Öl war teuer genug, dass man die Lampe nicht ohne Grund brennen ließ.',
      },
      {
        aspect: 'raum',
        text: 'Städte lagen aus Verteidigungsgründen auf Kuppen und waren nachts an ihren Lichtern über weite Strecken zu sehen. Wer im galiläischen Bergland stand, hatte solche Orte am Horizont. Das Bild ist eine Beobachtung, keine Erfindung.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'arbeit',
        text: 'Kleidung war ein Vermögenswert: Ein Gewand entstand aus Wolle oder Flachs in Wochen Handarbeit, wurde vererbt, gepfändet und als Sicherheit hinterlegt. 2. Mose 22 verlangt, den Mantel eines Armen vor Sonnenuntergang zurückzugeben, weil er darin schläft. Sorge um Kleidung war deshalb keine Eitelkeit.',
      },
      {
        aspect: 'raum',
        text: 'Die Lilien und das Gras des Feldes blühen in Galiläa im Frühjahr für wenige Wochen und verdorren im Mai; getrocknetes Gras wurde als Brennmaterial in den Backofen geschoben. Das Bild vom Gras, das morgen in den Ofen kommt, beschreibt einen Handgriff aus der Küche.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'arbeit',
        text: 'Mühselig und beladen beschreibt Tagelöhner, Träger und Kleinbauern: Lasten wurden auf dem Rücken oder mit dem Joch über den Schultern getragen, gearbeitet wurde von Sonnenaufgang bis Sonnenuntergang. Der Zustand ist körperlich gemeint, bevor er auf anderes übertragen wird.',
      },
      {
        aspect: 'arbeit',
        text: 'Ein Joch war maßgefertigt: Es wurde dem einzelnen Tier angepasst, damit es nicht scheuerte, und verband zwei Zugtiere, von denen das erfahrene das jüngere führte. „Mein Joch ist sanft“ meint deshalb ein gut gearbeitetes Joch – nicht das Fehlen einer Last.',
      },
    ],
    terms: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'unmöglich',
        note: 'Unmöglich, nicht machbar. Der Satz ist keine allgemeine Sentenz: Er antwortet auf die entsetzte Frage der Jünger, wer denn dann gerettet werden könne – nach dem Wort vom Kamel und dem Nadelöhr.',
      },
      {
        word: 'griech. panta',
        rendered: 'alle Dinge',
        note: 'Alles. Der Zusammenhang füllt das Wort: Gemeint ist nicht jede beliebige Möglichkeit, sondern dass auch ein Reicher gerettet werden kann – woran die Jünger zweifeln.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'gesellschaft',
        text: 'Die Frage nach dem wichtigsten Gebot war eine geläufige Schuldebatte: Bei 613 gezählten Geboten stritt man darüber, welches als Grundsatz alle anderen zusammenfasst. Hillel soll auf einem Bein die verneinte Goldene Regel genannt haben. Die Antwort steht in dieser Übung, sie fällt nicht aus ihr heraus.',
      },
      {
        aspect: 'alltag',
        text: 'Beide Zitate kannte jeder Hörer auswendig: Das erste stand im Gebet, das zweimal täglich gesprochen wurde, das zweite im Heiligkeitsgesetz. Sie zusammenzustellen war eine Auslegungsleistung, die man am Wortlaut nachprüfen konnte – deshalb stimmt der Fragende im Markusbericht ausdrücklich zu.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'gesellschaft',
        text: 'Beim Gastmahl entschied die Sitzordnung über den Rang, und die Plätze rechts und links des Gastgebers waren die begehrtesten. Die Bitte der Zebedäus-Söhne ist deshalb keine Frömmigkeit, sondern eine Karriereforderung – und die Empörung der übrigen zehn ist Konkurrenz.',
      },
      {
        aspect: 'recht',
        text: 'Lösegeld war ein geläufiger Rechtsvorgang: Kriegsgefangene und Schuldsklaven wurden freigekauft, oft von Verwandten, manchmal von Gemeinden. Inschriften aus Delphi überliefern hunderte solcher Freilassungen. Das Wort kam aus dem Alltag, nicht aus der Theologie.',
      },
    ],
    terms: [
      {
    ...
    terms: [
      {
        word: 'griech. ktisis',
        rendered: 'Kreatur',
        note: 'Geschöpf, Schöpfung. „Aller Kreatur“ ist weiter als „allen Menschen“ – ein Zug, den die Umweltethik aufgreift, während die Missionsgeschichte den Vers durchweg auf Menschen bezogen hat.',
      },
      {
        word: 'griech. katakrithesetai',
        rendered: 'verdammt werden',
        note: 'Verurteilt werden. Auffällig ist die Asymmetrie: Zur Rettung gehören Glaube und Taufe, zur Verurteilung nur der fehlende Glaube. Die Taufe erscheint damit nicht als Bedingung des Heils.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'griech. rhema',
        rendered: 'Ding',
        note: 'Wort und Sache zugleich – dasselbe Wort wie das hebräische *dabar*. Der Satz lautet wörtlich: „Kein Wort wird bei Gott unmöglich sein“ – nicht jede Sache, sondern jede Zusage.',
      },
      {
        word: 'griech. adynatesei',
        rendered: 'unmöglich',
        note: 'Kraftlos sein, unmöglich sein. Der Satz zitiert 1. Mose 18,14, wo Gott dieselbe Frage an Sara richtet, die über die Ankündigung eines Kindes gelacht hat.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    terms: [
      {
        word: 'griech. homoios',
        rendered: 'gleich auch ihr',
        note: 'Ebenso, in gleicher Weise. Lukas stellt die Regel mitten in die Feindesliebe – anders als Matthäus, der sie als Zusammenfassung von Gesetz und Propheten setzt.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'griech. kolpos',
        rendered: 'Schoß',
        note: 'Die Bausche des Obergewands, die über dem Gürtel als Tasche diente. Getreide wurde tatsächlich dorthin geschüttet – das Bild stammt vom Marktplatz, nicht aus der Poesie.',
      },
      {
        word: 'griech. metron',
        rendered: 'Maß',
        note: 'Das Hohlmaß beim Getreidehandel. „Gedrückt, gerüttelt und überfließend“ beschreibt, wie ein Händler ein Maß füllt, der es gut meint: schütteln, nachdrücken, überlaufen lassen.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'macht',
        text: 'Wer sich einer Bewegung anschloss, deren Anführer hingerichtet worden war, machte sich mitverdächtig. Rom verfolgte Aufstandsreste, und Sippenhaftung war nicht ausgeschlossen. Die Nachfolge, von der der Vers spricht, hatte für die ersten Leser eine unmittelbare politische Bedeutung.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Sich selbst zu verleugnen hieß in einer Ehrgesellschaft: auf den eigenen Anspruch verzichten, den die Familie mitträgt. Wer seinen Stand nicht verteidigte, beschädigte auch seine Angehörigen. Deshalb ist die Aufforderung härter, als sie heute klingt – sie betraf nicht nur den Einzelnen.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'arbeit',
        text: 'Zölle wurden verpachtet: Wer die Erhebung ersteigerte, zahlte im Voraus und holte sich den Einsatz mit Aufschlag herein. Jericho lag an einer Zollgrenze und war für Balsamhandel bekannt – ein Oberzöllner dort war reich, und jeder wusste, woher.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Zöllner galten als unrein und unzuverlässig, ihr Zeugnis vor Gericht wenig wert; sie wurden gemieden, weil sie für die Besatzungsmacht arbeiteten und die eigenen Leute schröpften. Bei einem solchen einzukehren hieß, seine Tischgemeinschaft öffentlich anzuerkennen.',
      },
      {
        aspect: 'recht',
        text: 'Vierfache Erstattung war der Satz für nachgewiesenen Diebstahl mit Schlachtung nach 2. Mose 21; freiwillige Rückgabe verlangte nur den Betrag plus ein Fünftel. Zachäus bietet also weit mehr an, als das Recht ihm abverlangt hätte.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'arbeit',
        text: 'Nachts wurden Herden in Steinpferche getrieben, deren einziger Zugang eine Lücke war; der Hirte legte sich davor. Wer über die Mauer kam, kam als Dieb. Die Bildrede setzt diese Bauweise voraus und braucht sie nicht zu erklären.',
      },
      {
        aspect: 'macht',
        text: 'Hesekiel 34 nennt die Hirten Israels als Verantwortliche, die sich selbst weiden – gemeint ist die politische Führung. Wer in Jerusalem vom guten Hirten und von Dieben sprach, sprach in einem Bild, das seit Jahrhunderten Herrschaftskritik trug.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'alltag',
        text: 'Bestattet wurde am Todestag, weil der Verwesung in diesem Klima nicht anders beizukommen war. Der Leichnam wurde gewaschen, mit Spezereien in Tücher gewickelt und in eine Felskammer gelegt; nach einem Jahr sammelte man die Gebeine in einer Kiste. Vier Tage im Grab hieß: endgültig.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Trauer war öffentlich und dauerte sieben Tage im Haus, mit Besuchern, Klagefrauen und Flötenspielern; auch arme Familien mussten sie bezahlen. Marta und Maria sind also von Menschen umgeben, als sie sprechen – die Szene spielt nicht im Stillen.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'arbeit',
        text: 'Weinbau war die aufwendigste Landwirtschaft der Region: Terrassen anlegen, Steine lesen, Mauern setzen, jährlich schneiden, im Herbst Wache halten. Bis zum vollen Ertrag vergingen vier bis fünf Jahre. Ein Weinberg war deshalb Vermögen und Verpflichtung zugleich.',
      },
      {
        aspect: 'glaube',
        text: 'Der Weinstock war Sinnbild Israels – bei Jesaja 5, Psalm 80 und Jeremia 2 –, und über dem Eingang zum Tempel hing nach Josephus ein goldener Weinstock. Wer das Bild in Jerusalem gebrauchte, griff nach einem Zeichen, das jeder Besucher gesehen hatte.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'raum',
        text: 'Die Reihenfolge Jerusalem – Judäa – Samarien – Ende der Erde ist eine Landkarte in konzentrischen Kreisen, und der letzte Kreis meinte für antike Leser die Säulen des Herakles oder Indien. Für Lukas endet er in Rom: Wer die Hauptstadt erreicht hatte, erreichte alles Übrige über deren Straßen.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Samarien ausdrücklich zu nennen war keine Selbstverständlichkeit: Der Weg dorthin führte durch Gebiet, das viele Pilger großräumig umgingen. Die Aufzählung setzt die unangenehmste Station in die Mitte.',
      },
    ],
    terms: [
      {
  ...
  },
  {
    ...
    reception:
      'Der Vers ist der zentrale Text jeder Tauflehre und markiert zugleich die Grenzlinien zwischen den Konfessionen: über die Reihenfolge von Umkehr und Taufe, über die Kindertaufe und über die Formel „auf den Namen Jesu“ gegenüber der dreigliedrigen Formel aus Matthäus 28.\n\nLuthers erste These von 1517 – „Da unser Herr und Meister Jesus Christus spricht ‚Tut Buße‘, hat er gewollt, dass das ganze Leben der Gläubigen Buße sein soll“ – beruht auf der Beobachtung, dass das griechische Wort Umdenken meint und die lateinische Übersetzung *poenitentiam agite* eine Handlung daraus machte.',
    world: [
      {
        aspect: 'glaube',
        text: 'Tauchbäder waren Alltag: In Jerusalem sind über hundert Mikwen ausgegraben, viele in Privathäusern und rund um den Tempelbezirk. Man tauchte vor dem Betreten des Heiligtums, nach Unreinheit, regelmäßig und selbst. Eine einmalige Taufe, die ein anderer vollzieht, war deshalb die auffällige Abweichung.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Die Szene spielt am Wochenfest, mit Wallfahrern aus aller Welt in der Stadt. Wer sich taufen ließ, tat das öffentlich und vor Zeugen aus der eigenen Heimatgemeinde – und nahm die Folgen für seine Stellung dort mit in Kauf.',
      },
    ],
    terms: [
      {
        word: 'griech. metanoesate',
        rendered: 'Tut Buße',
        note: 'Wörtlich „denkt um“ – eine Änderung der Einstellung, keine Bußleistung. Luthers „Buße tun“ hat im Deutschen eine Färbung bekommen, die das Wort nicht hat; Luther selbst wies in der ersten seiner 95 Thesen darauf hin.',
      },
      {
        word: 'griech. eis aphesin',
        rendered: 'zur Vergebung',
        note: 'Die Präposition kann „zur“ und „aufgrund“ heißen. An dieser Mehrdeutigkeit hängt der Streit, ob die Taufe die Vergebung bewirkt oder sie voraussetzt – zwischen Baptisten und lutherischer Tradition eine alte Trennlinie.',
      },
    ],
    interpretations: [
      {
  ...
  },
  {
    ...
    world: [
      {
        aspect: 'recht',
        text: 'Der Hohe Rat hatte etwa siebzig Mitglieder und tagte als oberstes Gericht in Religions- und Rechtsfragen. Petrus und Johannes stehen dort als Handwerker ohne Ausbildung – der Text vermerkt in Vers 13 ausdrücklich, dass man sie für ungelehrt hielt. Ihre Rede ist eine Verteidigung, kein Vortrag.',
      },
      {
        aspect: 'gesellschaft',
        text: 'Anlass der Verhandlung ist die Heilung eines Gelähmten, der jahrelang am Tempeltor gebettelt hatte und in der Stadt bekannt war. Der Rat verhandelt also einen Fall, den jeder überprüfen konnte – und dessen Wirkung sich nicht bestreiten ließ.',
      },
    ],
    terms: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'dein Haus',
        note: 'Der Hausstand: Familie, Bedienstete, Sklaven. Die Zusage gilt einer sozialen Einheit, nicht einer Summe von Einzelnen – so funktionierte Zugehörigkeit in der antiken Gesellschaft.',
      },
      {
        word: 'griech. sothese',
        rendered: 'selig',
        note: 'Gerettet werden. Im Zusammenhang klingt beides mit: Der Kerkermeister wollte sich eben umbringen, weil er die Gefangenen entkommen glaubte – seine Frage nach Rettung ist zunächst sehr wörtlich gemeint.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'preiset',
        note: 'Erweisen, unter Beweis stellen – ein Wort aus der Beweisführung. Der Satz behauptet nicht, dass Gott liebt, sondern nennt den Beleg dafür.',
      },
      {
        word: 'griech. eti',
        rendered: 'noch',
        note: 'Noch, immer noch. Das Wort trägt den ganzen Satz: nicht nachdem, sondern während. Paulus wiederholt es in den Versen davor dreimal – als wir noch schwach, noch gottlos, noch Sünder waren.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'griech. kyrios',
        rendered: 'HERR',
        note: 'Herr. Dasselbe Wort setzt die griechische Bibel für den Gottesnamen ein – und dasselbe beanspruchte der Kaiser. Das Bekenntnis „Jesus ist Herr“ war deshalb im römischen Reich nicht nur eine religiöse Aussage.',
      },
      {
        word: 'griech. homologeo',
        rendered: 'bekennst',
        note: 'Wörtlich „dasselbe sagen“ – öffentlich übereinstimmen, sich zu etwas bekennen. Ein Wort aus dem Vertrags- und Gerichtswesen, nicht aus dem Innenleben.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'vernünftiger Gottesdienst',
        note: 'Wörtlich „wortgemäßer“ oder „vernunftgemäßer Dienst“ – ein Ausdruck aus der philosophischen Religionskritik, die das Tieropfer durch geistige Verehrung ersetzen wollte. Paulus nimmt ihn auf und füllt ihn anders.',
      },
      {
        word: 'griech. somata',
        rendered: 'Leiber',
        note: 'Die Leiber, nicht die Seelen. Der Gottesdienst, von dem Paulus spricht, ist ausdrücklich körperlich – was mit Händen, Zeit und Geld geschieht, nicht was innerlich gefühlt wird.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'griech. kopos',
        rendered: 'Arbeit',
        note: 'Mühe, Anstrengung bis zur Erschöpfung – nicht Arbeit als Tätigkeit, sondern als Kraftaufwand. Paulus gebraucht dasselbe Wort für seine Handarbeit und für seinen Dienst.',
      },
      {
        word: 'griech. kenos',
        rendered: 'vergeblich',
        note: 'Leer, ins Leere gehend. Dasselbe Wort steht am Anfang des Kapitels für einen Glauben, der leer wäre, wenn Christus nicht auferstanden ist. Der Schlussvers nimmt es auf und dreht es um.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'äußerlicher Mensch',
        note: 'Der äußere Mensch. Nicht Körper gegen Seele im griechischen Sinn: Paulus meint den Menschen, wie er sichtbar vergeht, gegenüber dem, was Gott an ihm erneuert – beides betrifft denselben Menschen.',
      },
      {
        word: 'griech. baros doxes',
        rendered: 'wichtige Herrlichkeit',
        note: 'Wörtlich „Gewicht an Herrlichkeit“. Das hebräische Wort für Herrlichkeit, *kabod*, bedeutet zugleich Gewicht – Paulus spielt mit dieser Doppelbedeutung gegen die „leichte“ Trübsal.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'wandeln',
        note: 'Umhergehen, seinen Lebenswandel führen. Ein Alltagswort: Es geht nicht um eine Haltung, sondern um die Art, wie jemand durch seine Tage geht.',
      },
      {
        word: 'griech. eidos',
        rendered: 'Schauen',
        note: 'Das Aussehen, die sichtbare Gestalt. Das Wort meint das, was vor Augen liegt – der Gegensatz ist nicht Glaube gegen Wissen, sondern Vertrauen gegen Augenschein.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'überschwenglich',
        note: 'Eine dreifach gesteigerte Bildung: über-aus-reichlich. Der Epheserbrief liebt solche Häufungen; sie sind eines der Argumente dafür, dass er nicht von Paulus selbst stammt.',
      },
      {
        word: 'griech. energoumenen',
        rendered: 'wirkt',
        note: 'Wirksam sein, am Werk sein. Die Zusage endet nicht bei Gottes Vermögen, sondern bei einer Kraft, die bereits in den Angeredeten tätig ist.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'angefangen',
        note: 'Anfangen, beginnen – im griechischen Sprachgebrauch auch der Beginn einer Opferhandlung. Das Gegenwort „vollführen“ stammt aus demselben Bereich: Was begonnen wurde, wird zu Ende gebracht.',
      },
      {
        word: 'griech. hemera Christou',
        rendered: 'Tag Jesu Christi',
        note: 'Die christliche Fassung des alttestamentlichen „Tages des HERRN“. Der Satz nennt damit einen Endpunkt, der außerhalb der Lebenszeit der Angeredeten liegt.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'Demut',
        note: 'Wörtlich „Niedriggesinntheit“. In der griechisch-römischen Welt war das Wort ein Schimpfwort: die Haltung eines Sklaven. Das Christentum hat es zur Tugend gemacht – eine der stärksten Umwertungen der Antike.',
      },
      {
        word: 'griech. hyperechontas',
        rendered: 'höher',
        note: 'Überragend, hervorstehend. Der Satz verlangt nicht, sich selbst gering zu schätzen, sondern den anderen tatsächlich für bedeutender zu halten – ein Urteil, keine Stimmung.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'von Herzen',
        note: 'Wörtlich „aus der Seele“ – mit ganzem Einsatz. Luthers „von Herzen“ trifft den Sinn; das Griechische betont weniger das Gefühl als die Beteiligung der ganzen Person.',
      },
      {
        word: 'griech. kleronomia',
        rendered: 'Erbe',
        note: 'Erbteil. Das Wort ist im Zusammenhang scharf: Angesprochen sind unmittelbar davor Sklaven, die nach römischem Recht nichts erben konnten. Ihnen wird ein Erbe zugesagt.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'griech. deilia',
        rendered: 'Furcht',
        note: 'Feigheit, Kleinmut – nicht die Furcht als Gefühl, für die das Neue Testament ein anderes Wort hat. Gemeint ist ein Zurückweichen, kein Erschrecken.',
      },
      {
        word: 'griech. sophronismos',
        rendered: 'Zucht',
        note: 'Besonnenheit, gesunder Verstand, Selbstbeherrschung. Luthers „Zucht“ klingt heute nach Disziplinierung; gemeint ist ein klarer Kopf.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        word: 'griech. potapen',
        rendered: 'welch eine',
        note: 'Ursprünglich „von welchem Land?“ – ein Wort für etwas Fremdartiges, Unerhörtes. Der Ausruf lautet sinngemäß: Was für eine unerhörte Liebe.',
      },
      {
        word: 'griech. tekna theou',
        rendered: 'Gottes Kinder',
        note: 'Kinder Gottes – nicht „Söhne“, wie Paulus meist sagt. Der Unterschied ist nicht nebensächlich: Bei Paulus steht die rechtliche Adoption im Vordergrund, bei Johannes die Herkunft, das Gezeugtsein.',
      },
    ],
    interpretations: [
      {
    ...
    terms: [
      {
        ...
        rendered: 'Widerstehet',
        note: 'Sich entgegenstellen, standhalten – ein Wort aus der Schlachtordnung. Es verlangt kein Angreifen, sondern ein Nichtweichen; dasselbe Verb steht in der Waffenrüstung des Epheserbriefs.',
      },
      {
        word: 'griech. eggisate',
        rendered: 'nahet euch',
        note: 'Sich nähern. Im griechischen Alten Testament ist es das Fachwort für das Herantreten des Priesters an den Altar. Der Brief überträgt es auf alle Angeredeten.',
      },
    ],
    interpretations: [
      {
